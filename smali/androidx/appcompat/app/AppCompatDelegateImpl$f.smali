...
.method final b(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    invoke-direct {v0, v1, p1}, Lo$a;-><init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V

    .line 2
    iget-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$f;->c:Landroidx/appcompat/app/AppCompatDelegateImpl;

    .line 3
    invoke-virtual {p1, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->D(Lk$a;)Lk;
    ...
    .line 4
    invoke-virtual {v0, p1}, Lo$a;->e(Lk;)Landroid/view/ActionMode;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 2
    invoke-super {p0, p1}, Lr;->dispatchKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 1
    invoke-super {p0, p1}, Lr;->dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->W(ILandroid/view/KeyEvent;)Z
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    .line 2
    :cond_0
    invoke-super {p0, p1, p2}, Lr;->onCreatePanelMenu(ILandroid/view/Menu;)Z
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    .line 1
    invoke-super {p0, p1, p2}, Lr;->onMenuOpened(ILandroid/view/Menu;)Z

    .line 2
    iget-object p2, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$f;->c:Landroidx/appcompat/app/AppCompatDelegateImpl;

    invoke-virtual {p2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->X(I)V
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Lr;->onPanelClosed(ILandroid/view/Menu;)V

    .line 2
    iget-object p2, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$f;->c:Landroidx/appcompat/app/AppCompatDelegateImpl;

    invoke-virtual {p2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->Y(I)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    .line 2
    invoke-virtual {v0, v2}, Landroidx/appcompat/view/menu/g;->P(Z)V
...
.method public onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    .line 3
    invoke-super {p0, p1, v0, p3}, Lr;->onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V

    goto :goto_0

    .line 4
    :cond_0
    invoke-super {p0, p1, p2, p3}, Lr;->onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 3
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$f;->b(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 4
    :cond_1
    invoke-super {p0, p1}, Lr;->onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
    ...
    :cond_1
    :goto_0
    invoke-super {p0, p1, p2}, Lr;->onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
