...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Landroidx/lifecycle/f$a;-><init>(Ljava/lang/String;I)V

    sput-object v1, Landroidx/lifecycle/f$a;->ON_START:Landroidx/lifecycle/f$a;

    .line 3
    new-instance v3, Landroidx/lifecycle/f$a;

    const-string v5, "ON_RESUME"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Landroidx/lifecycle/f$a;-><init>(Ljava/lang/String;I)V

    sput-object v3, Landroidx/lifecycle/f$a;->ON_RESUME:Landroidx/lifecycle/f$a;

    .line 4
    new-instance v5, Landroidx/lifecycle/f$a;

    const-string v7, "ON_PAUSE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Landroidx/lifecycle/f$a;-><init>(Ljava/lang/String;I)V

    sput-object v5, Landroidx/lifecycle/f$a;->ON_PAUSE:Landroidx/lifecycle/f$a;
    ...
    invoke-direct {v7, v9, v10}, Landroidx/lifecycle/f$a;-><init>(Ljava/lang/String;I)V

    sput-object v7, Landroidx/lifecycle/f$a;->ON_STOP:Landroidx/lifecycle/f$a;

    .line 6
    new-instance v9, Landroidx/lifecycle/f$a;

    const-string v11, "ON_DESTROY"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Landroidx/lifecycle/f$a;-><init>(Ljava/lang/String;I)V

    sput-object v9, Landroidx/lifecycle/f$a;->ON_DESTROY:Landroidx/lifecycle/f$a;

    .line 7
    new-instance v11, Landroidx/lifecycle/f$a;

    const-string v13, "ON_ANY"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Landroidx/lifecycle/f$a;-><init>(Ljava/lang/String;I)V

    sput-object v11, Landroidx/lifecycle/f$a;->ON_ANY:Landroidx/lifecycle/f$a;

    const/4 v13, 0x7

    new-array v13, v13, [Landroidx/lifecycle/f$a;
    ...
    .line 8
    sput-object v13, Landroidx/lifecycle/f$a;->$VALUES:[Landroidx/lifecycle/f$a;
