...
# virtual methods
.method public E(La;Landroid/os/Bundle;)Z
    .locals 2
    ...
    invoke-direct {v1, p1}, Landroidx/browser/customtabs/f;-><init>(La;)V

    invoke-virtual {v0, v1, p2}, Landroidx/browser/customtabs/CustomTabsService;->f(Landroidx/browser/customtabs/f;Landroid/os/Bundle;)Z
...
.method public G(La;Landroid/net/Uri;)Z
    .locals 2
    ...
    invoke-virtual {v0, v1, p2}, Landroidx/browser/customtabs/CustomTabsService;->e(Landroidx/browser/customtabs/f;Landroid/net/Uri;)Z
...
.method public c(La;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    .locals 2
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Landroidx/browser/customtabs/CustomTabsService;->b(Landroidx/browser/customtabs/f;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public d(La;ILandroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 2
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Landroidx/browser/customtabs/CustomTabsService;->g(Landroidx/browser/customtabs/f;ILandroid/net/Uri;Landroid/os/Bundle;)Z
...
.method public x(La;Ljava/lang/String;Landroid/os/Bundle;)I
    .locals 2
    ...
    invoke-virtual {v0, v1, p2, p3}, Landroidx/browser/customtabs/CustomTabsService;->d(Landroidx/browser/customtabs/f;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public z(La;)Z
    .locals 5

    .line 1
    new-instance v0, Landroidx/browser/customtabs/f;

    invoke-direct {v0, p1}, Landroidx/browser/customtabs/f;-><init>(La;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/browser/customtabs/CustomTabsService;->c(Landroidx/browser/customtabs/f;)Z
