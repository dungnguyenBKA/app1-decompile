...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/b;Lm6;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p3, p0, Landroidx/work/impl/c;->d:Lm6;
...
.method public f(Ljava/lang/String;Landroidx/work/WorkerParameters$a;)Z
    ...
    .line 7
    :cond_0
    new-instance v1, Landroidx/work/impl/l$a;
    ...
    iget-object v7, p0, Landroidx/work/impl/c;->d:Lm6;
    ...
    invoke-direct/range {v4 .. v9}, Landroidx/work/impl/l$a;-><init>(Landroid/content/Context;Landroidx/work/b;Lm6;Landroidx/work/impl/WorkDatabase;Ljava/lang/String;)V

    iget-object v4, p0, Landroidx/work/impl/c;->g:Ljava/util/List;

    .line 8
    iput-object v4, v1, Landroidx/work/impl/l$a;->f:Ljava/util/List;

    if-eqz p2, :cond_1

    .line 9
    iput-object p2, v1, Landroidx/work/impl/l$a;->g:Landroidx/work/WorkerParameters$a;

    .line 10
    :cond_1
    new-instance p2, Landroidx/work/impl/l;

    invoke-direct {p2, v1}, Landroidx/work/impl/l;-><init>(Landroidx/work/impl/l$a;)V

    .line 11
    invoke-virtual {p2}, Landroidx/work/impl/l;->a()Luy;
    ...
    invoke-direct {v4, p0, p1, v1}, Landroidx/work/impl/c$a;-><init>(Landroidx/work/impl/a;Ljava/lang/String;Luy;)V

    iget-object v5, p0, Landroidx/work/impl/c;->d:Lm6;

    .line 13
    check-cast v5, Ln6;

    invoke-virtual {v5}, Ln6;->c()Ljava/util/concurrent/Executor;
    ...
    invoke-virtual {v1, v4, v5}, Lj6;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    .line 17
    iget-object v0, p0, Landroidx/work/impl/c;->d:Lm6;

    check-cast v0, Ln6;

    invoke-virtual {v0}, Ln6;->b()Ljava/util/concurrent/Executor;
...
.method public g(Ljava/lang/String;)Z
    ...
    .line 5
    invoke-virtual {v1}, Landroidx/work/impl/l;->c()V
