...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v0, v1, v1}, Lc1;->i(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    .line 8
    invoke-virtual {p0, p2}, Landroidx/transition/Visibility;->X(I)V
...
.method private S(Landroidx/transition/w;Landroidx/transition/w;)Landroidx/transition/Visibility$b;
    .locals 7
...
.method public T(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
    .locals 0
...
.method public U(Landroid/view/ViewGroup;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
    .locals 4
    ...
    .line 3
    invoke-virtual {p0, v0, v1}, Landroidx/transition/Transition;->r(Landroid/view/View;Z)Landroidx/transition/w;

    move-result-object v3

    .line 4
    invoke-virtual {p0, v0, v1}, Landroidx/transition/Transition;->y(Landroid/view/View;Z)Landroidx/transition/w;

    move-result-object v0

    .line 5
    invoke-direct {p0, v3, v0}, Landroidx/transition/Visibility;->S(Landroidx/transition/w;Landroidx/transition/w;)Landroidx/transition/Visibility$b;
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Landroidx/transition/Visibility;->T(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
...
.method public V(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
    .locals 0
...
.method public W(Landroid/view/ViewGroup;Landroidx/transition/w;Landroidx/transition/w;I)Landroid/animation/Animator;
    .locals 17
    ...
    .line 1
    iget v5, v0, Landroidx/transition/Visibility;->z:I
    ...
    .line 3
    iget-object v8, v3, Landroidx/transition/w;->b:Landroid/view/View;
    ...
    .line 9
    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->y(Landroid/view/View;Z)Landroidx/transition/w;

    move-result-object v14

    .line 10
    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->r(Landroid/view/View;Z)Landroidx/transition/w;

    move-result-object v15

    .line 11
    invoke-direct {v0, v14, v15}, Landroidx/transition/Visibility;->S(Landroidx/transition/w;Landroidx/transition/w;)Landroidx/transition/Visibility$b;
    ...
    invoke-direct {v4, v1}, Landroidx/transition/z;-><init>(Landroid/view/ViewGroup;)V

    .line 24
    invoke-virtual {v4, v10}, Landroidx/transition/z;->a(Landroid/view/View;)V

    .line 25
    :cond_b
    invoke-virtual {v0, v1, v10, v2, v3}, Landroidx/transition/Visibility;->V(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
    ...
    invoke-direct {v3, v1}, Landroidx/transition/z;-><init>(Landroid/view/ViewGroup;)V

    .line 27
    invoke-virtual {v3, v10}, Landroidx/transition/z;->b(Landroid/view/View;)V
    ...
    invoke-direct {v3, v0, v1, v10, v5}, Landroidx/transition/i0;-><init>(Landroidx/transition/Visibility;Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)V
    ...
    .line 31
    invoke-static {v8, v11}, Landroidx/transition/b0;->g(Landroid/view/View;I)V

    .line 32
    invoke-virtual {v0, v1, v8, v2, v3}, Landroidx/transition/Visibility;->V(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
    ...
    invoke-direct {v2, v8, v4, v12}, Landroidx/transition/Visibility$a;-><init>(Landroid/view/View;IZ)V
    ...
    .line 37
    :cond_f
    invoke-static {v8, v5}, Landroidx/transition/b0;->g(Landroid/view/View;I)V
...
.method public d(Landroidx/transition/w;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/transition/Visibility;->Q(Landroidx/transition/w;)V
...
.method public k(Landroid/view/ViewGroup;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
    ...
    .line 1
    invoke-direct {p0, p2, p3}, Landroidx/transition/Visibility;->S(Landroidx/transition/w;Landroidx/transition/w;)Landroidx/transition/Visibility$b;
    ...
    .line 4
    invoke-virtual {p0, p1, p2, p3}, Landroidx/transition/Visibility;->U(Landroid/view/ViewGroup;Landroidx/transition/w;Landroidx/transition/w;)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/transition/Visibility;->W(Landroid/view/ViewGroup;Landroidx/transition/w;Landroidx/transition/w;I)Landroid/animation/Animator;
...
.method public z(Landroidx/transition/w;Landroidx/transition/w;)Z
    ...
    .line 4
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/transition/Visibility;->S(Landroidx/transition/w;Landroidx/transition/w;)Landroidx/transition/Visibility$b;
