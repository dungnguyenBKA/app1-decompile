...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/o;->f:Landroidx/media/MediaBrowserServiceCompat$i;

    iput-object p2, p0, Landroidx/media/o;->b:Landroidx/media/MediaBrowserServiceCompat$j;

    iput-object p3, p0, Landroidx/media/o;->c:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/o;->d:Landroid/os/Bundle;

    iput-object p5, p0, Landroidx/media/o;->e:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media/o;->b:Landroidx/media/MediaBrowserServiceCompat$j;
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/o;->f:Landroidx/media/MediaBrowserServiceCompat$i;
    ...
    iget-object v1, p0, Landroidx/media/o;->c:Ljava/lang/String;
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Landroidx/media/o;->f:Landroidx/media/MediaBrowserServiceCompat$i;

    iget-object v0, v0, Landroidx/media/MediaBrowserServiceCompat$i;->a:Landroidx/media/MediaBrowserServiceCompat;

    iget-object v1, p0, Landroidx/media/o;->c:Ljava/lang/String;

    iget-object v2, p0, Landroidx/media/o;->e:Landroid/support/v4/os/ResultReceiver;

    .line 5
    new-instance v3, Landroidx/media/f;

    invoke-direct {v3, v0, v1, v2}, Landroidx/media/f;-><init>(Landroidx/media/MediaBrowserServiceCompat;Ljava/lang/Object;Landroid/support/v4/os/ResultReceiver;)V

    .line 6
    invoke-virtual {v0, v3}, Landroidx/media/MediaBrowserServiceCompat;->f(Landroidx/media/MediaBrowserServiceCompat$h;)V
