...
# instance fields
.field private final a:Landroidx/media/MediaBrowserServiceCompat$i;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct/range {v10 .. v15}, Landroidx/media/p;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    invoke-direct/range {v10 .. v15}, Landroidx/media/o;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    new-instance v4, Landroidx/media/n;

    invoke-direct {v4, v2, v3}, Landroidx/media/n;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;)V
    ...
    invoke-direct/range {v5 .. v11}, Landroidx/media/m;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;IILandroid/os/Bundle;)V
    ...
    new-instance v6, Landroidx/media/l;

    invoke-direct {v6, v3, v5, v4, v2}, Landroidx/media/l;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;)V
    ...
    new-instance v6, Landroidx/media/k;

    invoke-direct {v6, v3, v4, v5, v2}, Landroidx/media/k;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    invoke-direct/range {v11 .. v16}, Landroidx/media/j;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;)V
    ...
    new-instance v4, Landroidx/media/i;

    invoke-direct {v4, v2, v3}, Landroidx/media/i;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;)V
    ...
    invoke-direct/range {v5 .. v11}, Landroidx/media/h;-><init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;IILandroid/os/Bundle;)V
