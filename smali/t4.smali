...
.method private static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    ...
    .line 6
    invoke-static/range {v0 .. v6}, Lt4;->g(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ValueAnimator;
    ...
    .line 11
    sget-object v0, Lr4;->h:[I

    move-object/from16 v7, p4

    invoke-static {v8, v9, v7, v0}, Lc1;->n(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    .line 12
    invoke-static {v10, v0}, Lc1;->l(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 14
    invoke-static/range {v0 .. v7}, Lt4;->a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    ...
    .line 22
    sget-object v3, Lr4;->i:[I

    invoke-static {v8, v9, v1, v3}, Lc1;->n(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    .line 23
    invoke-static {v3, v10, v7, v2}, Lc1;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 24
    invoke-static {v10, v14}, Lc1;->l(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 30
    sget-object v15, Lr4;->j:[I

    invoke-static {v8, v9, v2, v15}, Lc1;->n(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v2

    .line 31
    invoke-static {v10, v1}, Lc1;->l(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 36
    sget-object v5, Lr4;->j:[I

    invoke-static {v8, v9, v2, v5}, Lc1;->n(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    .line 37
    invoke-static {v10, v5}, Lc1;->l(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 52
    invoke-static {v8, v5}, Lt4;->h(Landroid/content/Context;I)Landroid/view/animation/Interpolator;
    ...
    invoke-static {v5, v8}, Lt4;->c(Landroid/animation/Keyframe;F)Landroid/animation/Keyframe;
    ...
    .line 66
    :cond_1f
    invoke-static {v2, v8}, Lt4;->c(Landroid/animation/Keyframe;F)Landroid/animation/Keyframe;
    ...
    .line 79
    invoke-static {v3, v4, v8, v5, v7}, Lt4;->d(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
...
.method private static b(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    .locals 4
    ...
    invoke-direct {v2, p0, v1, p1}, Lw4;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private static d(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
    .locals 11
    ...
    .line 8
    invoke-static {p1}, Ll1;->e(Ljava/lang/String;)[Ll1$a;

    move-result-object p2

    .line 9
    invoke-static {p0}, Ll1;->e(Ljava/lang/String;)[Ll1$a;
...
.method public static f(Landroid/content/Context;I)Landroid/animation/Animator;
    .locals 10
...
.method private static g(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ValueAnimator;
    .locals 19
    ...
    .line 1
    sget-object v4, Lr4;->g:[I

    invoke-static {v0, v1, v2, v4}, Lc1;->n(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v4

    .line 2
    sget-object v5, Lr4;->k:[I

    invoke-static {v0, v1, v2, v5}, Lc1;->n(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    .line 4
    invoke-static {v3, v2}, Lc1;->l(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 8
    invoke-static {v3, v12}, Lc1;->l(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 17
    invoke-static {v4, v2, v15, v12, v5}, Lt4;->d(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
    ...
    .line 28
    invoke-static {v0, v3, v5, v6}, Lc1;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 29
    invoke-static {v0, v3, v7, v8}, Lc1;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 30
    invoke-static {v0, v3, v8, v14}, Lc1;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_10
    :goto_b
    invoke-static {v5}, Ll1;->f(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    .line 54
    invoke-static {v0, v3, v1, v9}, Lc1;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 56
    invoke-static {v3, v1}, Lc1;->l(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 58
    invoke-static {v2, v9}, Lt4;->h(Landroid/content/Context;I)Landroid/view/animation/Interpolator;
...
.method public static h(Landroid/content/Context;I)Landroid/view/animation/Interpolator;
    .locals 4
    ...
    invoke-static {p0, v0}, Lt4;->b(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
