...
.field private d:Lwb0;

.field private e:Lrb0;

.field private f:I

.field private g:Ljc0;
...
.method public constructor <init>(Landroid/app/Activity;Lcom/google/ads/ADRequestList;Z)V
    ...
    .line 3
    iput-boolean v1, p0, Lob0;->h:Z

    .line 4
    new-instance v1, Lob0$a;

    invoke-direct {v1, p0}, Lob0$a;-><init>(Lob0;)V

    iput-object v1, p0, Lob0;->i:Lub0$a;
    ...
    iput-object p3, p0, Lob0;->e:Lrb0;

    .line 11
    iput-object p2, p0, Lob0;->c:Lcom/google/ads/ADRequestList;
    ...
    .line 16
    :cond_0
    invoke-direct {p0}, Lob0;->k()Llb0;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lob0;->m(Landroid/app/Activity;Llb0;)V
...
.method static synthetic c(Lob0;)Lwb0;
    .locals 0

    .line 1
    iget-object p0, p0, Lob0;->d:Lwb0;

    return-object p0
.end method

.method static synthetic d(Lob0;)Llb0;
    .locals 0
...
.method static synthetic e(Lob0;Landroid/app/Activity;Llb0;)V
    .locals 0
...
.method static synthetic f(Lob0;)Lrb0;
    .locals 0

    .line 1
    iget-object p0, p0, Lob0;->e:Lrb0;

    return-object p0
.end method

.method static synthetic g(Lob0;)Z
    .locals 0

    .line 1
    iget-boolean p0, p0, Lob0;->h:Z

    return p0
.end method

.method static synthetic h(Lob0;)Ljc0;
    .locals 0

    .line 1
    iget-object p0, p0, Lob0;->g:Ljc0;

    return-object p0
.end method

.method static synthetic i(Lob0;Ljc0;)Ljc0;
    .locals 0

    const/4 p1, 0x0

    .line 1
    iput-object p1, p0, Lob0;->g:Ljc0;

    return-object p1
.end method

.method private k()Llb0;
    .locals 2

    .line 1
    iget-object v0, p0, Lob0;->c:Lcom/google/ads/ADRequestList;
    ...
    iget-object v1, p0, Lob0;->c:Lcom/google/ads/ADRequestList;
...
.method private m(Landroid/app/Activity;Llb0;)V
    .locals 2
    ...
    iput-object v0, p0, Lob0;->d:Lwb0;

    .line 6
    iget-object v1, p0, Lob0;->i:Lub0$a;

    invoke-virtual {v0, p1, p2, v1}, Lub0;->d(Landroid/app/Activity;Llb0;Lub0$a;)V

    .line 7
    iget-object p2, p0, Lob0;->d:Lwb0;
...
.method public n(Landroid/app/Activity;Lwb0$a;)V
    .locals 1
    ...
    iput-object v0, p0, Lob0;->g:Ljc0;

    .line 5
    :cond_0
    iget-object v0, p0, Lob0;->g:Ljc0;

    invoke-virtual {v0, p1}, Ljc0;->b(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1, p2}, Lwb0;->l(Landroid/app/Activity;Lwb0$a;)V
