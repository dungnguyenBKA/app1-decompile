...
.field private final okHttpClient:Lgh0;
...
.method public constructor <init>(Lcom/vungle/warren/downloader/DownloaderCache;JILcom/vungle/warren/utility/NetworkProvider;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-direct {p1}, Lgh0$b;-><init>()V

    const-wide/16 p2, 0x1e

    .line 21
    invoke-virtual {p1, p2, p3, p4}, Lgh0$b;->g(JLjava/util/concurrent/TimeUnit;)Lgh0$b;

    .line 22
    invoke-virtual {p1, p2, p3, p4}, Lgh0$b;->d(JLjava/util/concurrent/TimeUnit;)Lgh0$b;

    const/4 p2, 0x0

    .line 23
    invoke-virtual {p1, p2}, Lgh0$b;->c(Lmg0;)Lgh0$b;

    .line 24
    invoke-virtual {p1, v0}, Lgh0$b;->e(Z)Lgh0$b;

    .line 25
    invoke-virtual {p1, v0}, Lgh0$b;->f(Z)Lgh0$b;

    .line 26
    invoke-virtual {p1}, Lgh0$b;->b()Lgh0;

    move-result-object p1

    iput-object p1, p0, Lcom/vungle/warren/downloader/AssetDownloader;->okHttpClient:Lgh0;
...
.method static synthetic access$1000(Lcom/vungle/warren/downloader/AssetDownloader;Llh0;)J
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/vungle/warren/downloader/AssetDownloader;->getContentLength(Llh0;)J
...
.method static synthetic access$1100(Lcom/vungle/warren/downloader/AssetDownloader;Ljava/io/File;Llh0;Lcom/vungle/warren/downloader/DownloadRequestMediator;Ljava/util/HashMap;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/vungle/warren/downloader/AssetDownloader;->notModified(Ljava/io/File;Llh0;Lcom/vungle/warren/downloader/DownloadRequestMediator;Ljava/util/HashMap;)Z
...
.method static synthetic access$1400(Lcom/vungle/warren/downloader/AssetDownloader;JILlh0;Lcom/vungle/warren/downloader/DownloadRequestMediator;)Z
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p5}, Lcom/vungle/warren/downloader/AssetDownloader;->partialMalformed(JILlh0;Lcom/vungle/warren/downloader/DownloadRequestMediator;)Z
...
.method static synthetic access$1600(Lcom/vungle/warren/downloader/AssetDownloader;Ljava/io/File;Ljava/io/File;Lch0;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/vungle/warren/downloader/AssetDownloader;->checkEncoding(Ljava/io/File;Ljava/io/File;Lch0;)V

    return-void
.end method

.method static synthetic access$1700(Lcom/vungle/warren/downloader/AssetDownloader;Ljava/io/File;Lch0;Ljava/lang/String;)Ljava/util/HashMap;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/vungle/warren/downloader/AssetDownloader;->makeMeta(Ljava/io/File;Lch0;Ljava/lang/String;)Ljava/util/HashMap;
...
.method static synthetic access$1800(Lcom/vungle/warren/downloader/AssetDownloader;Llh0;)Lmh0;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/vungle/warren/downloader/AssetDownloader;->decodeGzipIfNeeded(Llh0;)Lmh0;
...
.method static synthetic access$800(Lcom/vungle/warren/downloader/AssetDownloader;JLjava/io/File;Ljava/util/HashMap;Ljh0$a;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p5}, Lcom/vungle/warren/downloader/AssetDownloader;->appendHeaders(JLjava/io/File;Ljava/util/HashMap;Ljh0$a;)V

    return-void
.end method

.method static synthetic access$900(Lcom/vungle/warren/downloader/AssetDownloader;)Lgh0;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/vungle/warren/downloader/AssetDownloader;->okHttpClient:Lgh0;
...
.method private appendHeaders(JLjava/io/File;Ljava/util/HashMap;Ljh0$a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 1
    invoke-virtual {p5, v0, v1}, Ljh0$a;->a(Ljava/lang/String;Ljava/lang/String;)Ljh0$a;
    ...
    .line 7
    invoke-virtual {p5, p1, p3}, Ljh0$a;->a(Ljava/lang/String;Ljava/lang/String;)Ljh0$a;
    ...
    .line 9
    invoke-virtual {p5, p1, v0}, Ljh0$a;->a(Ljava/lang/String;Ljava/lang/String;)Ljh0$a;
    ...
    invoke-virtual {p5, p2, p1}, Ljh0$a;->a(Ljava/lang/String;Ljava/lang/String;)Ljh0$a;
    ...
    .line 15
    invoke-virtual {p5, p2, p3}, Ljh0$a;->a(Ljava/lang/String;Ljava/lang/String;)Ljh0$a;
    ...
    .line 17
    invoke-virtual {p5, p2, v0}, Ljh0$a;->a(Ljava/lang/String;Ljava/lang/String;)Ljh0$a;
...
.method private checkEncoding(Ljava/io/File;Ljava/io/File;Lch0;)V
    .locals 2

    const-string v0, "Content-Encoding"

    .line 1
    invoke-virtual {p3, v0}, Lch0;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method private copyToDestination(Ljava/io/File;Ljava/io/File;Lj2;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 10
    iget-object v0, p3, Lj2;->a:Ljava/lang/Object;

    check-cast v0, Lcom/vungle/warren/downloader/DownloadRequest;

    iget-object v0, v0, Lcom/vungle/warren/downloader/DownloadRequest;->url:Ljava/lang/String;
    ...
    :goto_1
    :try_start_3
    const-string v3, "AssetDownloader#copyToDestination; loadAd sequence"

    const-string v4, "cannot copy from %1$s(%2$s) to %3$s due to %4$s"
    ...
    iget-object v6, p3, Lj2;->a:Ljava/lang/Object;

    check-cast v6, Lcom/vungle/warren/downloader/DownloadRequest;

    iget-object v6, v6, Lcom/vungle/warren/downloader/DownloadRequest;->url:Ljava/lang/String;
    ...
    .line 15
    invoke-static {v3, p1}, Lcom/vungle/warren/VungleLogger;->error(Ljava/lang/String;Ljava/lang/String;)V

    .line 16
    iget-object p1, p3, Lj2;->a:Ljava/lang/Object;

    check-cast p1, Lcom/vungle/warren/downloader/DownloadRequest;

    iget-object v3, p3, Lj2;->b:Ljava/lang/Object;

    check-cast v3, Lcom/vungle/warren/downloader/AssetDownloadListener;
    ...
    invoke-direct {p0, p1, v3, v4}, Lcom/vungle/warren/downloader/AssetDownloader;->deliverError(Lcom/vungle/warren/downloader/DownloadRequest;Lcom/vungle/warren/downloader/AssetDownloadListener;Lcom/vungle/warren/downloader/AssetDownloadListener$DownloadError;)V
...
.method private debugString(Lcom/vungle/warren/downloader/DownloadRequest;)Ljava/lang/String;
    ...
    const-string v0, ", single request url - "
...
.method private decodeGzipIfNeeded(Llh0;)Lmh0;
    .locals 4
    ...
    invoke-direct {v0, v1}, Lgk0;-><init>(Lrk0;)V
    ...
    invoke-direct {v1, p1, v2, v3, v0}, Lki0;-><init>(Ljava/lang/String;JLzj0;)V
...
.method private deliverSuccess(Lj2;Ljava/io/File;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iget-object v0, p1, Lj2;->b:Ljava/lang/Object;
...
.method private getContentLength(Llh0;)J
    .locals 3
    ...
    invoke-virtual {p1, v2}, Lch0;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method private makeMeta(Ljava/io/File;Lch0;Ljava/lang/String;)Ljava/util/HashMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-virtual {p2, p3}, Lch0;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method private notModified(Ljava/io/File;Llh0;Lcom/vungle/warren/downloader/DownloadRequestMediator;Ljava/util/HashMap;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private onCancelled(Lcom/vungle/warren/downloader/DownloadRequest;)V
    ...
    .line 5
    invoke-virtual {v0, p1}, Lcom/vungle/warren/downloader/DownloadRequestMediator;->remove(Lcom/vungle/warren/downloader/DownloadRequest;)Lj2;
    ...
    .line 6
    :cond_1
    iget-object v3, p1, Lj2;->a:Ljava/lang/Object;
...
.method private onErrorMediator(Lcom/vungle/warren/downloader/AssetDownloadListener$DownloadError;Lcom/vungle/warren/downloader/DownloadRequestMediator;)V
    ...
    .line 7
    iget-object v2, v1, Lj2;->a:Ljava/lang/Object;
...
.method private declared-synchronized onNetworkChanged(I)V
    ...
    .line 1
    :try_start_0
    iget-object p1, p0, Lcom/vungle/warren/downloader/AssetDownloader;->mediators:Ljava/util/Map;
    ...
    check-cast v0, Lcom/vungle/warren/downloader/DownloadRequestMediator;

    const/4 v1, 0x3

    .line 3
    invoke-virtual {v0, v1}, Lcom/vungle/warren/downloader/DownloadRequestMediator;->is(I)Z
    ...
    .line 4
    :cond_1
    invoke-direct {p0, v0}, Lcom/vungle/warren/downloader/AssetDownloader;->isAnyConnected(Lcom/vungle/warren/downloader/DownloadRequestMediator;)Z

    move-result v1

    .line 5
    invoke-virtual {v0, v1}, Lcom/vungle/warren/downloader/DownloadRequestMediator;->setConnected(Z)V
    ...
    .line 7
    invoke-direct {p0, v0}, Lcom/vungle/warren/downloader/AssetDownloader;->load(Lcom/vungle/warren/downloader/DownloadRequestMediator;)V
    ...
    iget-object v2, v0, Lcom/vungle/warren/downloader/DownloadRequestMediator;->key:Ljava/lang/String;
...
.method private onProgressMediator(Lcom/vungle/warren/downloader/DownloadRequestMediator;Lcom/vungle/warren/downloader/AssetDownloadListener$Progress;)V
    ...
    iget v2, p2, Lcom/vungle/warren/downloader/AssetDownloadListener$Progress;->progressPercent:I
    ...
    .line 4
    iget-object v1, p2, Lj2;->a:Ljava/lang/Object;

    check-cast v1, Lcom/vungle/warren/downloader/DownloadRequest;

    iget-object p2, p2, Lj2;->b:Ljava/lang/Object;
...
.method private onSuccessMediator(Ljava/io/File;Lcom/vungle/warren/downloader/DownloadRequestMediator;)V
    ...
    iget-object v3, v1, Lj2;->a:Ljava/lang/Object;
    ...
    .line 17
    invoke-direct {p0, p1, v2, v1}, Lcom/vungle/warren/downloader/AssetDownloader;->copyToDestination(Ljava/io/File;Ljava/io/File;Lj2;)V
    ...
    iget-object v3, v3, Lcom/vungle/warren/downloader/DownloadRequest;->url:Ljava/lang/String;

    .line 19
    invoke-virtual {v2}, Ljava/io/File;->getPath()Ljava/lang/String;

    .line 20
    invoke-direct {p0, v1, v2}, Lcom/vungle/warren/downloader/AssetDownloader;->deliverSuccess(Lj2;Ljava/io/File;)V
...
.method private partialMalformed(JILlh0;Lcom/vungle/warren/downloader/DownloadRequestMediator;)Z
    .locals 1
    ...
    .line 1
    invoke-direct {p0, p4, p1, p2, p5}, Lcom/vungle/warren/downloader/AssetDownloader;->satisfiesPartialDownload(Llh0;JLcom/vungle/warren/downloader/DownloadRequestMediator;)Z
...
.method private pause(Lcom/vungle/warren/downloader/DownloadRequestMediator;Lcom/vungle/warren/downloader/AssetDownloadListener$Progress;Lcom/vungle/warren/downloader/AssetDownloadListener$DownloadError;)Z
    ...
    .line 5
    iget-object v4, v3, Lj2;->a:Ljava/lang/Object;
    ...
    .line 6
    :cond_1
    iget-boolean v5, v4, Lcom/vungle/warren/downloader/DownloadRequest;->pauseOnConnectionLost:Z

    if-nez v5, :cond_2

    .line 7
    invoke-virtual {p1, v4}, Lcom/vungle/warren/downloader/DownloadRequestMediator;->remove(Lcom/vungle/warren/downloader/DownloadRequest;)Lj2;

    .line 8
    iget-object v3, v3, Lj2;->b:Ljava/lang/Object;

    check-cast v3, Lcom/vungle/warren/downloader/AssetDownloadListener;

    invoke-direct {p0, v4, v3, p3}, Lcom/vungle/warren/downloader/AssetDownloader;->deliverError(Lcom/vungle/warren/downloader/DownloadRequest;Lcom/vungle/warren/downloader/AssetDownloadListener;Lcom/vungle/warren/downloader/AssetDownloadListener$DownloadError;)V
    ...
    .line 10
    invoke-direct {p0, v4}, Lcom/vungle/warren/downloader/AssetDownloader;->debugString(Lcom/vungle/warren/downloader/DownloadRequest;)Ljava/lang/String;
    ...
    invoke-direct {p0, p2, v4, v3}, Lcom/vungle/warren/downloader/AssetDownloader;->deliverProgress(Lcom/vungle/warren/downloader/AssetDownloadListener$Progress;Lcom/vungle/warren/downloader/DownloadRequest;Lcom/vungle/warren/downloader/AssetDownloadListener;)V
...
.method private responseVersionMatches(Llh0;Ljava/util/HashMap;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private satisfiesPartialDownload(Llh0;JLcom/vungle/warren/downloader/DownloadRequestMediator;)Z
    .locals 4
    ...
    invoke-virtual {v1, v2}, Lch0;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method public declared-synchronized cancelAll()V
    ...
    .line 2
    iget-object v2, v1, Lcom/vungle/warren/downloader/DownloadRequest;->url:Ljava/lang/String;
...
.method public cancelAndAwait(Lcom/vungle/warren/downloader/DownloadRequest;J)Z
    ...
    .line 6
    :try_start_0
    iget-object v2, p0, Lcom/vungle/warren/downloader/AssetDownloader;->transitioning:Ljava/util/List;
    ...
    .line 10
    invoke-direct {p0, v1, v2}, Lcom/vungle/warren/downloader/AssetDownloader;->sleep(J)V
