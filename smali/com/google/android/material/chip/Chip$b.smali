...
.method constructor <init>(Lcom/google/android/material/chip/Chip;Lcom/google/android/material/chip/Chip;)V
    ...
    .line 2
    invoke-direct {p0, p2}, Ls3;-><init>(Landroid/view/View;)V
...
.method protected r(FF)I
    ...
    invoke-static {v0}, Lcom/google/android/material/chip/Chip;->k(Lcom/google/android/material/chip/Chip;)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/chip/Chip;->l(Lcom/google/android/material/chip/Chip;)Landroid/graphics/RectF;
...
.method protected x(Ln3;)V
    ...
    invoke-virtual {v0}, Lcom/google/android/material/chip/Chip;->v()Z

    move-result v0

    invoke-virtual {p1, v0}, Ln3;->P(Z)V
    ...
    invoke-virtual {p1, v0}, Ln3;->S(Z)V
    ...
    .line 4
    invoke-virtual {p1, v0}, Ln3;->R(Ljava/lang/CharSequence;)V
    ...
    .line 10
    invoke-virtual {p1, v0}, Ln3;->p0(Ljava/lang/CharSequence;)V

    goto :goto_3

    .line 11
    :cond_3
    invoke-virtual {p1, v0}, Ln3;->V(Ljava/lang/CharSequence;)V

    :goto_3
    return-void
.end method

.method protected y(ILn3;)V
    .locals 6
    ...
    .line 8
    invoke-virtual {p2, p1}, Ln3;->V(Ljava/lang/CharSequence;)V

    .line 9
    iget-object p1, p0, Lcom/google/android/material/chip/Chip$b;->q:Lcom/google/android/material/chip/Chip;

    invoke-static {p1}, Lcom/google/android/material/chip/Chip;->n(Lcom/google/android/material/chip/Chip;)Landroid/graphics/Rect;

    move-result-object p1

    invoke-virtual {p2, p1}, Ln3;->M(Landroid/graphics/Rect;)V

    .line 10
    sget-object p1, Ln3$a;->g:Ln3$a;

    invoke-virtual {p2, p1}, Ln3;->b(Ln3$a;)V
    ...
    invoke-virtual {p2, p1}, Ln3;->X(Z)V

    goto :goto_0

    .line 12
    :cond_1
    invoke-virtual {p2, v0}, Ln3;->V(Ljava/lang/CharSequence;)V

    .line 13
    invoke-static {}, Lcom/google/android/material/chip/Chip;->o()Landroid/graphics/Rect;
...
.method protected z(IZ)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/material/chip/Chip;->m(Lcom/google/android/material/chip/Chip;Z)Z
