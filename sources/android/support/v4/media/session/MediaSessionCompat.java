...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((x) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            bundle2.putBinder(MediaSessionCompat.KEY_EXTRA_BINDER, iBinder);
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(x xVar) {
            long j;
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo(xVar);
                    if (z2 && z) {
                        onPause();
                    } else if (!z2 && z3) {
                        onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            x currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(x xVar);
        ...
        void setPlaybackToRemote(b0 b0Var);
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public int getRccTransportControlFlagsFromActions(long j) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j);
            return (j & 128) != 0 ? rccTransportControlFlagsFromActions | AdRequest.MAX_CONTENT_URL_LENGTH : rccTransportControlFlagsFromActions;
        }
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final x getCurrentControllerInfo() {
            return new x(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(x xVar) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private b0.a mVolumeCallback = new b0.a() {
            /* class android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.AnonymousClass1 */

            @Override // androidx.media.b0.a
            public void onVolumeChanged(b0 b0Var) {
                if (MediaSessionImplBase.this.mVolumeProvider == b0Var) {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    b0 b0Var = mediaSessionImplBase.mVolumeProvider;
                    if (i != 2) {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new x("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    MediaSessionImplBase.this.setCurrentControllerInfo(new x(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public x getCurrentControllerInfo() {
            x xVar;
            synchronized (this.mLock) {
                xVar = this.mRemoteUserInfo;
            }
            return xVar;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(b0 b0Var) {
            if (b0Var == null) {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public String toString() {
            StringBuilder q = ic.q("MediaSession.QueueItem {Description=");
            q.append(this.mDescription);
            q.append(", Id=");
            q.append(this.mId);
            q.append(" }");
            return q.toString();
    ...
    public void setPlaybackToRemote(b0 b0Var) {
        if (b0Var != null) {
            this.mImpl.setPlaybackToRemote(b0Var);
            return;
        }
        throw new IllegalArgumentException("volumeProvider may not be null!");
    }
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                if (!mediaSessionImplApi21.mDestroyed) {
                    ...
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new x(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
