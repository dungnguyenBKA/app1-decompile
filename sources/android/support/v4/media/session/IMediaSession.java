            ...
            if (i == TRANSACTION_rateWithExtras) {
                ...
                switch (i) {
                    ...
                    case 35:
                        ...
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_prepareFromUri /*{ENCODED_INT: 36}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        return true;
                    case TRANSACTION_isShuffleModeEnabledRemoved /*{ENCODED_INT: 38}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean isShuffleModeEnabledRemoved = isShuffleModeEnabledRemoved();
                        parcel2.writeNoException();
                        parcel2.writeInt(isShuffleModeEnabledRemoved ? 1 : 0);
                        return true;
                    case TRANSACTION_setRepeatMode /*{ENCODED_INT: 39}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        setRepeatMode(parcel.readInt());
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_setShuffleModeEnabledRemoved /*{ENCODED_INT: 40}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                            z = true;
                        }
                        ...
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_addQueueItem /*{ENCODED_INT: 41}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                        ...
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_addQueueItemAt /*{ENCODED_INT: 42}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                        ...
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_removeQueueItem /*{ENCODED_INT: 43}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                        ...
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_removeQueueItemAt /*{ENCODED_INT: 44}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        removeQueueItemAt(parcel.readInt());
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_isCaptioningEnabled /*{ENCODED_INT: 45}*/:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 46:
                        ...
                        parcel2.writeNoException();
                        return true;
                    case TRANSACTION_getShuffleMode /*{ENCODED_INT: 47}*/:
                        parcel.enforceInterface(DESCRIPTOR);
