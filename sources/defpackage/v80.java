...
public class v80 {
    ...
    public static java.util.Date b(java.lang.String r17, java.text.ParsePosition r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.v80.b(java.lang.String, java.text.ParsePosition):java.util.Date");
    }
    ...
    private static int c(String str, int i, int i2) {
        ...
        if (i < i2) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder q = ic.q("Invalid number: ");
                q.append(str.substring(i, i2));
        ...
        while (i4 < i2) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder q2 = ic.q("Invalid number: ");
                q2.append(str.substring(i, i2));
