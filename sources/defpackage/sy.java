...
public class sy {
    ...
    class a extends g {
        ...
        a(sy syVar, List list, Matrix matrix) {
            this.b = list;
            this.c = matrix;
        }

        @Override // defpackage.sy.g
        public void a(Matrix matrix, ey eyVar, int i, Canvas canvas) {
            for (g gVar : this.b) {
                gVar.a(this.c, eyVar, i, canvas);
            }
        }
    }
    ...
    public static class b extends g {
        ...
        public void a(Matrix matrix, ey eyVar, int i, Canvas canvas) {
            ...
            float f2 = dVar.g;
            d dVar2 = this.b;
            eyVar.a(canvas, matrix, new RectF(dVar2.b, dVar2.c, dVar2.d, dVar2.e), i, f, f2);
        }
    }
    ...
    public static class c extends g {
        ...
        public void a(Matrix matrix, ey eyVar, int i, Canvas canvas) {
            ...
            matrix2.preRotate(b());
            eyVar.b(canvas, matrix2, rectF, i);
        }
    ...
    public static abstract class g {
        ...
        public abstract void a(Matrix matrix, ey eyVar, int i, Canvas canvas);
    }
