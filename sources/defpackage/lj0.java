...
public class lj0<T> {
    ...
    lj0(Class<?> cls, String str, Class... clsArr) {
        this.a = cls;
        this.b = str;
        this.c = clsArr;
    }
    ...
    private java.lang.reflect.Method a(java.lang.Class<?> r4) {
        ...
        L_0x0026:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.lj0.a(java.lang.Class):java.lang.reflect.Method");
    }
    ...
    public Object b(T t, Object... objArr) {
        ...
        if (a2 != null) {
            ...
            q.append(this.b);
            q.append(" not supported for object ");
            q.append((Object) t);
