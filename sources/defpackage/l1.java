...
public class l1 {
    ...
    public static boolean c(java.io.File r0, android.content.res.Resources r1, int r2) {
        ...
        L_0x0017:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l1.c(java.io.File, android.content.res.Resources, int):boolean");
    }
    ...
    public static boolean d(java.io.File r5, java.io.InputStream r6) {
        ...
        L_0x0058:
            goto L_0x0057
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l1.d(java.io.File, java.io.InputStream):boolean");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.l1.a[] e(java.lang.String r16) {
        /*
        // Method dump skipped, instructions count: 272
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l1.e(java.lang.String):l1$a[]");
    }
    ...
    public static Path f(String str) {
        ...
        try {
            ...
            throw new RuntimeException(ic.i("Error in parsing ", str), e2);
        }
    }
    ...
    public static File h(Context context) {
        ...
        for (int i = 0; i < 100; i++) {
            File file = new File(cacheDir, ic.f(sb, i));
            try {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.nio.ByteBuffer i(android.content.Context r7, android.os.CancellationSignal r8, android.net.Uri r9) {
        /*
        ...
        L_0x004b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l1.i(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }
    ...
    public static class a {
        ...
        public static void b(a[] aVarArr, Path path) {
            ...
            while (i4 < aVarArr2.length) {
                char c5 = aVarArr2[i4].a;
                float[] fArr3 = aVarArr2[i4].b;
                float f20 = fArr2[c3];
                float f21 = fArr2[1];
                float f22 = fArr2[2];
                float f23 = fArr2[3];
        ...
        a(a aVar) {
            this.a = aVar.a;
            float[] fArr = aVar.b;
            this.b = l1.b(fArr, 0, fArr.length);
        }
    }
}
