...
public final class ti0 {
    static final ak0 a = ak0.e("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    static {
        ...
        while (true) {
            ...
            strArr[i2] = rh0.o("%8s", Integer.toBinaryString(i2)).replace(' ', '0');
            i2++;
        }
        String[] strArr2 = c;
        strArr2[0] = "";
        ...
        for (int i3 = 0; i3 < 1; i3++) {
            int i4 = iArr[i3];
            String[] strArr3 = c;
            strArr3[i4 | 8] = ic.l(new StringBuilder(), strArr3[i4], "|PADDED");
        }
        String[] strArr4 = c;
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            ...
            for (int i7 = 0; i7 < 1; i7++) {
                ...
                sb.append('|');
                strArr5[i9 | 8] = ic.l(sb, strArr5[i6], "|PADDED");
            }
        }
        while (true) {
            String[] strArr6 = c;
    ...
    static String a(boolean z, int i, int i2, byte b2, byte b3) {
        String str;
        String[] strArr = b;
        String o = b2 < strArr.length ? strArr[b2] : rh0.o("0x%02x", Byte.valueOf(b2));
        if (b3 == 0) {
            str = "";
        } else {
            if (!(b2 == 2 || b2 == 3)) {
        ...
        objArr[3] = o;
        objArr[4] = str;
        return rh0.o("%s 0x%08x %5d %-13s %s", objArr);
    }

    static IllegalArgumentException b(String str, Object... objArr) {
        throw new IllegalArgumentException(rh0.o(str, objArr));
    }

    static IOException c(String str, Object... objArr) {
        throw new IOException(rh0.o(str, objArr));
    }
}
