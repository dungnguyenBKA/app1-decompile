...
public class cj0 {
    ...
    private static final cj0 d = new cj0();
    ...
    public void b(ak0 ak0, yj0 yj0) {
        ...
        if (b2 > 0) {
            ((xj0) yj0).u0((int) (((long) (255 >>> b2)) | (j << (8 - b2))));
        }
    }

    /* access modifiers changed from: package-private */
    public int c(ak0 ak0) {
        long j = 0;
        for (int i = 0; i < ak0.m(); i++) {
            j += (long) c[ak0.f(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
