...
public abstract class a {
    protected final x<String, Method> a;
    protected final x<String, Method> b;
    protected final x<String, Class> c;

    public a(x<String, Method> xVar, x<String, Method> xVar2, x<String, Class> xVar3) {
        this.a = xVar;
        this.b = xVar2;
        this.c = xVar3;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: androidx.versionedparcelable.a */
