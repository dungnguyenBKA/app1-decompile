...
public class AlertController {
    ...
    public AlertController(Context context, o oVar, Window window) {
        ...
        this.c = window;
        this.Q = new c(oVar);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, R$styleable.f, R.attr.ad, 0);
    ...
    public void c() {
        ...
        View findViewById2 = this.c.findViewById(R.id.mk);
        View findViewById3 = findViewById2.findViewById(R.id.sh);
        View findViewById4 = findViewById2.findViewById(R.id.fo);
        View findViewById5 = findViewById2.findViewById(R.id.eu);
        ViewGroup viewGroup = (ViewGroup) findViewById2.findViewById(R.id.fs);
        View view4 = this.h;
        int i3 = 0;
        if (view4 == null) {
        ...
        if (z3) {
            FrameLayout frameLayout = (FrameLayout) this.c.findViewById(R.id.fr);
        ...
        View findViewById6 = viewGroup.findViewById(R.id.sh);
        View findViewById7 = viewGroup.findViewById(R.id.fo);
        View findViewById8 = viewGroup.findViewById(R.id.eu);
        ...
        NestedScrollView nestedScrollView = (NestedScrollView) this.c.findViewById(R.id.ow);
        ...
        context.getTheme().resolveAttribute(R.attr.ac, typedValue, true);
        ...
        if (this.G != null) {
            ...
            this.c.findViewById(R.id.sd).setVisibility(8);
        } else {
            ...
            if (!(!TextUtils.isEmpty(this.e)) || !this.P) {
                ...
                TextView textView2 = (TextView) this.c.findViewById(R.id.c6);
                this.E = textView2;
        ...
        if (!z6 && (findViewById = e3.findViewById(R.id.rr)) != null) {
        ...
        if (z5) {
            ...
            if (this.f == null && this.g == null) {
                ...
                view3 = e2.findViewById(R.id.sa);
            }
            if (view3 != null) {
                view3.setVisibility(0);
            }
        } else {
            View findViewById9 = e3.findViewById(R.id.rs);
        ...
        if (!z4) {
            ...
            if (view5 != null) {
                ...
                char c3 = z5 ? 1 : 0;
                int i9 = i8 | i3;
                View findViewById10 = this.c.findViewById(R.id.ov);
                View findViewById11 = this.c.findViewById(R.id.ou);
                ...
                if (i10 >= 23) {
                    ...
                    if (!(findViewById10 == null && view2 == null)) {
                        if (this.f != null) {
                            this.A.C(new b(this, findViewById10, view2));
                            this.A.post(new c(this, findViewById10, view2));
                        } else {
                            ListView listView2 = this.g;
                            if (listView2 != null) {
                                listView2.setOnScrollListener(new d(this, findViewById10, view2));
                                this.g.post(new e(this, findViewById10, view2));
                            } else {
                                if (findViewById10 != null) {
                                    e3.removeView(findViewById10);
                                }
