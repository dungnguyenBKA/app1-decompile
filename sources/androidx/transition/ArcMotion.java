...
public class ArcMotion extends PathMotion {
    ...
    public Path a(float f, float f2, float f3, float f4) {
        ...
        if (f15 != 0.0f) {
            ...
            f6 = ic.a(f6, f11, sqrt, f11);
            f7 = ic.a(f7, f12, sqrt, f12);
        }
    ...
    public ArcMotion(Context context, AttributeSet attributeSet) {
        ...
        this.b = b(c1.h(obtainStyledAttributes, xmlPullParser, "minimumVerticalAngle", 1, 0.0f));
        this.a = b(c1.h(obtainStyledAttributes, xmlPullParser, "minimumHorizontalAngle", 0, 0.0f));
        this.c = b(c1.h(obtainStyledAttributes, xmlPullParser, "maximumAngle", 2, 70.0f));
