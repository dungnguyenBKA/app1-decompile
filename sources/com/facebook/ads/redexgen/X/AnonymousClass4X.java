...
public abstract class AnonymousClass4X {
    ...
    public int A00 = -1;
    public View A01;
    public AnonymousClass4K A02;
    public C0469Eq A03;
    public boolean A04;
    public boolean A05;
    public final AnonymousClass4V A06 = new AnonymousClass4V(0, 0);
    ...
    public abstract void A0I(int i, int i2, AnonymousClass4Z v, AnonymousClass4V v2);

    public abstract void A0J(View view, AnonymousClass4Z v, AnonymousClass4V v2);
    ...
    public void A05(int i, int i2) {
        C0469Eq eq = this.A03;
        if (!this.A05 || this.A00 == -1 || eq == null) {
            A0A();
        }
        this.A04 = false;
        View view = this.A01;
        if (view != null) {
            ...
            strArr2[0] = "WYaFIbeKL";
            if (A002 == i3) {
                A0J(this.A01, eq.A0s, this.A06);
                AnonymousClass4V r4 = this.A06;
                if (A08[5].length() != 9) {
                    String[] strArr3 = A08;
                    strArr3[6] = "M";
                    strArr3[2] = "Q";
    ...
    @Nullable
    public final AnonymousClass4K A09() {
        return this.A02;
    }
    ...
    public final void A0E(C0469Eq eq, AnonymousClass4K r5) {
        this.A03 = eq;
        this.A02 = r5;
        if (this.A00 != -1) {
