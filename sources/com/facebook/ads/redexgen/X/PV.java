...
public final class PV extends FrameLayout implements PE {
    public static String[] A08;
    public static final int A09 = ((int) (C0632Lh.A01 * 250.0f));
    public static final int A0A = ((int) (C0632Lh.A01 * 350.0f));
    public static final int A0B = ((int) (C0632Lh.A01 * 175.0f));
    public static final int A0C = ((int) (C0632Lh.A01 * 12.0f));
    public static final int A0D = ((int) (C0632Lh.A01 * 8.0f));
    public static final int A0E = ((int) (C0632Lh.A01 * 6.0f));
    @Nullable
    public TextView A00;
    @Nullable
    public TextView A01;
    ...
    public PV(XJ xj, NativeAd nativeAd, C0578Ja ja, EnumC0579Jb jb, C0690No no, MediaView mediaView, AdOptionsView adOptionsView) {
        super(xj);
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new PF(xj, this.A05, ja, no, adOptionsView);
        PF pf = this.A06;
        int i = A0C;
        pf.setPadding(i, i, i, A0E);
        addView(this.A06, new FrameLayout.LayoutParams(-1, -2));
        if (jb == EnumC0579Jb.A09 || jb == EnumC0579Jb.A0B) {
            A08(ja);
        }
        addView(this.A04, new FrameLayout.LayoutParams(-1, -2));
        if (!(jb == EnumC0579Jb.A0B && this.A05.getAdCreativeType() == NativeAd.AdCreativeType.CAROUSEL)) {
            A07(ja);
            A05(ja);
            A06(ja);
        }
    ...
    private void A03(int i) {
        ...
        C0632Lh.A0Q(textView, i3);
        TextView textView2 = this.A00;
        if (i <= A09) {
            i4 = 8;
        }
        C0632Lh.A0Q(textView2, i4);
    }

    public static void A04(int i, int i2, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            if (textView != null && textView.getVisibility() == 0) {
                int A052 = C0632Lh.A05(textView, i2);
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        PF pf = this.A06;
        pf.layout(i, i2, i3, pf.getMeasuredHeight() + i2);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.A04.getMediaWidth() == 0 || this.A04.getMediaHeight() == 0) {
            i3 = A002;
        } else if (((C0836Th) this.A04.getMediaViewApi()).A0K()) {
            i3 = A002;
        } else {
