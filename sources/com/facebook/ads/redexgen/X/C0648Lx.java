...
public final class C0648Lx implements SensorEventListener {
    ...
    public final XJ A08;
    public final Set<AbstractC0647Lw> A09 = new CopyOnWriteArraySet();
    ...
    private void A01() {
        ...
        if (this.A07 == null) {
            Toast.makeText(this.A08, A00(0, 21, FacebookMediationAdapter.ERROR_NULL_CONTEXT), 1).show();
        }
        boolean z = false;
        try {
    ...
    public final void A03(AbstractC0647Lw lw) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(lw)) {
            return;
        }
        this.A09.add(lw);
    }
            ...
            if (elapsedRealtime - j > 100) {
                if ((Math.abs(((((sensorEvent.values[0] + sensorEvent.values[1]) + sensorEvent.values[2]) - this.A00) - this.A01) - this.A02) / ((float) (elapsedRealtime - j))) * 10000.0f > 800.0f) {
                    ...
                    if (i >= 3 && elapsedRealtime - this.A05 > 1000) {
                        ...
                        this.A03 = 0;
                        for (AbstractC0647Lw lw : this.A09) {
                            lw.ABb();
                        }
                    }
