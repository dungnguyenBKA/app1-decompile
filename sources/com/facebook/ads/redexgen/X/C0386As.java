...
public final class C0386As {
    public static byte[] A02;
    public static final C0386As A03 = new C0386As(new int[]{2}, 2);
    ...
    public static C0386As A00(Context context) {
        return A01(context.registerReceiver(null, new IntentFilter(A02(56, 36, 98))));
    }

    @SuppressLint({"InlinedApi"})
    public static C0386As A01(Intent intent) {
        if (intent == null || intent.getIntExtra(A02(92, 36, 85), 0) == 0) {
            return A03;
        }
        return new C0386As(intent.getIntArrayExtra(A02(128, 29, 70)), intent.getIntExtra(A02(157, 37, 92), 0));
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof C0386As)) {
            return false;
        }
        C0386As audioCapabilities = (C0386As) obj;
