...
public class VZ implements AbstractC02866k {
    ...
    @Nullable
    public final String A05 = ((String) A02(A03(29, 6, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS)));
    @Nullable
    ...
    public final boolean A80(Object obj) {
        ...
        if (str4 == null || !str4.equals(vz.A03) || (str = this.A04) == null || !str.equals(vz.A04) || (bool = this.A00) == null || !bool.equals(vz.A00) || (str2 = this.A05) == null || !str2.equals(vz.A05) || (num = this.A02) == null || !num.equals(vz.A02) || (str3 = this.A06) == null || !str3.equals(vz.A06)) {
            return false;
        }
        return true;
    }
