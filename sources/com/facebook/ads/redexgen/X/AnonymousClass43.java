...
public final class AnonymousClass43 {
    ...
    public final AnonymousClass42 A00;
    ...
    public AnonymousClass43(AnonymousClass42 r1) {
        this.A00 = r1;
    }

    private int A00(List<C02043f> list) {
        boolean z = false;
    ...
    private void A02(List<C02043f> list, int i, int i2) {
        C02043f r5 = list.get(i);
        C02043f nextOp = list.get(i2);
        int i3 = nextOp.A00;
        if (i3 == 1) {
            String[] strArr = A01;
    ...
    private void A03(List<C02043f> list, int i, C02043f r6, int i2, C02043f r8) {
        int i3 = 0;
        if (r6.A01 < r8.A02) {
            i3 = 0 - 1;
        }
    ...
    private final void A04(List<C02043f> list, int i, C02043f r11, int i2, C02043f r13) {
        boolean z;
        C02043f r2 = null;
        boolean z2 = false;
        if (r11.A02 < r11.A01) {
        ...
        if (r11.A02 <= r13.A02) {
            ...
            r2 = this.A00.A9D(2, r11.A02 + 1, (r13.A02 + r13.A01) - r11.A02, null);
    ...
    private final void A05(List<C02043f> list, int i, C02043f r11, int i2, C02043f r13) {
        C02043f r6 = null;
        C02043f r4 = null;
        if (r11.A01 < r13.A02) {
            r13.A02--;
            ...
            r13.A01--;
            r6 = this.A00.A9D(4, r11.A02, 1, r13.A03);
        }
        if (r11.A02 <= r13.A02) {
            r13.A02++;
        } else if (r11.A02 < r13.A02 + r13.A01) {
            int i3 = (r13.A02 + r13.A01) - r11.A02;
            r4 = this.A00.A9D(4, r11.A02 + 1, i3, r13.A03);
            r13.A01 -= i3;
        }
        list.set(i2, r11);
        if (r13.A01 > 0) {
    ...
    public final void A06(List<C02043f> list) {
        while (true) {
            int A002 = A00(list);
            if (A002 != -1) {
