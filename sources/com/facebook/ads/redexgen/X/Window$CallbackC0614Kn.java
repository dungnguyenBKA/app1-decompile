...
public final class Window$CallbackC0614Kn implements Window.Callback {
    public static final List<Km> A02 = Collections.synchronizedList(new ArrayList());
    public Activity A00;
    public Window.Callback A01;

    public Window$CallbackC0614Kn(Window.Callback callback, Activity activity) {
        this.A01 = callback;
        this.A00 = activity;
    }

    public static void A00(Km km) {
        A02.add(km);
    }
