...
public enum EnumC02846i {
    ...
    public static final Map<Integer, EnumC02846i> A03 = new HashMap();
    public int A00;
    ...
    static {
        A04();
        A03();
        EnumC02846i[] values = values();
        for (EnumC02846i r2 : values) {
            A03.put(Integer.valueOf(r2.A00), r2);
        }
    }
    ...
    @Nullable
    public static EnumC02846i A00(int i) {
    ...
    public static EnumSet<EnumC02846i> A02(int i) throws Exception {
        EnumSet<EnumC02846i> noneOf = EnumSet.noneOf(EnumC02846i.class);
        if (i <= 0) {
            return noneOf;
        }
        EnumC02846i[] values = values();
