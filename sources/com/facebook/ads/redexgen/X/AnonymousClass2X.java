...
public class AnonymousClass2X<K, V> {
    ...
    public int A00 = 0;
    public int[] A01 = AnonymousClass2N.A00;
    public Object[] A02 = AnonymousClass2N.A02;
    ...
    public static int A02(int[] iArr, int i, int i2) {
        try {
            return AnonymousClass2N.A02(iArr, i, i2);
    ...
    public final V A0B(int i) {
        ...
        if (i3 <= 1) {
            ...
            this.A01 = AnonymousClass2N.A00;
            this.A02 = AnonymousClass2N.A02;
            i2 = 0;
        } else {
            i2 = i3 - 1;
            int[] iArr = this.A01;
    ...
    /* JADX INFO: Multiple debug info for r7v2 com.facebook.ads.redexgen.X.2X: [D('mine' V), D('map' com.facebook.ads.internal.androidx.support.v4.util.SimpleArrayMap<?, ?>), D('theirs' java.lang.Object)] */
    public final boolean equals(Object obj) {
        if (this == obj) {
            return true;
        }
        if (obj instanceof AnonymousClass2X) {
            SimpleArrayMap<?, ?> map = (AnonymousClass2X) obj;
            if (size() != map.size()) {
                return false;
            }
