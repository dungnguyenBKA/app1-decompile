...
public final class AnonymousClass2A {
    ...
    public AnonymousClass2A() {
    }

    public AnonymousClass2A(JJ jj) {
        this.A00 = jj;
    }
    ...
    public final void A09(AnonymousClass29 r6) {
    ...
    public final void A0A(AnonymousClass29 r6, int i) {
        List<String> list = this.A02;
