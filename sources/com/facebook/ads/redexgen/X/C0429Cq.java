...
public final class C0429Cq {
    ...
    public static C0428Cp A00(int i, long[] jArr, int[] iArr, long j) {
        int i2 = 8192 / i;
        int i3 = 0;
        for (int i4 : iArr) {
            i3 += C0556Ic.A04(i4, i2);
        }
        ...
        return new C0428Cp(jArr2, iArr2, i5, jArr3, iArr3, j * ((long) i6));
    }
}
