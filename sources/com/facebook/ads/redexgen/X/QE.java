...
public final class QE {
    ...
    public static final String A0I = QE.class.getSimpleName();
    public int A00;
    public int A01;
    public int A02;
    public long A03;
    public AbstractRunnableC0603Kb A04;
    public QF A05;
    ...
    public final XJ A0D;
    public final WeakReference<QD> A0E;
    ...
    public QE(View view, int i, int i2, boolean z, WeakReference<QD> weakReference, XJ xj) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = AdError.NETWORK_ERROR_CODE;
        this.A08 = true;
        this.A05 = new QF(AnonymousClass0Q.A0M);
    ...
    public QE(View view, int i, WeakReference<QD> weakReference, XJ xj) {
        this(view, i, 0, false, weakReference, xj);
    }

    public QE(View view, int i, boolean z, WeakReference<QD> weakReference, XJ xj) {
        this(view, i, 0, z, weakReference, xj);
    }
    ...
    public static /* synthetic */ int A05(QE qe) {
        int i = qe.A00;
        qe.A00 = i + 1;
        return i;
    }
    ...
    /* JADX INFO: Multiple debug info for r1v15 android.graphics.Rect: [D('yPos' int), D('leftEdgeIndex' int)] */
    ...
    public static int A08(java.util.Vector<android.graphics.Rect> r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.QE.A08(java.util.Vector):int");
    }
    ...
    /* JADX INFO: Multiple debug info for r12v0 android.view.View: [D('widthPixels' int), D('e' java.lang.NullPointerException), D('blockLockScreens' boolean), D('visibleAreaThreshold' float)] */
    /* JADX INFO: Multiple debug info for r14v0 com.facebook.ads.redexgen.X.XJ: [D('verticalInvisibleThreshold' int), D('visibleAreaThreshold' float), D('windowInfo' java.util.Map<java.lang.String, java.lang.String>)] */
    /* JADX INFO: Multiple debug info for r1v18 java.util.Vector<android.graphics.Rect>: [D('rectVector' java.util.Vector<android.graphics.Rect>), D('metrics' android.util.DisplayMetrics)] */
    /* JADX INFO: Multiple debug info for r0v29 int: [D('areaSize' int), D('visiblePercent' float)] */
    /* JADX INFO: Multiple debug info for r2v8 int: [D('targetRect' android.graphics.Rect), D('targetAreaSize' int)] */
    public static QF A0E(View view, int i, XJ xj) {
        DisplayMetrics displayMetrics;
        if (view == null) {
            A0O(null, false, A0H(472, 16, 113));
            return new QF(AnonymousClass0Q.A08);
        }
        boolean A1h = J4.A1h(xj);
        String A0H2 = A0H(534, 37, 121);
        String A0H3 = A0H(331, 22, 99);
        if (A1h) {
            if (view.getParent() == null) {
                A0O(view, false, A0H3);
                return new QF(AnonymousClass0Q.A0K);
            } else if (!view.isShown()) {
                A0O(view, false, A0H2);
                return new QF(AnonymousClass0Q.A0N);
            }
        } else if (view.getParent() == null) {
            A0O(view, false, A0H3);
            return new QF(AnonymousClass0Q.A0H);
        } else if (!view.isShown()) {
            A0O(view, false, A0H2);
            return new QF(AnonymousClass0Q.A0H);
        }
            ...
            if (A0H[4].charAt(15) == 'A') {
                ...
                try {
                    ...
                    if (!view.getGlobalVisibleRect(rect)) {
                        return new QF(AnonymousClass0Q.A07);
                    }
                    int heightPixels = Build.VERSION.SDK_INT;
                    if (A0H[1].length() == 16) {
                        A0H[1] = "Od97VXu84qI514kY";
                        if (heightPixels >= 17) {
                            Display display = ((WindowManager) xj.getSystemService(A0H(713, 6, 30))).getDefaultDisplay();
                            displayMetrics = new DisplayMetrics();
                            display.getRealMetrics(displayMetrics);
                        } else {
                            displayMetrics = xj.getResources().getDisplayMetrics();
                        }
                        ...
                        if (A1Z) {
                            ...
                            if (rect.top - iArr[1] > widthPixels) {
                                ...
                                return new QF(AnonymousClass0Q.A0E, A082);
                            } else if ((iArr[1] + height) - rect.bottom > widthPixels) {
                                A0O(view, false, A0H(397, 39, 30));
                                return new QF(AnonymousClass0Q.A0C, A082);
                            }
                        }
                        if (!C0649Ly.A03(xj)) {
                            A0O(view, false, A0H(185, 26, 62));
                            return new QF(AnonymousClass0Q.A0L, A082);
                        }
                        Map<String, String> A012 = C0650Lz.A01(xj);
                        if (C0633Li.A05(A012)) {
                            A0O(view, false, A0H(156, 29, 77));
                            return new QF(AnonymousClass0Q.A0A, A082);
                        } else if (!J4.A1E(xj) || !C0633Li.A04(A012)) {
                            A0O(view, true, A0H(515, 19, 99));
                            return new QF(AnonymousClass0Q.A0J, A082, A012);
                        } else {
                            A0O(view, false, A0H(31, 31, 14));
                            return new QF(AnonymousClass0Q.A05, A082, A012);
                        }
                    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
            ...
            if (!(childAt instanceof C0933Xb) || !QG.A00(childAt)) {
                z2 = true;
            }
            if (z && z2) {
    ...
    public static Vector<Rect> A0L(View view) {
        ...
        if (!(view instanceof ViewGroup) || (!QG.A00(view) && i == 0)) {
            Rect rect = new Rect();
            if (view.getGlobalVisibleRect(rect)) {
                vector.add(rect);
            }
    ...
    public static void A0O(View view, boolean z, String str) {
        ...
        if (BuildConfigApi.isDebug()) {
            ...
            sb.append(A0H(240, 5, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD));
            sb.append(view);
            sb.append(A0H(9, 4, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS));
            if (z) {
                A0H2 = A0H(698, 8, 68);
            } else {
                A0H2 = A0H(684, 12, 97);
    ...
    public final synchronized String A0S() {
        String str;
        AnonymousClass0Q r0 = AnonymousClass0Q.values()[this.A05.A01()];
    ...
    public final synchronized Map<String, String> A0T() {
        ...
        hashMap.put(A0H(706, 2, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), String.valueOf(this.A05.A00()));
        hashMap.put(A0H(696, 2, 84), new JSONObject(this.A06).toString());
        hashMap.put(A0H(711, 2, 69), LZ.A05(this.A03));
    ...
    public final synchronized void A0V() {
        ...
        this.A04 = new C02635n(this, this.A0D);
