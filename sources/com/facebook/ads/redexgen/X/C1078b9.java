...
public final class C1078b9 implements HI {
    ...
    public final long ACC(HM hm) throws IOException {
        ...
        if (A00(102, 4, 62).equals(scheme)) {
            String[] A0m = C0556Ic.A0m(uri.getSchemeSpecificPart(), A00(0, 1, 18));
            if (A0m.length == 2) {
                ...
                if (strArr[4].length() != strArr[0].length()) {
                    ...
                    if (str.contains(A00(1, 7, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE))) {
                        try {
                            this.A02 = Base64.decode(dataString, 0);
                        } catch (IllegalArgumentException e) {
                            throw new AJ(A00(8, 43, 126) + dataString, e);
                        }
                    } else {
            ...
            throw new AJ(A00(59, 23, 21) + uri);
        }
        throw new AJ(A00(82, 20, 99) + scheme);
    }
