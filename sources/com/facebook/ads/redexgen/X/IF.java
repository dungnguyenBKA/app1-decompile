...
public final class IF {
    ...
    public static final ArrayList<IE> A02 = new ArrayList<>();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0044, code lost:
        if (r10.equals(A04(350, 14, 97)) != false) goto L_0x0046;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x005b, code lost:
        if (r10.equals(A04(350, 8, 62)) != false) goto L_0x0046;
     */
    ...
    public static int A00(java.lang.String r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.IF.A00(java.lang.String):int");
    }
    ...
    public static int A01(String str) {
        ...
        if (A0C(str)) {
            ...
            A01[2] = "Tbf";
            return 2;
        } else if (A0B(str) || A04(23, 19, 49).equals(str) || A04(42, 19, 78).equals(str) || A04(193, 25, 9).equals(str) || A04(306, 20, 43).equals(str) || A04(FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD, 20, 74).equals(str) || A04(239, 28, 97).equals(str) || A04(218, 21, 14).equals(str) || A04(267, 19, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION).equals(str) || A04(130, 18, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT).equals(str) || A04(95, 15, 90).equals(str) || A04(61, 19, 98).equals(str)) {
            return 3;
        } else {
    ...
    public static String A03(int i) {
        ...
        if (i != 35) {
            if (i != 64) {
                if (i == 163) {
                    ...
                    return A04(576, 10, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT);
                } else if (i == 177) {
                    ...
                    switch (i) {
                        ...
                        case 102:
                        case FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT /*{ENCODED_INT: 103}*/:
                        case FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION /*{ENCODED_INT: 104}*/:
                            break;
                        case FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS /*{ENCODED_INT: 105}*/:
                        case FacebookMediationAdapter.ERROR_NULL_CONTEXT /*{ENCODED_INT: 107}*/:
                            if (A01[3].charAt(8) != '5') {
                                return A04(379, 10, 26);
                            }
                            A01[3] = "3bsHpIyd5cpBijoTJ4OMmefdCTR5gTxx";
                            return A04(379, 10, 26);
                        case FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE /*{ENCODED_INT: 106}*/:
        ...
        if (strArr5[7].charAt(25) != strArr5[1].charAt(25)) {
            return A04(532, 10, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT);
        }
        String[] strArr6 = A01;
        strArr6[6] = "P8Y4RDrDcLRp9FcHeOWRUzIMEfiRWdjY";
        strArr6[4] = "CxyRoddQ3h3V8143CrsBrhzN8eEi9nxs";
        return A04(532, 10, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT);
    }

    /* JADX WARNING: Code restructure failed: missing block: B:67:0x01c7, code lost:
        if (r3.startsWith(A04(477, 4, 8)) == false) goto L_0x01c9;
     */
    ...
    public static java.lang.String A05(@androidx.annotation.Nullable java.lang.String r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.IF.A05(java.lang.String):java.lang.String");
    }
