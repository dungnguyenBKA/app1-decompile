...
public final class BI {
    ...
    /* JADX INFO: Multiple debug info for r11v0 'this'  com.facebook.ads.redexgen.X.BI: [D('state' int), D('elapsedTimeSinceStopUs' long)] */
    private long A00() {
    ...
    private void A09(long j, long audioTimestampSystemTimeUs) {
        if (this.A0I.A09(j)) {
            ...
            if (Math.abs(A032 - j) > 5000000) {
                this.A0N.ABm(audioTimestampPositionFrames, A032, j, audioTimestampSystemTimeUs);
                this.A0I.A05();
            } else if (Math.abs(A02(audioTimestampPositionFrames) - audioTimestampSystemTimeUs) > 5000000) {
                this.A0N.ABE(audioTimestampPositionFrames, A032, j, audioTimestampSystemTimeUs);
                this.A0I.A05();
            } else {
                this.A0I.A04();
            }
    ...
    private boolean A0A() {
        if (this.A0M && this.A0H.getPlayState() == 2 && A00() == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void A0H(AudioTrack audioTrack, int i, int i2, int i3) {
        ...
        this.A02 = i2;
        this.A00 = i3;
        this.A0I = new BF(audioTrack);
        this.A03 = audioTrack.getSampleRate();
        this.A0M = A0B(i);
        this.A0L = C0556Ic.A0d(i);
        if (this.A0L) {
            j = A02((long) (i3 / i2));
        } else {
    ...
    public final boolean A0M(long j) {
        ...
        boolean z = this.A0K;
        this.A0K = A0K(j);
        if (z && !this.A0K && playState != 1 && (bg = this.A0N) != null) {
            bg.ABt(this.A00, C03639u.A01(this.A05));
        }
        return true;
    }
}
