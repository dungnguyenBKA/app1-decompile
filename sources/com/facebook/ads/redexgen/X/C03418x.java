...
public final class C03418x {
    public static byte[] A0F;
    public static final AdPlacementType A0G = AdPlacementType.UNKNOWN;
    public static final String A0H = C03418x.class.getSimpleName();
    public int A00 = -1;
    public int A01 = -1;
    public int A02 = 3600;
    public int A03 = 1;
    ...
    public int A07 = HttpStatus.SC_OK;
    public int A08 = 0;
    public int A09 = AdError.NETWORK_ERROR_CODE;
    public int A0A = 0;
    public AdPlacementType A0B = A0G;
    public List<C03398v> A0C = null;
    public boolean A0D = false;
    public final long A0E = System.currentTimeMillis();

    /* JADX WARNING: Error to parse debug info: Index 13 out of bounds for length 13 in method: com.facebook.ads.redexgen.X.8x.<init>(java.util.Map<java.lang.String, java.lang.String>):void, file: assets/audience_network.dex
    ...
    public C03418x(Map<String, String> map) {
        char c;
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            switch (key.hashCode()) {
                ...
                case -553208868:
                    ...
                    break;
                case 3575610:
                    if (key.equals(A01(HttpStatus.SC_CREATED, 4, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION))) {
                        c = 0;
                        break;
                    }
                    c = 65535;
                    break;
                case 700812481:
                    if (key.equals(A01(FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS, 26, 17))) {
                        c = 1;
                        break;
                    }
                    c = 65535;
                ...
                case 858630459:
                    ...
                    break;
                case 986744879:
                    if (key.equals(A01(HttpStatus.SC_RESET_CONTENT, 27, 35))) {
                        c = '\r';
                        break;
                    }
                    c = 65535;
            ...
            switch (c) {
                ...
                case VungleException.NO_AUTO_CACHED_PLACEMENT /*{ENCODED_INT: 12}*/:
                    this.A0C = C03398v.A01(entry.getValue());
                    try {
                        CookieManager instance = CookieManager.getInstance();
                        boolean acceptCookie = instance.acceptCookie();
                        instance.setAcceptCookie(true);
                        for (C03398v r7 : this.A0C) {
                            if (r7.A05()) {
    ...
    public static void A02() {
        A0F = new byte[]{47, 80, 123, 121, 117, 125, 122, 41, 30, 96, 93, 85, 76, 87, 64, 86, 24, 1, 74, 91, 78, 82, 7, 21, 76, 15, 40, 32, 37, 44, 45, 105, 61, 38, 105, 58, 44, 61, 105, 42, 38, 38, 34, 32, 44, 103, 47, 45, 47, 36, 41, 45, 46, 32, 41, 87, 91, 90, 66, 107, 64, 70, 85, 87, 95, 93, 90, 83, 107, 80, 85, 64, 85, 56, 63, 39, 48, 61, 56, 53, 48, 37, 56, 62, 63, 14, 53, 36, 35, 48, 37, 56, 62, 63, 14, 56, 63, 14, 34, 52, 50, 62, 63, 53, 34, 14, 10, 13, 60, 21, 10, 6, 20, 2, 1, 10, 15, 10, 23, 26, 60, 19, 6, 17, 0, 6, 13, 23, 2, 4, 6, 75, 87, 90, 88, 94, 86, 94, 85, 79, 100, 83, 94, 82, 92, 83, 79, 75, 87, 90, 88, 94, 86, 94, 85, 79, 100, 76, 82, 95, 79, 83, 64, 87, 84, 64, 87, 65, 90, 94, 73, 74, 94, 73, 95, 68, 115, 88, 68, 94, 73, 95, 68, 67, 64, 72, 75, 92, 72, 76, 92, 74, 77, 102, 77, 80, 84, 92, 86, 76, 77, 110, 99, 106, Byte.MAX_VALUE, 39, 56, 53, 52, 62, 14, 37, 56, 60, 52, 14, 33, 62, 61, 61, 56, 63, 54, 14, 56, 63, 37, 52, 35, 39, 48, 61, 89, 70, 74, 88, 78, 77, 70, 67, 70, 91, 86, 112, 76, 71, 74, 76, 68, 112, 70, 65, 70, 91, 70, 78, 67, 112, 75, 74, 67, 78, 86, 64, 95, 83, 65, 87, 84, 95, 90, 95, 66, 79, 105, 85, 94, 83, 85, 93, 105, 95, 88, 66, 83, 68, 64, 87, 90, 66, 93, 81, 67, 85, 86, 93, 88, 93, 64, 77, 107, 87, 92, 81, 87, 95, 107, 64, 93, 87, 95, 81, 70};
    }
    ...
    public static C03418x A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        return new C03418x(hashMap);
    }

    public final int A03() {
        return this.A02 * AdError.NETWORK_ERROR_CODE;
    }
    ...
    public final long A0A() {
        return (long) (this.A04 * AdError.NETWORK_ERROR_CODE);
    }

    public final long A0B() {
        return (long) (this.A05 * AdError.NETWORK_ERROR_CODE);
    }
