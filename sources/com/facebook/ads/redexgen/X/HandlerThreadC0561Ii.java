...
public class HandlerThreadC0561Ii extends HandlerThread implements Handler.Callback {
    ...
    public HandlerThreadC0561Ii() {
        super(A00(77, 12, 38));
    }

    private void A01() {
        C0551Hx.A01(this.A01);
        this.A01.A09();
    }
    ...
    public final DummySurface A05(int i) {
        ...
        if (runtimeException == null) {
            ...
            if (error == null) {
                return (DummySurface) C0551Hx.A01(this.A02);
            }
            throw error;
        }
    ...
    /* JADX INFO: Multiple debug info for r6v0 'this'  com.facebook.ads.redexgen.X.Ii: [D('e' java.lang.RuntimeException), D('e' java.lang.Throwable), D('e' java.lang.Error)] */
