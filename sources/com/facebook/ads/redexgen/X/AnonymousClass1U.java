...
public final class AnonymousClass1U implements Serializable {
    public static byte[] A0D = null;
    public static String[] A0E = null;
    public static final AnonymousClass1V A0F = AnonymousClass1V.A03;
    public static final EnumC0679Nd A0G = EnumC0679Nd.A05;
    public static final long serialVersionUID = -5352540123250859603L;
    public String A00;
    public final int A01;
    public final int A02;
    public final AnonymousClass1V A03;
    public final EnumC0679Nd A04;
    ...
    public static void A07() {
        A0E = new String[]{"U8UpqfD5GcCjHjfawFZje9GDKAZv", "HUavThSyJs21QkbQiVkA2MVijDNZ2nZM", "IARTRQxD0JaHLqaDLyMBN", "Hsg2CAAgFk1Vd6W6cseJD0UtB0g0pB8N", "UbckorOyb4FxR7xZ8GphAvSWlQBuZ4z3", "t3UgO82iTBj4Je3asj0XN1i1cbfA", "fleIFkN77EtPYIR4IZjCzdODP1NyIKiN", "OPDxW3mvsrdjNTdOIjiPk89aFloqol7I"};
    }
    ...
    public AnonymousClass1U(String str, String str2, int i, String str3, String str4, EnumC0679Nd nd, int i2, boolean z, boolean z2, AnonymousClass1V r16, boolean z3, String str5) {
        if (z3) {
            this.A08 = UUID.randomUUID().toString();
            this.A07 = Uri.parse(str).buildUpon().appendQueryParameter(A03(132, 11, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), this.A08).appendQueryParameter(A03(58, 12, 69), str5).build().toString();
        } else {
            this.A07 = str;
            this.A08 = null;
        }
    ...
    @Nullable
    public static AnonymousClass1U A01(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A03(198, 13, 62));
        if (optJSONObject == null) {
            return null;
        }
        return new AnonymousClass1U(optJSONObject.optString(A03(282, 3, 72)), optJSONObject.optString(A03(143, 19, 61)), A00(jSONObject), A05(optJSONObject), A04(optJSONObject), A02(optJSONObject), optJSONObject.optInt(A03(285, 32, 0), 5000), optJSONObject.optBoolean(A03(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 17, 87), true), optJSONObject.optBoolean(A03(88, 15, 37)), AnonymousClass1V.A00(optJSONObject.optString(A03(211, 17, 50), A0F.name())), optJSONObject.optBoolean(A03(162, 25, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION)), jSONObject.optString(A03(70, 2, 71)));
    }

    public static EnumC0679Nd A02(JSONObject jSONObject) {
        return EnumC0679Nd.A00(jSONObject.optInt(A03(187, 11, 74), A0G.A04()));
    }
    ...
    public static String A04(JSONObject jSONObject) {
        ...
        return genericTextObject.optString(A03(72, 16, 125), A032);
    }
    ...
    public static String A05(JSONObject jSONObject) {
        ...
        return genericTextObject.optString(A03(228, 18, 6), A032);
    }
    ...
    public final AnonymousClass1V A0A() {
        return this.A03;
    }

    public final EnumC0679Nd A0B() {
        return this.A04;
    }
