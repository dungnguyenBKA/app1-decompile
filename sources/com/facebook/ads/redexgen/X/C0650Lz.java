...
public final class C0650Lz {
    public static byte[] A00;
    public static String[] A01;
    public static final String A02 = C0650Lz.class.getSimpleName();
    ...
    public static Map<String, String> A01(XJ xj) {
        Window window;
        ...
        try {
            hashMap.put(A00(40, 3, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), String.valueOf(A05(xj)));
            Activity A09 = xj.A09();
            ...
            xj.A04().A8V(A00(43, 5, 114), C03228e.A29, new C03238f(e));
        }
        return hashMap;
    }

    public static boolean A04(XJ xj) {
        return !C0633Li.A05(A01(xj));
    }

    public static boolean A05(XJ xj) {
        KeyguardManager keyguardManager = (KeyguardManager) xj.getSystemService(A00(32, 8, 4));
