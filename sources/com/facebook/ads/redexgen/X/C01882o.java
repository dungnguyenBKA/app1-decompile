...
public final class C01882o extends C3 {
    public static byte[] A05;
    public static String[] A06;
    public final C0509Gg A00 = new C0509Gg();
    public final C0515Gm A01 = new C0515Gm();
    public final C0518Gp A02 = new C0518Gp();
    public final IM A03 = new IM();
    public final List<C0513Gk> A04 = new ArrayList();
    ...
    /* renamed from: A01 */
    public final C1068az A0d(byte[] bArr, int i, boolean z) throws GD {
        boolean isEmpty;
        this.A03.A0c(bArr, i);
        this.A01.A0F();
        this.A04.clear();
        C0519Gq.A05(this.A03);
        do {
        ...
        while (true) {
            ...
            if (A002 == 1) {
                ...
                if (A002 == 2) {
                    ...
                    if (A06[0].length() == 13) {
                        String[] strArr = A06;
                        strArr[1] = "RankGpg1WKksvMbJf2r1Mj9i4dXCVfm7";
                        strArr[2] = "PTwUfk4233EGPZYG7vYxG5zvlLDyWplM";
                        if (!isEmpty2) {
                            break;
                        }
                    } else {
                        String[] strArr2 = A06;
                        strArr2[1] = "YowA8l8uvxZXaVypumJ5yBUyc4sOcAQV";
                        strArr2[2] = "HKbmxYlwqclncAnOAoFTo7zzjR7PE75y";
                        if (!isEmpty2) {
                            break;
                        }
                    }
                    this.A03.A0Q();
                    C0513Gk A0F = this.A00.A0F(this.A03);
                    if (A0F != null) {
                        this.A04.add(A0F);
                    }
        ...
        throw new GD(A02(0, 44, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS));
    }

    public static void A05(IM im) {
        do {
