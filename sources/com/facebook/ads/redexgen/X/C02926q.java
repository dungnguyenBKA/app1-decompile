...
public final class C02926q {
    public static byte[] A05;
    public static String[] A06;
    public static final String A07 = C02926q.class.getSimpleName();
    public final int A00;
    public final EnumC02916p A01;
    @Nullable
    ...
    public C02926q(Throwable th) {
        String stackTraceElement;
        this.A01 = EnumC02916p.A08;
        ...
        if (th.getStackTrace() == null || th.getStackTrace().length <= 1 || th.getStackTrace().toString().length() <= 500) {
            ...
            stackTraceElement = th.getStackTrace()[0].toString().substring(0, HttpStatus.SC_INTERNAL_SERVER_ERROR);
        }
    ...
    public final JSONObject A09() {
        ...
        try {
            int i = C02906o.A00[this.A01.ordinal()];
