...
public class C1172ch implements AbstractC0647Lw {
    ...
    public C1172ch(Executor executor, C03408w r3, XJ xj) {
        this.A01 = C0755Qc.A01(xj.A00());
        this.A02 = executor;
        this.A00 = r3;
    }
    ...
    private Map<String, String> A03(String str) {
        ...
        QY qy = new QY();
        QY qy2 = new QY();
        miscInfo.put(A01(257, 15, 96), C02525b.A00().A03());
        ...
        if (A07 != null) {
            qy2.put(A01(208, 12, 70), A07);
        }
        if (A04[2].charAt(28) != 'S') {
            throw new RuntimeException();
        }
        A04[1] = "6c1y5rO2F72616lTK87Vm3xCzjJjlGKf";
        qy.put(A01(229, 11, 59), str);
        qy.put(A01(248, 9, 102), LG.A01(qy2));
        miscInfo.A05(A01(240, 8, 47), LG.A01(qy));
        return miscInfo;
    }

    /* access modifiers changed from: public */
    private void A07(C03408w r1) {
        this.A00 = r1;
    }

    @Override // com.facebook.ads.redexgen.X.AbstractC0647Lw
    public final void ABb() {
        Activity A002 = C0619Ks.A00();
        if (A002 != null) {
            ...
            builder.setNegativeButton(A01(78, 6, 72), new DialogInterface$OnClickListenerC0644Lt(this));
            builder.setPositiveButton(A01(149, 11, 127), new DialogInterface$OnClickListenerC0645Lu(this, editText));
            builder.create().show();
        }
    }
}
