...
public final class NE extends LinearLayout {
    public static byte[] A0A;
    public static String[] A0B;
    public static final int A0C = Color.rgb(224, 224, 224);
    public static final int A0D = Color.argb(34, 0, 0, 0);
    public static final Uri A0E = Uri.parse(A05(90, 23, 31));
    public static final View.OnTouchListener A0F = new N8();
    @Nullable
    ...
    public final NN A09 = new C1032aP(this);
    ...
    public static void A08() {
        A0B = new String[]{"knq4crm7fvqQP", "POuWJNR6FFtqsTvB6KeDXgsqVDDrfXB5", "10LYd3PkBnL3JTlwXO74lkb8laVhyfxM", "yGvyB2PsIdOlgSHN7xWAdIyeKrkcUuSJ", "30OsfDGqNeLBXhmKwxFpv8WuoKRgKdOB", "v4mwmIuaROl", "LuFvPWZsJ2RrZ", "py7QobRXpH9AZVstdVJJOkEIejHuBaN9"};
    }
    ...
    public NE(XJ xj, WebView webView) {
        super(xj);
        this.A08 = webView;
        this.A07 = J5.A06(xj);
        A09(xj);
    ...
    private void A09(XJ xj) {
        ...
        this.A01.setImageBitmap(C0641Lq.A01(EnumC0640Lp.BROWSER_CLOSE));
        this.A01.setOnTouchListener(A0F);
        this.A01.setOnClickListener(new N9(this));
        ...
        if (this.A07) {
            ...
            this.A00.setOnClickListener(new NA(this));
        ...
        if (this.A07) {
            ...
            this.A02.setImageBitmap(C0641Lq.A02(EnumC0640Lp.BACK_ARROW));
            this.A02.setOnTouchListener(A0F);
            this.A02.setOnClickListener(new NB(this));
        ...
        this.A03.setOnClickListener(new NC(this, xj));
        addView(this.A03, layoutParams5);
        setupDefaultNativeBrowser(xj);
    }

    public NN getBrowserNavigationListener() {
        return this.A09;
    }

    public void setListener(ND nd) {
        this.A04 = nd;
    }
    ...
    private void setupDefaultNativeBrowser(XJ xj) {
        Bitmap A012;
        List<ResolveInfo> queryIntentActivities = xj.getPackageManager().queryIntentActivities(new Intent(A05(46, 26, 84), A0E), 65536);
        if (queryIntentActivities.size() == 0) {
            ...
            if (queryIntentActivities.size() == 1) {
                if (A05(72, 18, 95).equals(queryIntentActivities.get(0).activityInfo.packageName)) {
                    EnumC0640Lp lp = EnumC0640Lp.BROWSER_LAUNCH_CHROME;
                    if (A0B[5].length() != 31) {
                        String[] strArr = A0B;
            ...
            A012 = C0641Lq.A01(EnumC0640Lp.BROWSER_LAUNCH_NATIVE);
        }
        this.A03.setImageBitmap(A012);
    }
}
