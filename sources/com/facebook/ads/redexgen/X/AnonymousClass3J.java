...
public final class AnonymousClass3J extends AbstractC0398Be {
    ...
    private void A04() {
        int backgroundColor = GJ.A01(this.A06.A05(2), this.A06.A05(2), this.A06.A05(2), this.A06.A05(2));
        int edgeG = GJ.A01(this.A06.A05(2), this.A06.A05(2), this.A06.A05(2), this.A06.A05(2));
        this.A06.A09(2);
        this.A01.A0C(backgroundColor, edgeG, GJ.A00(this.A06.A05(2), this.A06.A05(2), this.A06.A05(2)));
    }
    ...
    private void A06() {
        int fillG = GJ.A01(this.A06.A05(2), this.A06.A05(2), this.A06.A05(2), this.A06.A05(2));
        int borderG = this.A06.A05(2);
        int scrollDirection = GJ.A00(this.A06.A05(2), this.A06.A05(2), this.A06.A05(2));
        if (this.A06.A0G()) {
            borderG |= 4;
        }
    ...
    private void A07() {
        ...
        if (i != i2) {
            ...
            sb.append(A00(0, 18, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS));
        ...
        if (A053 == 0) {
            if (A052 != 0) {
                Log.w(A002, A00(HttpStatus.SC_NOT_ACCEPTABLE, 27, 121) + A052 + A00(18, 21, 53));
            }
    ...
    private void A0B(int r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass3J.A0B(int):void");
    }

    /* JADX INFO: Multiple debug info for r7v0 'this'  com.facebook.ads.redexgen.X.3J: [D('window' int), D('i' int)] */
    ...
    private void A0F(int i) {
        ...
        this.A06.A09(2);
        gj.A0G(A0G, A0G2, A0G3, A052, columnLock, verticalAnchor, rowCount, A053, A054, penStyle, this.A06.A05(3), this.A06.A05(3));
    }
        ...
        if (i == 32) {
            ...
            if (strArr[2].charAt(6) == strArr[1].charAt(6)) {
                ...
                if (i == 57) {
                    ...
                    if (A0A[0].length() != 12) {
                        String[] strArr2 = A0A;
                        strArr2[2] = "Hn1frjObrkKWee9bQkUvSoGsCyNbx6K5";
                        strArr2[1] = "5jLxiAOonCPZsccE4Rlf5xBOSnJI2Mxj";
                        gj.A0A(353);
                        return;
                    }
                } else if (i == 60) {
                    ...
                    switch (i) {
                        ...
                        case 52:
                            ...
                            if (A0A[0].length() != 12) {
                                String[] strArr4 = A0A;
                                strArr4[4] = "pjkXXm09rSmpulg3ZnQvc2tVnRpvsPhy";
                                strArr4[7] = "1ZIH3c3lD2nrVh46isF21y1NEU8S3DGz";
                                gj3.A0A(8221);
                                return;
                            }
                            throw new RuntimeException();
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0398Be
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void A0R(com.facebook.ads.redexgen.X.C0416By r11) {
        /*
        // Method dump skipped, instructions count: 259
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass3J.A0R(com.facebook.ads.redexgen.X.By):void");
    }
