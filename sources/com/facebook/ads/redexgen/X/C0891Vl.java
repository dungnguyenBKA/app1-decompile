...
public class C0891Vl implements AbstractC02876l<String> {
    ...
    public C0891Vl(@Nullable File file) {
        long j;
        this.A03 = file;
        long j2 = 0;
        if (file != null) {
    ...
    public final boolean A80(Object obj) {
        C0891Vl vl = (C0891Vl) obj;
        File file = this.A03;
        if (file == null || vl.A03 == null) {
            return false;
        }
        String absolutePath = file.getAbsolutePath();
        String absolutePath2 = vl.A03.getAbsolutePath();
        String[] strArr = A05;
        ...
        if (!absolutePath.equals(absolutePath2) || this.A00 != vl.A00) {
            return false;
        }
        long j = this.A02;
        long j2 = vl.A02;
