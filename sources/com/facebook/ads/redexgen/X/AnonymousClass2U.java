...
public abstract class AnonymousClass2U<K, V> {
    public static String[] A03;
    public AnonymousClass2U<K, V>.EntrySet A00;
    public AnonymousClass2U<K, V>.KeySet A01;
    public AnonymousClass2U<K, V>.ValuesCollection A02;
    ...
    public final Collection<V> A0A() {
        if (this.A02 == null) {
            this.A02 = new AnonymousClass2T(this);
        }
        return this.A02;
    }
    ...
    public final Set<Map.Entry<K, V>> A0C() {
        if (this.A00 == null) {
            this.A00 = new AnonymousClass2Q(this);
        }
        AnonymousClass2U<K, V>.EntrySet entrySet = this.A00;
    ...
    public final Set<K> A0D() {
        if (this.A01 == null) {
            this.A01 = new AnonymousClass2R(this);
        }
        return this.A01;
    }
