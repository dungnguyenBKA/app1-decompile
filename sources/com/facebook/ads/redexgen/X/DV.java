...
public final class DV {
    ...
    public DV(List<Format> list) {
        this.A00 = list;
        this.A01 = new CS[list.size()];
    }

    public final void A02(long j, IM im) {
        GM.A04(j, im, this.A01);
    }

    public final void A03(CI ci, C0433Da da) {
        boolean z;
        String A05;
        for (int i = 0; i < this.A01.length; i++) {
            ...
            C0551Hx.A05(z, A00(0, 43, 85) + str);
            if (format.A0M != null) {
                A05 = format.A0M;
            } else {
                A05 = da.A05();
            }
            AEM.A5P(Format.A08(A05, str, null, -1, format.A0D, format.A0N, format.A03, null));
            this.A01[i] = AEM;
        }
    }
}
