...
public enum AnonymousClass5X {
    ...
    /* access modifiers changed from: public */
    AnonymousClass5X(String str) {
        this.A00 = str;
    }

    @Nullable
    public static AnonymousClass5X A00(@Nullable String str) {
        AnonymousClass5X[] values = values();
        for (AnonymousClass5X r1 : values) {
