...
public class C0439Dg extends Exception {
    ...
    public C0439Dg(Format format, Throwable th, boolean z, int i) {
    ...
    public C0439Dg(Format format, Throwable th, boolean z, String str) {
    ...
    public static String A00(int i) {
        ...
        if (i < 0) {
            ...
            A012 = A01(0, 0, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS);
        }
