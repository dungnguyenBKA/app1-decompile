...
public final class AnonymousClass9N {
    ...
    public AnonymousClass9N() {
        this(-1, -1);
    }

    public AnonymousClass9N(int i, int i2) {
        if (i < -1) {
    ...
    public final int A05(AnonymousClass9N r3) {
        int i = this.A00;
        int i2 = r3.A00;
        if (i != i2) {
            return i - i2;
    ...
    public final AnonymousClass9N A06(int i) {
        int i2 = this.A01;
        if (i + i2 >= 0) {
            return new AnonymousClass9N(this.A00, i2 + i);
        }
        throw new IllegalArgumentException(String.format(Locale.US, A00(0, 35, 63), Integer.valueOf(i), Integer.valueOf(this.A01)));
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof AnonymousClass9N)) {
            return false;
        }
        AnonymousClass9N r7 = (AnonymousClass9N) obj;
        int i = r7.A00;
        int i2 = this.A00;
        if (A03[4].charAt(2) != 'U') {
