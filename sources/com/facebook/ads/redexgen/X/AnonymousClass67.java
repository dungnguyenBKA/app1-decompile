...
public final class AnonymousClass67 {
    public static AnonymousClass66 A00;
    public static byte[] A01;
    public static String[] A02;
    public static final String A03 = AnonymousClass67.class.getSimpleName();
    ...
    public static void A03(AnonymousClass66 r0) {
        A00 = r0;
    }

    @SuppressLint({"BadMethodUse-android.util.Log.e"})
    public static void A04(Throwable th) {
        AnonymousClass66 r0 = A00;
        if (r0 != null) {
            r0.ADG(th);
        } else {
