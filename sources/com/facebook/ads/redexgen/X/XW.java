...
public final class XW implements AnonymousClass8Q {
    public static byte[] A03;
    public static String[] A04;
    public Context A00;
    @Nullable
    public AnonymousClass8P A01;
    ...
    @Nullable
    private AnonymousClass8P A00() {
        return AnonymousClass8P.A00(AdSharedPreferences.getSharedPreferences(this.A00).getString(A01(95, 16, 52), null));
    }
    ...
    public final void A05(@Nullable String[] strArr, @Nullable Integer num, @Nullable Integer num2) {
        AnonymousClass8P r1 = new AnonymousClass8P(strArr, num, num2);
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass8Q
    @Nullable
    public final AnonymousClass8P A6C() {
        A02();
        return this.A01;
    }
    ...
    public final boolean A8A() {
        ...
        Set<String> A0W = J4.A0W(this.A00);
