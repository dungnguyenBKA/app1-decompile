...
public final class C0433Da {
    ...
    public C0433Da(int i, int i2) {
        this(RecyclerView.UNDEFINED_DURATION, i, i2);
    }

    public C0433Da(int i, int i2, int i3) {
        String A002;
        if (i != Integer.MIN_VALUE) {
            A002 = i + A00(0, 1, 53);
        } else {
            A002 = A00(0, 0, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD);
        }
        this.A04 = A002;
        this.A02 = i2;
        this.A03 = i3;
