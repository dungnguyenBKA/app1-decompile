...
public enum LF {
    ...
    /* access modifiers changed from: public */
    LF(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static LF A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        LF[] values = values();
        for (LF lf : values) {
            if (lf.A01 == nativeComponentTag) {
                return lf;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        LF A002 = A00(nativeComponentTag);
        if (view != null && A002 != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, LF lf) {
        if (view != null && lf != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, lf);
        }
    }
