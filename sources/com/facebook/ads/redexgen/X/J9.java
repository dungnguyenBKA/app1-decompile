...
public final class J9 {
    ...
    public J9(AnonymousClass8D r6, String str, double d, String str2, Map<String, String> map, JD jd, JE je, boolean z) {
        this.A05 = str;
        this.A00 = d;
        this.A04 = str2;
        this.A02 = jd;
        ...
        String A012 = JL.A01(str);
        if (!TextUtils.isEmpty(A012) && (z || je == JE.A0C)) {
            hashMap.put(A00(6, 21, 61), A012);
        }
        if (A0C()) {
            hashMap.put(A00(0, 6, 63), LG.A01(r6.A02().A5b()));
        }
