...
public final class C03459c implements Closeable {
    public static byte[] A03;
    public static String[] A04;
    public boolean A00 = false;
    public final AnonymousClass9S A01;
    public final Deque<C03449b> A02 = new LinkedList();
    ...
    public C03459c(AnonymousClass9S r2, AbstractC03439a r3) throws IOException {
        this.A01 = r2;
        A06(r2, r3);
        if (this.A02.isEmpty()) {
            A00();
    ...
    private C03449b A00() throws IOException {
        int i = -1;
        if (!this.A02.isEmpty()) {
            i = this.A02.getLast().A00();
        }
        int i2 = i + 1;
        this.A02.add(new C03449b(i2, new AnonymousClass9Y(new File(this.A01.A05(), A01(i2)))));
    ...
    private void A05(int i, File file) throws IOException {
        AnonymousClass9Y r2 = new AnonymousClass9Y(file);
        r2.A05();
        this.A02.addFirst(new C03449b(i, r2));
    }

    /* JADX INFO: Multiple debug info for r7v0 java.util.HashSet: [D('file' java.io.File), D('fileToLoad' java.io.File), D('fileNumber' int)] */
    private void A06(AnonymousClass9S r14, AbstractC03439a r15) throws IOException {
        ...
        if (listFiles != null) {
            ...
            for (File file : listFiles) {
                try {
                    ...
                    hashSet.add(file);
                    r15.ADH(String.format(Locale.US, A02(260, 39, 79), file.getCanonicalPath()));
                }
            }
            if (!hashMap.isEmpty()) {
                int i2 = i;
                ...
                while (it.hasNext()) {
                    ...
                    if (intValue < i2) {
                        r15.ADH(String.format(Locale.US, A02(166, 61, 2), Integer.valueOf(intValue), Integer.valueOf(i2)));
                ...
                while (i >= i2) {
                    ...
                    if (A04[7].length() != 23) {
                        ...
                        try {
                            ...
                            r15.ADI(String.format(Locale.US, A02(FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION, 62, 43), file2.getCanonicalPath(), Integer.valueOf(i)), e);
            ...
            for (File file3 : hashSet) {
                if (!file3.delete()) {
                    r15.ADH(String.format(Locale.US, A02(40, 26, 29), file3.getCanonicalPath()));
                }
            }
            return;
        }
    ...
    public final synchronized AnonymousClass9Q A0B(int i, int i2, byte[] bArr, int i3, int[] iArr, int i4) throws IOException {
        if (!this.A00) {
            for (C03449b r2 : this.A02) {
                if (r2.A00() == i) {
                    return new AnonymousClass9Q(i, r2.A02(i2, bArr, i3, iArr, i4));
                }
            }
            return new AnonymousClass9Q(-1, new AnonymousClass9P(AnonymousClass9O.A04, -1, -1, 0));
        }
        throw new IOException(A02(227, 33, 62));
    }
