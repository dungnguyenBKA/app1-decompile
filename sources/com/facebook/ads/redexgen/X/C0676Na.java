...
public final class C0676Na extends Drawable {
    ...
    public final Runnable A0F = new C1019aC(this);
    ...
    public static void A04() {
        A0G = new byte[]{65, 73, 21, 42, 38, 52, 121, 99, 24, 87, 94, 24, 81, 93, 49, 18, 28, 25, 24, 25, 93, 117, 109, 113, 109, 114, 55, 21, 6, 16, 84, 86, 113, 118, 107, 118, 126, 115, 118, 101, 118, 113, 120, 49, 49, 49, 60, 11, 4, 79, 68, Byte.MAX_VALUE, 122, Byte.MAX_VALUE, 126, 102, Byte.MAX_VALUE, 108, 83, 95, 77, 91, 88, 83, 86, 83, 78, 67, 26, 121, 82, 95, 89, 81, 95, 72, 26, 84, 85, 78, 26, 73, 95, 78, 32, 104, 48, 125, 51, 96, 33, 39, 47};
    }
    ...
    /* JADX INFO: Multiple debug info for r4v0 java.lang.StringBuilder: [D('hours' int), D('vc' com.facebook.ads.redexgen.X.QE)] */
    ...
    public void A03() {
        ...
        WeakReference<QE> weakReference = this.A07;
        if (weakReference == null || weakReference.get() == null) {
            sb.append(A02(57, 27, 4));
        } else {
            sb.append(this.A07.get().A0S());
        }
    ...
    public final void A0B(QE qe) {
        this.A07 = new WeakReference<>(qe);
        A03();
    }
