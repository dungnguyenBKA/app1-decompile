...
public final class RV implements AnonymousClass0G {
    public static byte[] A03;
    public static String[] A04;
    public File A00;
    public RandomAccessFile A01;
    public final AnonymousClass0B A02;
    ...
    public RV(File file, AnonymousClass0B r8) throws RX {
        File file2;
        if (r8 != null) {
            try {
                this.A02 = r8;
                AnonymousClass0E.A06(file.getParentFile());
                ...
                throw new RX(A00(186, 17, 126) + file + A00(0, 14, 84), e);
            }
        } else {
    ...
    public final synchronized int A04() throws RX {
        try {
        } catch (IOException e) {
            throw new RX(A00(137, 29, 81) + this.A00, e);
        }
    ...
    public final synchronized void A06() throws RX {
        try {
            this.A01.setLength(0);
        } catch (IOException e) {
            throw new RX(A00(57, 16, 6), e);
        }
        String[] strArr = A04;
    ...
    public final synchronized void A07() throws RX {
        try {
            this.A01.close();
            this.A02.AEL(this.A00);
        } catch (IOException e) {
            throw new RX(A00(FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION, 19, 99) + this.A00, e);
        }
    }

    /* JADX INFO: Multiple debug info for r0v11 boolean: [D('completedFile' java.io.File), D('renamed' boolean)] */
    public final synchronized void A08() throws RX {
        if (!A0A()) {
            A07();
            ...
            if (this.A00.renameTo(file)) {
                ...
                try {
                    ...
                    throw new RX(A00(123, 14, 124) + this.A00 + A00(0, 14, 84), e);
                }
            } else {
                throw new RX(A00(166, 20, 40) + this.A00 + A00(44, 4, 124) + file + A00(14, 16, 28));
            }
        }
    }

    public final synchronized void A09(byte[] bArr, int i) throws RX {
        try {
            if (!A0A()) {
                this.A01.seek((long) A04());
                this.A01.write(bArr, 0, i);
            } else {
                throw new RX(A00(73, 31, 52) + this.A00 + A00(30, 14, 118));
            }
        } catch (IOException e) {
            String A002 = A00(HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION, 53, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS);
            throw new RX(String.format(Locale.US, A002, Integer.valueOf(i), this.A01, Integer.valueOf(bArr.length)), e);
        }
    }
