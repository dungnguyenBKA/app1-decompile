...
public final class C0519Gq {
    ...
    public static long A01(String str) throws NumberFormatException {
        long j = 0;
        String[] A0n = C0556Ic.A0n(str, A02(50, 2, 102));
        for (String subpart : C0556Ic.A0m(A0n[0], A02(1, 1, 3))) {
        ...
        if (A0n.length == 2) {
            String str2 = A0n[1];
            if (A01[5].charAt(7) != 'A') {
                A01[5] = "EtjYanqu7taAJaVCJ4eq2Fekx5qw52Sf";
    ...
    public static void A05(IM im) throws GD {
        String line = im.A0Q();
        if (line == null || !A03.matcher(line).matches()) {
            throw new GD(A02(2, 21, 44) + line);
        }
    }
}
