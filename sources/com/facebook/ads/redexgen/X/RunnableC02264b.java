...
public class RunnableC02264b implements Runnable {
    public static byte[] A07;
    public static String[] A08;
    public Interpolator A00 = C0469Eq.A1A;
    public OverScroller A01;
    public int A02;
    public int A03;
    public boolean A04 = false;
    public boolean A05 = false;
    public final /* synthetic */ C0469Eq A06;
    ...
    public RunnableC02264b(C0469Eq eq) {
        this.A06 = eq;
        this.A01 = new OverScroller(eq.getContext(), C0469Eq.A1A);
    }
    ...
    public final void A08() {
        ...
        if (A08[4].charAt(10) != 'o') {
            ...
            AnonymousClass2z.A0C(this.A06, this);
            return;
        }
    ...
    public final void A0A(int i, int i2) {
        ...
        this.A03 = 0;
        this.A02 = 0;
        this.A01.fling(0, 0, i, i2, RecyclerView.UNDEFINED_DURATION, Integer.MAX_VALUE, RecyclerView.UNDEFINED_DURATION, Integer.MAX_VALUE);
        A08();
    }
    ...
    public final void A0E(int i, int i2, Interpolator interpolator) {
        ...
        if (interpolator == null) {
            interpolator = C0469Eq.A1A;
        }
        A0D(i, i2, A012, interpolator);
    }

    /* JADX INFO: Multiple debug info for r1v5 'x'  int: [D('overscrollY' int), D('velY' int)] */
    /* JADX INFO: Multiple debug info for r0v20 'vresult'  int: [D('overscrollX' int), D('velY' int), D('scrollConsumed' int[])] */
    /* JADX WARNING: Code restructure failed: missing block: B:116:0x028d, code lost:
        if (r15 != 2) goto L_0x017e;
     */
    ...
    public final void run() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.RunnableC02264b.run():void");
    }
}
