...
public final class AnonymousClass1I implements Serializable {
    ...
    public AnonymousClass1I(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        this.A00 = i;
        this.A01 = i2;
        this.A02 = i3;
        this.A03 = i4;
    ...
    public static AnonymousClass1I A01(@Nullable JSONObject jSONObject) {
        return new AnonymousClass1I(A00(jSONObject, A02(37, 12, 6), A0A), A00(jSONObject, A02(57, 10, 7), A0B), A00(jSONObject, A02(135, 14, 4), -16777216), A00(jSONObject, A02(49, 8, 80), A0C), A00(jSONObject, A02(67, 9, 50), A0D), A00(jSONObject, A02(76, 20, 86), -1), A00(jSONObject, A02(96, 14, 62), -1), A00(jSONObject, A02(FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD, 25, 32), A0F), A00(jSONObject, A02(149, 11, 123), -16777216));
    }
