...
public final class Y8<T> implements AnonymousClass9V<T> {
    public static byte[] A06;
    public static String[] A07;
    public AnonymousClass9N A00 = this.A04.A04();
    public AnonymousClass9N A01;
    public List<Y8<T>.RecordFileBasedFetch> A02 = new ArrayList();
    public boolean A03;
    public final AnonymousClass9M A04;
    public final C03459c A05;
    ...
    public Y8(AnonymousClass9S r5, AbstractC03439a r6) throws IOException {
        this.A05 = new C03459c(r5.A04(A00(515, 4, 63)), r6);
        this.A04 = new AnonymousClass9M(new File<>(r5.A05(), A00(509, 6, 70)));
        A06(r6);
        this.A01 = this.A00;
    }

    private void A03(int i, int i2) throws IOException {
        this.A00 = new AnonymousClass9N(i, i2);
        this.A04.A05(this.A00);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private synchronized void A04(Y8<T>.RecordFileBasedFetch recordFileBasedFetch) throws C03479e {
        if (this.A03) {
            throw new C03479e(A00(427, 39, 68));
        } else if (!A07(recordFileBasedFetch)) {
            throw new C03479e(A00(466, 43, 49));
        } else if (recordFileBasedFetch.A5J() != 0) {
            if (this.A00.A05(recordFileBasedFetch.A00().A02) == 0) {
                try {
                    Iterator<AnonymousClass9Z> it = recordFileBasedFetch.A00.iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            break;
                        } else if (((AnonymousClass9Z) it.next()).A00 != this.A05.A08() || !this.A05.A0E()) {
                    ...
                    throw new C03479e(A00(361, 30, 93), e);
                }
            } else {
                throw new C03479e(A00(0, 54, 63));
            }
        }
    }

    private void A06(AbstractC03439a r11) throws IOException {
        AnonymousClass9N r3 = new AnonymousClass9N(this.A05.A07(), 0);
        if (r3.A05(this.A00) > 0) {
            r11.ADH(String.format(Locale.US, A00(54, 102, 53), Integer.valueOf(this.A00.A03()), Integer.valueOf(this.A00.A04()), Integer.valueOf(r3.A03()), Integer.valueOf(r3.A04())));
            this.A00 = r3;
            return;
        }
        while (r3.A03() < this.A00.A03()) {
            if (this.A05.A0E()) {
                r3 = new AnonymousClass9N(this.A05.A07(), 0);
            } else {
                r11.ADH(String.format(Locale.US, A00(156, 101, 13), Integer.valueOf(this.A00.A03()), Integer.valueOf(this.A00.A04()), Integer.valueOf(r3.A03())));
                this.A00 = new AnonymousClass9N(this.A05.A07(), this.A05.A08());
                this.A04.A05(this.A00);
            }
        }
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private synchronized boolean A07(Y8<T>.RecordFileBasedFetch recordFileBasedFetch) {
        if (!this.A02.remove(recordFileBasedFetch)) {
            return false;
        }
        if (recordFileBasedFetch.A5J() > 0 && recordFileBasedFetch.A01().A02.A06(recordFileBasedFetch.A01().A01).equals(this.A01)) {
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass9V
    public final synchronized AnonymousClass9U A5I(byte[] bArr, int[] iArr) throws C03479e {
        Y8<T>.RecordFileBasedFetch y7;
        if (!this.A03) {
            int i = 0;
            int i2 = 0;
            try {
                ...
                boolean z = true;
                while (true) {
                    AnonymousClass9Q A0B = this.A05.A0B(this.A01.A03(), this.A01.A04(), bArr, i, iArr, i2);
                    int A002 = A0B.A01().A00() - A0B.A01().A01();
                    i += A0B.A01().A02();
                    i2 += A002;
                    if (A0B.A01().A03() == AnonymousClass9O.A02) {
                        arrayList.add(A0B);
                    }
                    if (A0B.A01().A03() == AnonymousClass9O.A03) {
                        break;
                    } else if (A0B.A01().A03() != AnonymousClass9O.A04) {
                        this.A01 = this.A01.A06(A002);
                    } else if (this.A05.A07() + this.A05.A09() == this.A01.A03() + 1) {
                        z = false;
                        break;
                    } else {
                        this.A01 = new AnonymousClass9N(this.A01.A03() + 1, 0);
                    }
                }
                y7 = new Y7(this, arrayList, z);
                this.A02.add(y7);
                if (!arrayList.isEmpty()) {
                    this.A01 = y7.A01().A02.A06(y7.A01().A01);
                }
            } catch (IOException e) {
                throw new C03479e(A00(306, 29, 79), e);
            }
        } else {
            throw new C03479e(A00(391, 36, 119));
        }
        return y7;
    }

    @Override // com.facebook.ads.redexgen.X.AnonymousClass9V
    public final synchronized int A74() throws C03479e {
        int A0A;
        if (!this.A03) {
            try {
                A0A = this.A05.A0A();
                ...
                throw new C03479e(A00(335, 26, 122), e);
            }
        } else {
            throw new C03479e(A00(427, 39, 68));
        }
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass9V
    public final synchronized void AEE(byte[] bArr) throws C03479e {
        if (!this.A03) {
            try {
                this.A05.A0D(bArr);
            } catch (IOException e) {
                throw new C03479e(A00(257, 25, 61), e);
            }
        } else {
            throw new C03479e(A00(427, 39, 68));
        }
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass9V
    public final synchronized void clear() throws C03479e {
        try {
            this.A05.A0C();
            A03(this.A05.A07(), 0);
            this.A02.clear();
