...
public final class AnonymousClass7H {
    ...
    public static Bitmap A01(InputStream inputStream, int i, int i2) throws IOException {
        ...
        AnonymousClass0N r3 = new AnonymousClass0N(inputStream);
        r3.mark(8192);
    ...
    public static Bitmap A02(String str, int i, int i2, AnonymousClass8D r5) {
        try {
            BitmapFactory.Options options = new BitmapFactory.Options();
            options.inJustDecodeBounds = true;
            ...
            r5.A04().A8V(A03(0, 5, 99), C03228e.A1P, new C03238f(th));
            return null;
        }
    }
}
