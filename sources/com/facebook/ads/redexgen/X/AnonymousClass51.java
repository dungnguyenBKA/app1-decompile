...
public final class AnonymousClass51 implements AudienceNetworkActivityApi {
    ...
    public AnonymousClass51(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi, AnonymousClass50 r3) {
    ...
    private void A03(Throwable th) {
        ...
        XJ A0J = this.A03.A0J();
        if (A0J != null) {
            A0J.A04().A8V(A00(38, 11, 18), C03228e.A04, new C03238f(th));
            return;
        }
        ...
        A05[6] = "roakWe6n8CepWvGQKms2st32sM0MtJhe";
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        ...
        try {
            ...
            String[] strArr = A05;
            if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
                A05[6] = "46sQaeWUXFUhhsRkoBzMlxezgaVtku4l";
                A03(th);
                return;
            }
            throw new RuntimeException();
