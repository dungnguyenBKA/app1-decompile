...
public final class AnonymousClass8P {
    ...
    public AnonymousClass8P(Set<String> options, @Nullable Integer num, @Nullable Integer num2, String str) {
        this.A03 = options;
        this.A00 = num;
        this.A01 = num2;
        this.A02 = str;
    ...
    public AnonymousClass8P(@Nullable String[] strArr, @Nullable Integer num, @Nullable Integer num2) {
    ...
    @Nullable
    public static AnonymousClass8P A00(@Nullable String str) {
        if (str == null) {
            return null;
        }
        ...
        return new AnonymousClass8P(linkedHashSet, num, num2, str);
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        if (!(obj instanceof AnonymousClass8P)) {
            return false;
        }
        AnonymousClass8P r6 = (AnonymousClass8P) obj;
