...
public final class C0508Gf {
    ...
    private C0508Gf A00(C0508Gf gf, boolean z) {
        if (gf != null) {
            if (!this.A0C && gf.A0C) {
                A0C(gf.A03);
            }
    ...
    public final C0508Gf A0A(float f) {
        this.A00 = f;
        return this;
    }

    public final C0508Gf A0B(int i) {
        this.A01 = i;
        this.A0B = true;
        return this;
    }

    public final C0508Gf A0C(int i) {
        boolean z;
        if (this.A0D == null) {
            z = true;
        } else {
    ...
    public final C0508Gf A0D(int i) {
        this.A04 = i;
        return this;
    }

    public final C0508Gf A0E(Layout.Alignment alignment) {
        this.A08 = alignment;
        return this;
    }

    public final C0508Gf A0F(C0508Gf gf) {
        return A00(gf, true);
    }

    public final C0508Gf A0G(String str) {
        boolean z;
        if (this.A0D == null) {
            z = true;
        } else {
    ...
    public final C0508Gf A0H(String str) {
        this.A0A = str;
        return this;
    }

    public final C0508Gf A0I(boolean z) {
        boolean z2;
        if (this.A0D == null) {
            z2 = true;
        } else {
    ...
    public final C0508Gf A0J(boolean z) {
        boolean z2;
        if (this.A0D == null) {
            z2 = true;
        } else {
    ...
    public final C0508Gf A0K(boolean z) {
        boolean z2;
        if (this.A0D == null) {
            z2 = true;
        } else {
    ...
    public final C0508Gf A0L(boolean z) {
        boolean z2;
        if (this.A0D == null) {
            z2 = true;
        } else {
