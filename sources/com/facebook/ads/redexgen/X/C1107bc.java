...
public final class C1107bc implements AbstractC0545Hr {
    public static byte[] A02;
    public static String[] A03;
    public static final C1107bc A04 = new C1107bc(Collections.emptyMap());
    public int A00;
    ...
    public C1107bc(Map<String, byte[]> map) {
        this.A01 = Collections.unmodifiableMap(map);
    }

    public static C1107bc A00(DataInputStream dataInputStream) throws IOException {
        ...
        return new C1107bc(hashMap);
    }

    public static Map<String, byte[]> A02(Map<String, byte[]> map, C0547Ht ht) {
    ...
    /* JADX INFO: Multiple debug info for r0v10 byte[]: [D('otherMetadata' java.util.Map<java.lang.String, byte[]>), D('otherValue' byte[])] */
    ...
    public final C1107bc A09(C0547Ht ht) {
        Map<String, byte[]> A022 = A02(this.A01, ht);
        if (A07(A022)) {
            return this;
        }
        return new C1107bc(A022);
    }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0545Hr
    public final long A5R(String str, long j) {
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0545Hr
    public final String A5S(String str, String str2) {
        if (this.A01.containsKey(str)) {
