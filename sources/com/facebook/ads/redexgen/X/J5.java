...
public final class J5 {
    ...
    public static boolean A02(Context context) {
        return J4.A0N(context).A22(A00(0, 47, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS), true);
    }

    public static boolean A03(Context context) {
        return J4.A0N(context).A22(A00(47, 47, 115), false);
    }

    public static boolean A04(Context context) {
        return J4.A0N(context).A22(A00(139, 46, 114), false);
    }

    public static boolean A05(Context context) {
        if (Build.VERSION.SDK_INT < 19 || !J4.A0N(context).A22(A00(185, 15, 91), false)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean A06(Context context) {
        return J4.A0N(context).A22(A00(94, 45, 96), false);
    }
}
