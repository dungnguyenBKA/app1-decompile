...
public final class RW implements AnonymousClass0K {
    public static String A07 = RW.class.getSimpleName();
    ...
    public RW(String str) {
        this(str, AnonymousClass0I.A01(str));
    }
    ...
    public RW(String str, @Nullable String str2) {
        this.A05 = RecyclerView.UNDEFINED_DURATION;
        this.A00 = -1;
        this.A03 = (String) AnonymousClass0J.A00(str);
        this.A06 = str2;
    }
    ...
    private HttpURLConnection A02(int i, int i2) throws IOException, RU {
        String A012;
        ...
        do {
            ...
            if (strArr[1].charAt(4) != strArr[5].charAt(4)) {
                ...
                if (code > 5) {
                    throw new RU(A01(293, 20, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE) + code);
                }
            } else {
                throw new RuntimeException();
            }
    ...
    private void A03() throws RU {
        ...
        try {
            ...
            Log.i(A07, A01(74, 18, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION) + this.A03 + A01(313, 9, 58) + this.A06 + A01(32, 18, 100) + this.A05);
            AnonymousClass0I.A06(inputStream);
        } catch (IOException e) {
    ...
    private final void A06(int i, int i2) throws RU {
        try {
            this.A02 = A02(i, i2);
            ...
            throw new RU(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e);
        }
    }
    ...
    public final void close() throws RU {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new RU(A01(92, 37, 93), e);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.AnonymousClass0K
    public final synchronized int length() throws RU {
        int i;
        int i2 = this.A05;
        ...
        if (strArr2[6].length() != strArr2[4].length()) {
            A09[3] = "gS2RFCMrZVvAwZylX045evNEUJ7fs3DK";
            return i;
        }
        String[] strArr3 = A09;
        strArr3[6] = "lavKIXl";
        strArr3[4] = "xddCZzh8okNZPw2KOzu6FC9g";
        return i;
    }

    /* JADX INFO: Multiple debug info for r5v0 'this'  com.facebook.ads.redexgen.X.RW: [D('e' java.io.InterruptedIOException), D('e' java.io.IOException)] */
    @Override // com.facebook.ads.redexgen.X.AnonymousClass0K
    public final int read(byte[] bArr) throws RU {
        InputStream inputStream = this.A01;
        String A012 = A01(183, 24, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION);
        if (inputStream != null) {
            try {
                return inputStream.read(bArr, 0, bArr.length);
            } catch (InterruptedIOException e) {
                throw new C0501Fy(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e);
            } catch (IOException e2) {
                throw new RU(A012 + this.A03, e2);
            }
        } else {
            throw new RU(A012 + this.A03 + A01(51, 23, 21));
        }
    }
