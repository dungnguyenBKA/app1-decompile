...
public class C1056an implements GE {
    ...
    @Override // com.facebook.ads.redexgen.X.GE
    public final AbstractC1055am A4G(Format format) {
        char c;
        ...
        switch (str.hashCode()) {
            case -1351681404:
                ...
                break;
            case -1248334819:
                if (str.equals(A00(FacebookMediationAdapter.ERROR_NULL_CONTEXT, 15, 26))) {
                    c = '\n';
                    break;
                }
                c = 65535;
        ...
        switch (c) {
            ...
            case 4:
                return new C01922s();
            case 5:
                return new C01902q(format.A0P);
            case 6:
            case 7:
                return new AnonymousClass3N(format.A0O, format.A03);
            case '\b':
                return new AnonymousClass3J(format.A03);
            case '\t':
                return new C01952v(format.A0P);
            case '\n':
                return new C01942u();
            default:
    ...
    public final boolean AEH(Format format) {
        String str = format.A0O;
        if (A00(236, 8, 112).equals(str) || A00(244, 10, 85).equals(str) || A00(122, 20, 87).equals(str) || A00(167, 21, 57).equals(str) || A00(216, 20, 2).equals(str) || A00(188, 28, 125).equals(str) || A00(50, 19, 119).equals(str) || A00(142, 25, 39).equals(str) || A00(69, 19, 27).equals(str) || A00(88, 19, 97).equals(str) || A00(FacebookMediationAdapter.ERROR_NULL_CONTEXT, 15, 26).equals(str)) {
            return true;
        }
        return false;
    }
