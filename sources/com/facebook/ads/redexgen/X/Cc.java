...
public final class Cc {
    ...
    public /* synthetic */ Cc(Z3 z3) {
        this();
    }

    public static Pair<String, List<byte[]>> A00(IM im) throws AJ {
        try {
            im.A0a(16);
            long A0L2 = im.A0L();
            if (A0L2 == 1482049860) {
            ...
            if (A0L2 == 826496599) {
                byte[] bArr = im.A00;
                for (int A072 = im.A07() + 20; A072 < bArr.length - 4; A072++) {
                    if (bArr[A072] == 0 && bArr[A072 + 1] == 0 && bArr[A072 + 2] == 1 && bArr[A072 + 3] == 15) {
                        return new Pair<>(A01(934, 10, FacebookMediationAdapter.ERROR_NULL_CONTEXT), Collections.singletonList(Arrays.copyOfRange(bArr, A072, bArr.length)));
                    }
                }
                throw new AJ(A01(238, 45, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD));
            }
            Log.w(A01(283, 17, 56), A01(HttpStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE, 51, 124));
            return new Pair<>(A01(944, 15, 9), null);
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw new AJ(A01(137, 33, 53));
        }
    }

    public static List<byte[]> A03(byte[] bArr) throws AJ {
        String A012 = A01(HttpStatus.SC_NO_CONTENT, 34, 125);
        try {
            if (bArr[0] == 2) {
                int i = 1;
                int i2 = 0;
    ...
    public static boolean A06(IM im) throws AJ {
        try {
            int A0D2 = im.A0D();
            if (A0D2 == 1) {
                return true;
            ...
            im.A0Z(24);
            if (im.A0M() == Z5.A0s.getMostSignificantBits() && im.A0M() == Z5.A0s.getLeastSignificantBits()) {
                return true;
            }
            return false;
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw new AJ(A01(170, 34, 13));
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:100:0x04b0, code lost:
        if (r7[0].length() == r7[5].length()) goto L_0x04ce;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:101:0x04b2, code lost:
        r7 = com.facebook.ads.redexgen.X.Cc.A0i;
        r7[0] = "GDRTIaIlzs7O11";
        r7[5] = "6URnVLVv";
        r2 = com.facebook.ads.internal.exoplayer2.Format.A0A(r8, r1, null, -1, r3, r2, r27.A0g, r27.A0U);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:102:0x04ce, code lost:
        com.facebook.ads.redexgen.X.Cc.A0i[6] = "fbrpEOPCxs8P1PkqPKxhpgVrBLZobrss";
        r2 = com.facebook.ads.internal.exoplayer2.Format.A0A(r8, r1, null, -1, r3, r2, r27.A0g, r27.A0U);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:144:0x0616, code lost:
        if (r9.equals(A01(50, 14, 32)) != false) goto L_0x0618;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:147:0x062d, code lost:
        if (r9.equals(A01(50, 14, 37)) != false) goto L_0x0618;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:201:0x0790, code lost:
        throw new com.facebook.ads.redexgen.X.AJ(A01(398, 21, 82));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x03e7, code lost:
        if (A01(693, 20, 14).equals(r1) != false) goto L_0x03e9;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:85:0x0409, code lost:
        if (A01(693, 20, 40).equals(r1) != false) goto L_0x03e9;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:87:0x041a, code lost:
        if (A01(871, 10, 78).equals(r1) == false) goto L_0x044a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:88:0x041c, code lost:
        r4 = 3;
        r7 = new java.util.ArrayList(2);
        r7.add(com.facebook.ads.redexgen.X.Z5.A0t);
        r7.add(r27.A0d);
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:90:0x0458, code lost:
        if (A01(675, 18, 29).equals(r1) != false) goto L_0x049a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:91:0x045a, code lost:
        r7 = A01(660, 15, 25).equals(r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:92:0x0475, code lost:
        if (com.facebook.ads.redexgen.X.Cc.A0i[6].charAt(13) == 'P') goto L_0x047d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:94:0x047c, code lost:
        throw new java.lang.RuntimeException();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:95:0x047d, code lost:
        r6 = com.facebook.ads.redexgen.X.Cc.A0i;
        r6[2] = "mzu";
        r6[4] = "qu0J2ADkyWaVBa9kD7o9Qirh7WEjYJw0";
     */
    /* JADX WARNING: Code restructure failed: missing block: B:96:0x0489, code lost:
        if (r7 != false) goto L_0x049a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:98:0x0498, code lost:
        if (A01(641, 19, 5).equals(r1) == false) goto L_0x0781;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:99:0x049a, code lost:
        r4 = 3;
    ...
    public final void A0A(com.facebook.ads.redexgen.X.CI r28, int r29) throws com.facebook.ads.redexgen.X.AJ {
        /*
        // Method dump skipped, instructions count: 2118
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.Cc.A0A(com.facebook.ads.redexgen.X.CI, int):void");
    }
}
