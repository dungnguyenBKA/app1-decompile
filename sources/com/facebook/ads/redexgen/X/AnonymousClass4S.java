...
public final class AnonymousClass4S {
    public static byte[] A09;
    public static String[] A0A;
    public int A00 = 2;
    public AnonymousClass4R A01;
    public ArrayList<AbstractC02274c> A02 = null;
    public int A03 = 2;
    public AbstractC02254a A04;
    public final ArrayList<AbstractC02274c> A05 = new ArrayList<>();
    public final ArrayList<AbstractC02274c> A06 = new ArrayList<>();
    public final List<AbstractC02274c> A07 = Collections.unmodifiableList(this.A05);
    public final /* synthetic */ C0469Eq A08;
    ...
    public AnonymousClass4S(C0469Eq eq) {
        this.A08 = eq;
    }
    ...
    /* JADX INFO: Multiple debug info for r10v0 'this'  com.facebook.ads.redexgen.X.4S: [D('i' int), D('offsetPosition' int)] */
    private final AbstractC02274c A01(int i) {
        int size;
        int A0E;
        ArrayList<AbstractC02274c> arrayList = this.A02;
        if (arrayList == null || (size = arrayList.size()) == 0) {
            return null;
        }
        for (int i2 = 0; i2 < size; i2++) {
            AbstractC02274c r1 = this.A02.get(i2);
            if (!r1.A0j() && r1.A0J() == i) {
                r1.A0U(32);
                return r1;
            }
        ...
        if (this.A08.A04.A0C() && (A0E = this.A08.A00.A0E(i)) > 0 && A0E < this.A08.A04.A0E()) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                AbstractC02274c r3 = this.A02.get(i3);
    ...
    /* JADX INFO: Multiple debug info for r6v0 int: [D('i' int), D('cacheSize' int)] */
    private final AbstractC02274c A02(int cacheSize, boolean z) {
        View A092;
        int size = this.A05.size();
        for (int i = 0; i < size; i++) {
            AbstractC02274c r1 = this.A05.get(i);
        ...
        if (z || (A092 = this.A08.A01.A09(cacheSize)) == null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                AbstractC02274c r12 = this.A06.get(i2);
        ...
        AbstractC02274c A0G = C0469Eq.A0G(A092);
        ...
        throw new IllegalStateException(A04(727, 52, 27) + A0G + this.A08.A1J());
    }
    ...
    private final com.facebook.ads.redexgen.X.AbstractC02274c A03(long r8, int r10, boolean r11) {
        /*
        // Method dump skipped, instructions count: 313
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass4S.A03(long, int, boolean):com.facebook.ads.redexgen.X.4c");
    }
    ...
    private void A0A(AbstractC02274c r3) {
        if (this.A08.A1t()) {
            View view = r3.A0H;
            if (AnonymousClass2z.A00(view) == 0) {
                AnonymousClass2z.A09(view, 1);
            }
            if (!AnonymousClass2z.A0E(view)) {
                r3.A0U(16384);
                AnonymousClass2z.A0A(view, this.A08.A09.A0A());
            }
        }
    }

    private void A0B(AbstractC02274c r3) {
        if (r3.A0H instanceof ViewGroup) {
            A09((ViewGroup) r3.A0H, false);
        }
    }

    private final void A0C(AbstractC02274c r2) {
        if (this.A08.A07 != null) {
            throw null;
        }
        AnonymousClass48 r0 = this.A08.A04;
        if (this.A08.A0s != null) {
            this.A08.A0t.A0C(r2);
        }
    }

    private final boolean A0D(AbstractC02274c r7) {
        if (r7.A0d()) {
            return this.A08.A0s.A07();
        }
        if (r7.A03 < 0 || r7.A03 >= this.A08.A04.A0E()) {
            throw new IndexOutOfBoundsException(A04(211, 60, 112) + r7 + this.A08.A1J());
    ...
    private boolean A0E(AbstractC02274c r10, int i, int i2, long j) {
        r10.A08 = this.A08;
        int A0I = r10.A0I();
        long nanoTime = this.A08.getNanoTime();
        if (j != Long.MAX_VALUE) {
            AnonymousClass4R r3 = this.A01;
            String[] strArr = A0A;
    ...
    public final AnonymousClass4R A0I() {
        if (this.A01 == null) {
            this.A01 = new AnonymousClass4R();
        }
        return this.A01;
    }

    @Nullable
    public final AbstractC02274c A0J(int i, boolean z, long j) {
        AnonymousClass4L r4;
        C0469Eq A0I;
        AbstractC02254a r0;
        View A002;
        if (i < 0 || i >= this.A08.A0s.A03()) {
            throw new IndexOutOfBoundsException(A04(271, 22, 0) + i + A04(12, 1, 99) + i + A04(21, 14, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION) + this.A08.A0s.A03() + this.A08.A1J());
        }
        boolean fromScrapOrHiddenOrCache = false;
        AbstractC02274c holder = null;
        boolean z2 = true;
        if (this.A08.A0s.A07()) {
            holder = A01(i);
            if (holder != null) {
        ...
        if (holder == null) {
            ...
            if (A0E < 0 || A0E >= this.A08.A04.A0E()) {
                throw new IndexOutOfBoundsException(A04(165, 46, 118) + i + A04(13, 8, 126) + A0E + A04(35, 8, 119) + this.A08.A0s.A03() + this.A08.A1J());
            }
            ...
            if (!(holder != null || (r0 = this.A04) == null || (A002 = r0.A00(this, i, A042)) == null)) {
                ...
                if (holder == null) {
                    throw new IllegalArgumentException(A04(653, 74, 17) + this.A08.A1J());
                } else if (holder.A0i()) {
                    throw new IllegalArgumentException(A04(540, 113, 76) + this.A08.A1J());
                }
            }
            if (holder == null) {
                AnonymousClass4R A0I2 = A0I();
                String[] strArr = A0A;
                if (strArr[5].charAt(0) != strArr[3].charAt(0)) {
            ...
            if (holder == null) {
                ...
                AnonymousClass48 r7 = this.A08.A04;
                C0469Eq eq = this.A08;
                String[] strArr2 = A0A;
                if (strArr2[5].charAt(0) != strArr2[3].charAt(0)) {
                    ...
                    holder = r7.A06(eq, A042);
                    if ((C0469Eq.A1E) && (A0I = C0469Eq.A0I(holder.A0H)) != null) {
        ...
        if (fromScrapOrHiddenOrCache && !this.A08.A0s.A07() && holder.A0l(8192)) {
            holder.A0V(0, 8192);
            if (this.A08.A0s.A0C) {
                this.A08.A1n(holder, this.A08.A05.A08(this.A08.A0s, holder, AnonymousClass4G.A00(holder) | 4096, holder.A0M()));
            }
        }
        boolean z3 = false;
        ...
        if (layoutParams == null) {
            r4 = (AnonymousClass4L) this.A08.generateDefaultLayoutParams();
            holder.A0H.setLayoutParams(r4);
        } else if (!this.A08.checkLayoutParams(layoutParams)) {
            r4 = (AnonymousClass4L) this.A08.generateLayoutParams(layoutParams);
            holder.A0H.setLayoutParams(r4);
        } else {
            if (A0A[0].length() == 16) {
                A0A[4] = "WeHbAL2DpvJL4iRMn0O7hIhaGbvumhB7";
                r4 = (AnonymousClass4L) layoutParams;
            }
            throw new RuntimeException();
        }
        r4.A00 = holder;
    ...
    public final List<AbstractC02274c> A0K() {
        return this.A07;
    }
    ...
    public final void A0N() {
        int size = this.A06.size();
        for (int i = 0; i < size; i++) {
            AnonymousClass4L r1 = (AnonymousClass4L) this.A06.get(i).A0H.getLayoutParams();
            if (r1 != null) {
                r1.A01 = true;
            }
        }
    ...
    public final void A0O() {
        ...
        int size = this.A06.size();
        for (int i = 0; i < size; i++) {
            AbstractC02274c r3 = this.A06.get(i);
            if (A0A[0].length() != 16) {
                throw new RuntimeException();
            }
            String[] strArr = A0A;
    ...
    public final void A0P() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass4S.A0P():void");
    }
    ...
    public final void A0S(int i, int i2) {
        int size = this.A06.size();
        for (int i3 = 0; i3 < size; i3++) {
            AbstractC02274c r1 = this.A06.get(i3);
            if (r1 != null && r1.A03 >= i) {
                r1.A0X(i2, true);
            }
        }
    ...
    public final void A0T(int end, int inBetweenOffset) {
        ...
        int size = this.A06.size();
        for (int i3 = 0; i3 < size; i3++) {
            AbstractC02274c r3 = this.A06.get(i3);
    ...
    public final void A0U(int cachedCount, int i) {
        ...
        for (int size = this.A06.size() - 1; size >= 0; size--) {
            AbstractC02274c r1 = this.A06.get(size);
    ...
    public final void A0X(View view) {
        ...
        if (A0G.A0l(12) || !A0G.A0g() || this.A08.A21(A0G)) {
            ...
            throw new IllegalArgumentException(A04(43, 122, 32) + this.A08.A1J());
        }
        if (this.A02 == null) {
    ...
    public final void A0Z(AnonymousClass48 r2, AnonymousClass48 r3, boolean z) {
        A0Q();
        A0I().A09(r2, r3, z);
    }

    public final void A0a(AnonymousClass4R r3) {
        AnonymousClass4R r0 = this.A01;
        if (r0 != null) {
            r0.A05();
        }
        this.A01 = r3;
    ...
    public final void A0b(AbstractC02254a r1) {
        this.A04 = r1;
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void A0c(com.facebook.ads.redexgen.X.AbstractC02274c r10) {
        /*
        // Method dump skipped, instructions count: 384
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass4S.A0c(com.facebook.ads.redexgen.X.4c):void");
    }

    public final void A0d(AbstractC02274c r2) {
        if (r2.A0G) {
            this.A02.remove(r2);
        } else {
            this.A05.remove(r2);
    ...
    public final void A0e(AbstractC02274c r4, boolean z) {
        C0469Eq.A0u(r4);
        if (r4.A0l(16384)) {
            r4.A0V(0, 16384);
            AnonymousClass2z.A0A(r4.A0H, null);
        }
        if (z) {
            A0C(r4);
        }
