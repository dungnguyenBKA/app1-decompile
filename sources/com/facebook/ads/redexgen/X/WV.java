...
public class WV implements AbstractC02876l<String> {
    ...
    public WV(Context context, String str, EnumC02766a r4) {
        this.A00 = str;
    ...
    @Nullable
    public static String A03(Context context, String str, EnumC02766a r4) {
        int i = AnonymousClass6Z.A00[r4.ordinal()];
        if (i == 1) {
    ...
    public final boolean A80(Object obj) {
        ...
        String str2;
        WV wv = (WV) obj;
        if (this.A00 == null && wv.A00 == null) {
            z = true;
        } else {
            z = false;
        }
        if (this.A01 == null && wv.A01 == null) {
            z2 = true;
        } else {
            z2 = false;
        }
        String str3 = this.A00;
        if (!(str3 == null || (str2 = wv.A00) == null)) {
            z = str3.equals(str2);
        }
        String str4 = this.A01;
        if (!(str4 == null || (str = wv.A01) == null)) {
            z2 = str4.equals(str);
        }
        if (!z || !z2) {
            return false;
