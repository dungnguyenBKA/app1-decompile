...
public class C02223x {
    public static byte[] A05;
    public int A00;
    public int A01;
    public boolean A02;
    public boolean A03;
    public final /* synthetic */ TB A04;
    ...
    /* JADX INFO: Multiple debug info for r0v33 int: [D('childEnd' int), D('childSize' int)] */
    /* JADX INFO: Multiple debug info for r0v41 int: [D('startReference' int), D('layoutStart' int)] */
    ...
    public final boolean A06(View view, AnonymousClass4Z r4) {
        AnonymousClass4L r1 = (AnonymousClass4L) view.getLayoutParams();
        if (r1.A02() || r1.A00() < 0 || r1.A00() >= r4.A03()) {
            return false;
        }
        return true;
    }
