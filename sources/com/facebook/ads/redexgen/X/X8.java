...
public final class X8<T> extends AbstractC02956t<List<T>> {
    ...
    public X8(long j, @Nullable C02936r r9, List<T> list, EnumC02946s r11) {
        super(j, r9, list, EnumC02946s.A08);
        this.A01 = list;
        this.A00 = r11;
        if (!A05()) {
    ...
    private int A00(T t) {
        int i = C02886m.A00[this.A00.ordinal()];
        if (i == 1) {
            return 4;
        }
        if (i == 2) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.facebook.ads.redexgen.X.X8<T> */
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC02956t
    public final boolean A0B(AbstractC02956t<List<T>> r10) {
        List<T> A08 = r10.A08();
        T newSignal = A08();
        if (newSignal == null || A08 == null) {
            ...
            while (true) {
                ...
                int i2 = C02886m.A00[this.A00.ordinal()];
                if (i2 == 1 || i2 == 2) {
                    if (!A08.get(i).equals(newSignal.get(i))) {
                        return false;
                    }
                } else if (i2 == 3 && !t.A80(obj)) {
                    return false;
                }
                i++;
            }
