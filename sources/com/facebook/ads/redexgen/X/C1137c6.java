...
public class C1137c6 implements AnonymousClass75 {
    ...
    public C1137c6(C1143cD cDVar, C0794Rp rp, boolean z) {
        this.A01 = cDVar;
        this.A00 = rp;
        this.A02 = z;
    }
    ...
    public final void A9h() {
        ...
        this.A01.A0a.A0A().A2d(LZ.A01(this.A01.A00), adErrorType.getErrorCode(), A002);
        if (this.A01.A0F != null) {
            this.A01.A0F.AA7(C0588Jl.A02(adErrorType, A002));
        }
    }

    /* JADX WARNING: Code restructure failed: missing block: B:12:0x006d, code lost:
        if (r3.A0D.equals(com.facebook.ads.redexgen.X.JS.A04) != false) goto L_0x006f;
     */
    ...
    public final void A9o() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1137c6.A9o():void");
    }
}
