...
public final class C0613Kl {
    ...
    public static EnumC0612Kk A00() throws ClassNotFoundException, NoSuchMethodException, NoSuchFieldException, InvocationTargetException, IllegalAccessException {
        ...
        for (Object obj : map.values()) {
            ...
            if (activity.isTaskRoot() && activity.getIntent().getCategories().contains(A03(34, 32, 84))) {
                return EnumC0612Kk.A06;
            }
        }
        return EnumC0612Kk.A09;
    }

    public static EnumC0612Kk A01(Context context) {
        try {
