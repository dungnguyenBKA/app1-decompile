...
public final class AnonymousClass6P {
    ...
    public AnonymousClass6P(int i, int i2, int i3, float[] fArr, float f, float f2, float f3) {
        this.A05 = i;
        this.A03 = i2;
        this.A04 = i3;
        this.A06 = fArr;
    ...
    public final JSONObject A0B(JSONObject pointerLocObject) throws JSONException {
        ...
        jSONObject2.put(A06(16, 1, 9), (double) AnonymousClass72.A00(this.A06[0]));
        jSONObject2.put(A06(17, 1, 37), (double) AnonymousClass72.A00(this.A06[1]));
        jSONObject.put(A06(5, 2, 98), jSONObject2);
        jSONObject.put(A06(11, 2, 47), (double) AnonymousClass72.A00(this.A02));
        jSONObject.put(A06(9, 2, 17), (double) AnonymousClass72.A00(this.A01));
        jSONObject.put(A06(7, 2, 5), (double) AnonymousClass72.A00(this.A00));
        pointerLocObject.put(A06(15, 1, 123), jSONObject);
        return pointerLocObject;
    }

    public final boolean A0C(AnonymousClass6P r6) {
        if (A05() == r6.A05() && A03() == r6.A03() && A04() == r6.A04()) {
            ...
            if (strArr[0].charAt(29) != strArr[3].charAt(29)) {
                ...
                if (abs < C02715v.A01() && Math.abs(A09()[1] - r6.A09()[1]) < C02715v.A01()) {
                    int i = (Math.abs(A02() - r6.A02()) > C02715v.A01() ? 1 : (Math.abs(A02() - r6.A02()) == C02715v.A01() ? 0 : -1));
                    String[] strArr3 = A08;
                    ...
                    if (i >= 0 || Math.abs(A01() - r6.A01()) >= C02715v.A01() || Math.abs(A00() - r6.A00()) >= C02715v.A01()) {
                        return false;
                    }
                    return true;
                }
