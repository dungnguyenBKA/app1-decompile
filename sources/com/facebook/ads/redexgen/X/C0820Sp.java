...
public class C0820Sp<T> implements AnonymousClass2V<T> {
    ...
    public static String A00(int i, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < copyOfRange.length; i4++) {
            ...
            if (strArr[4].length() != strArr[7].length()) {
                A03[5] = "P1E265Ge3cQ";
                copyOfRange[i4] = (byte) ((b ^ i3) ^ FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE);
            } else {
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass2V
    public T A2P() {
        int i = this.A00;
        if (i <= 0) {
            return null;
