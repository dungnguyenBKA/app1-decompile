...
public final class C0437De {
    ...
    public C0437De(String str, @Nullable String str2, @Nullable MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
        boolean z4;
        boolean z5;
        this.A02 = (String) C0551Hx.A01(str);
        this.A01 = str2;
    ...
    public static int A00(String str, String str2, int i) {
        ...
        if (i <= 1) {
            ...
            if (strArr[3].length() == strArr[4].length()) {
                ...
                if ((i3 < 26 || i <= 0) && !A03(226, 10, 23).equals(str2) && !A03(121, 10, 22).equals(str2) && !A03(140, 12, 57).equals(str2) && !A03(211, 15, 119).equals(str2) && !A03(255, 12, 11).equals(str2) && !A03(236, 10, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD).equals(str2) && !A03(246, 9, 118).equals(str2)) {
                    ...
                    if (strArr3[0].length() != strArr3[5].length()) {
                        ...
                        if (!A032.equals(str2) && !A03(172, 15, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS).equals(str2) && !A03(187, 15, 4).equals(str2) && !A03(HttpStatus.SC_ACCEPTED, 9, 47).equals(str2)) {
    ...
    public static C0437De A01(String str) {
        return new C0437De(str, null, null, true, false, false);
    }

    public static C0437De A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        return new C0437De(str, str2, codecCapabilities, false, z, z2);
    }
    ...
    public static boolean A0A(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0556Ic.A02 >= 21 && A0B(codecCapabilities);
    }
    ...
    public static boolean A0C(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0556Ic.A02 >= 21 && A0D(codecCapabilities);
    }
    ...
    public final Point A0F(int widthAlignment, int heightAlignment) {
        ...
        if (videoCapabilities == null) {
            A07(A03(FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD, 11, 68));
            return null;
        }
        int widthAlignment2 = videoCapabilities.getWidthAlignment();
        int heightAlignment2 = videoCapabilities.getHeightAlignment();
        return new Point(C0556Ic.A04(widthAlignment, widthAlignment2) * widthAlignment2, C0556Ic.A04(heightAlignment, heightAlignment2) * heightAlignment2);
    }
    ...
    public final boolean A0G(int i) {
        ...
        if (A08[1].length() != 9) {
            ...
            if (audioCapabilities == null) {
                ...
                A07(A03(HttpStatus.SC_MOVED_TEMPORARILY, 22, 10) + i);
                return false;
            }
        } else {
            throw new RuntimeException();
    ...
    public final boolean A0I(int i, int i2, double d) {
        ...
        if (videoCapabilities == null) {
            ...
            String A032 = A03(513, 1, 40);
            if (i >= i2 || !A0E(videoCapabilities, i2, i, d)) {
                A07(A03(458, 21, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD) + i + A032 + i2 + A032 + d);
                return false;
            }
    ...
    public final boolean A0J(String codecMimeType) {
        String A052;
        if (codecMimeType == null || this.A01 == null || (A052 = IF.A05(codecMimeType)) == null) {
            return true;
        }
        ...
        Pair<Integer, Integer> A022 = C0446Dp.A02(codecMimeType);
        if (A022 == null) {
            return true;
        }
