...
public final class AnonymousClass5G implements NativeAdsManagerApi {
    ...
    public AnonymousClass5G(Context context, String str, int i) {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC0593Jr jr = EnumC0593Jr.A05;
        int i = this.A06;
        SP sp = this.A02;
        this.A02 = new SP(this.A07, this.A08, jr, null, i);
        if (this.A05) {
            this.A02.A07();
        }
        this.A02.A0A(this.A03);
        this.A02.A09(new C0842To(this, this.A07, mediaCacheFlag));
        this.A02.A08();
    }
