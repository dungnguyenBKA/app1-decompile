...
public final class GZ {
    ...
    public GZ(String str, String str2, long j, long j2, C0508Gf gf, String[] strArr, String str3) {
        boolean z;
        this.A05 = str;
        this.A06 = str2;
        this.A03 = gf;
        ...
        this.A02 = j;
        this.A01 = j2;
        this.A04 = (String) C0551Hx.A01(str3);
        this.A09 = new HashMap<>();
        this.A08 = new HashMap<>();
    }

    private final int A00() {
        List<GZ> list = this.A00;
        if (list == null) {
            return 0;
        }
        return list.size();
    ...
    public static GZ A04(String str) {
        return new GZ(null, C0504Gb.A02(str), -9223372036854775807L, -9223372036854775807L, null, null, A06(0, 0, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION));
    }

    public static GZ A05(String str, long j, long j2, C0508Gf gf, String[] strArr, String str2) {
        return new GZ(str, null, j, j2, gf, strArr, str2);
    }
    ...
    private void A09(long j, Map<String, C0508Gf> map, Map<String, SpannableStringBuilder> map2) {
        int i;
        if (A0D(j)) {
    ...
    private void A0A(long j, boolean z, String str, Map<String, SpannableStringBuilder> map) {
        ...
        if (!A06(2, 8, 48).equals(this.A05)) {
            if (!A06(0, 0, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION).equals(this.A04)) {
                str2 = this.A04;
            }
            if (!this.A07 || !z) {
                if (A06(0, 2, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS).equals(this.A05) && z) {
    ...
    private void A0B(Map<String, C0508Gf> map, SpannableStringBuilder spannableStringBuilder, int i, int i2) {
        C0508Gf A002 = C0504Gb.A00(this.A03, this.A0A, map);
        if (A002 != null) {
            C0504Gb.A06(spannableStringBuilder, i, i2, A002);
        }
    }
    ...
    public final List<GB> A0E(long j, Map<String, C0508Gf> map, Map<String, C0503Ga> map2) {
        ...
        for (Map.Entry<String, SpannableStringBuilder> entry : regionOutputs.entrySet()) {
            C0503Ga ga = map2.get(entry.getKey());
            arrayList.add(new GB(A01(entry.getValue()), (Layout.Alignment) null, ga.A00, ga.A05, ga.A04, ga.A01, (int) RecyclerView.UNDEFINED_DURATION, ga.A03, ga.A06, ga.A02));
        }
        return arrayList;
    }

    public final void A0F(GZ gz) {
        if (this.A00 == null) {
