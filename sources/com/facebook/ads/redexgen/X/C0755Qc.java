...
public final class C0755Qc {
    @Nullable
    public static QI A00;
    ...
    public static QK A00(AnonymousClass8D r1) {
        return A03(true, r1);
    }

    public static QK A01(AnonymousClass8D r1) {
        return A02(true, r1);
    }

    public static QK A02(boolean z, AnonymousClass8D r7) {
        QO qo = new QO();
        QR A042 = A04(r7);
        if (!A0B()) {
            qo.A02(A04);
        ...
        if (C0624Kz.A04()) {
            Map<String, String> A022 = C0624Kz.A02();
            String[] strArr = A02;
        ...
        return QM.A00().A01(qo.A00(A042.A09()).A03(z).A04(BuildConfigApi.isDebug()).A05(), r7.A04(), ExecutorC0637Lm.A01());
    }

    public static QK A03(boolean z, AnonymousClass8D r5) {
        return QM.A00().A01(new QO().A03(z).A00(A04(r5).A09()).A04(BuildConfigApi.isDebug()).A05(), r5.A04(), ExecutorC0637Lm.A01());
    }

    public static QR A04(AnonymousClass8D r5) {
        A09(r5);
        QR qr = new QR();
        if (A0B()) {
            qr.A02(360000).A04(120000);
        } else {
            int A07 = J4.A07(r5);
        ...
        qr.A03(J4.A08(r5)).A04(J4.A09(r5)).A05(J4.A0A(r5)).A06(J4.A0B(r5));
        synchronized (C0755Qc.class) {
            if (A00 != null && (A00 instanceof QI)) {
                qr.A07(A00);
            }
        }
        return qr;
    ...
    public static void A09(AnonymousClass8D r5) {
        if (!A05.get()) {
            r5.A04().A8V(A05(158, 7, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), C03228e.A1j, new C03238f(A05(90, 23, 119)));
        }
    }

    public static synchronized void A0A(QI qi) {
        synchronized (C0755Qc.class) {
            A00 = qi;
        }
    }
    ...
    public static boolean A0C(AnonymousClass8D r5) {
