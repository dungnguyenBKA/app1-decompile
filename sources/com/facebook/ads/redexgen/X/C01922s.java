...
public final class C01922s extends C3 {
    ...
    /* renamed from: A01 */
    public final C1063au A0d(byte[] bArr, int i, boolean z) {
            ...
            if (A0Q == null) {
                ...
                try {
                    ...
                    if (!matcher.matches()) {
                        ...
                        ic.A04(A00(matcher, 1));
                        if (!TextUtils.isEmpty(matcher.group(6))) {
                            z2 = true;
                            ic.A04(A00(matcher, 6));
                        }
                        ...
                        arrayList.add(new GB(Html.fromHtml(this.A00.toString())));
                        if (z2) {
                            arrayList.add(null);
                        }
                    } else {
        ...
        return new C1063au(gbArr, ic.A05());
    }
}
