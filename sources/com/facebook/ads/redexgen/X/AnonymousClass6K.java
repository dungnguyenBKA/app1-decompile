...
public final class AnonymousClass6K implements SensorEventListener {
    public static byte[] A09;
    public static String[] A0A;
    public static final String A0B = AnonymousClass6K.class.getSimpleName();
    public AnonymousClass6I A00;
    public final Context A01;
    public final SensorManager A02;
    public final Handler A03;
    public final AnonymousClass6F A04;
    public final AnonymousClass6H A05;
    public final EnumC02846i A06;
    public final List<Sensor> A07;
    public final Map<Integer, AnonymousClass6O> A08 = new HashMap();
    ...
    public AnonymousClass6K(Context context, AnonymousClass6F r5, EnumC02846i r6) {
        this.A01 = context;
        this.A03 = new Handler(C03016z.A00().A04().getLooper());
        this.A02 = (SensorManager) context.getSystemService(A00(0, 6, 54));
        this.A07 = this.A02.getSensorList(-1);
        this.A04 = r5;
        this.A05 = new AnonymousClass6H(this.A04, r6);
        this.A06 = r6;
    }

    @SuppressLint({"CatchGeneralException"})
    public final synchronized void A03(List<AnonymousClass6O> list) {
        try {
            for (AnonymousClass6O r6 : list) {
                if (r6 != null) {
                    int A032 = r6.A03();
                    if (A032 != -1) {
    ...
    @SuppressLint({"CatchGeneralException"})
    public final synchronized void A04(List<AnonymousClass6O> list) {
        try {
            if (this.A08 != null) {
                if (list == null) {
                ...
                for (AnonymousClass6O r4 : list) {
                    ...
                    if (A032 != -1) {
                        if (r4.A03() == 0) {
                            ...
                            if (AnonymousClass6J.A00[r4.ordinal()] == 1) {
                                this.A05.A02();
                            }
                        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x00ea, code lost:
        r13.A04.A02(new com.facebook.ads.redexgen.X.X5(r3, r1, r14.values[0]), com.facebook.ads.redexgen.X.AnonymousClass6E.A0D);
     */
    ...
    public final void onSensorChanged(android.hardware.SensorEvent r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass6K.onSensorChanged(android.hardware.SensorEvent):void");
    }
}
