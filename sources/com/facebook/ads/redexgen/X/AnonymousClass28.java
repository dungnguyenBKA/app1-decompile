...
public final class AnonymousClass28 {
    public static AnonymousClass28 A01;
    public static byte[] A02;
    public static String[] A03;
    public static final String[] A04 = {A05(488, 7, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS), A05(495, 19, 96), A05(514, 25, 30), A05(539, 15, 120), A05(649, 9, 8), A05(658, 21, 68), A05(679, 27, 53), A05(706, 17, 5), A05(576, 21, 112), A05(454, 16, 91), A05(470, 18, 20), A05(434, 20, 83), A05(732, 20, 46), A05(352, 14, 46), A05(597, 25, 39)};
    ...
    public AnonymousClass28(XK xk) {
        this.A00 = xk.getSharedPreferences(ProcessUtils.getProcessSpecificName(A05(398, 36, 78), xk), 0);
    }

    public static long A00(XK xk) {
        return A02(xk).A01(A05(554, 22, 23), 0);
    }
    ...
    public static AnonymousClass28 A02(XK xk) {
        if (A01 == null) {
            synchronized (AnonymousClass28.class) {
                if (A01 == null) {
                    A01 = new AnonymousClass28(xk);
                }
            }
        }
        return A01;
    ...
    public static AnonymousClass2B A03(XK xk) {
        AnonymousClass2B r6 = new AnonymousClass2B(A0H(xk));
        try {
            Iterator<AdReportingReason> it = A0K(A02(xk).A0J(A05(539, 15, 120), A05(0, 0, 94))).iterator();
            while (it.hasNext()) {
                r6.A06((AnonymousClass2B) it.next());
            }
        } catch (JSONException e) {
            A02(xk).A0M();
            xk.A04().A8V(A05(723, 9, 116), C03228e.A1o, new C03238f(e));
        }
        return r6;
    }

    public static AnonymousClass2B A04(XK xk) {
        AnonymousClass2B r6 = new AnonymousClass2B(A0I(xk));
        try {
            Iterator<AdReportingReason> it = A0K(A02(xk).A0J(A05(706, 17, 5), A05(0, 0, 94))).iterator();
            while (it.hasNext()) {
                r6.A06((AnonymousClass2B) it.next());
            }
        } catch (JSONException e) {
            A02(xk).A0M();
            xk.A04().A8V(A05(723, 9, 116), C03228e.A1r, new C03238f(e));
        }
        return r6;
    }

    public static String A06(XK xk) {
        return A02(xk).A0J(A05(352, 14, 46), A05(0, 0, 94));
    }

    public static String A07(XK xk) {
        return A02(xk).A0J(A05(434, 20, 83), A05(312, 38, 71));
    }

    public static String A08(XK xk) {
        return A02(xk).A0J(A05(454, 16, 91), A05(38, 10, 26));
    }

    public static String A09(XK xk) {
        return A02(xk).A0J(A05(470, 18, 20), A05(48, 12, 9));
    }

    public static String A0A(XK xk) {
        return A02(xk).A0J(A05(495, 19, 96), A05(268, 23, 59));
    }

    public static String A0B(XK xk) {
        return A02(xk).A0J(A05(488, 7, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS), A05(193, 7, 27));
    }

    public static String A0C(XK xk) {
        return A02(xk).A0J(A05(597, 25, 39), A05(0, 0, 94));
    }

    public static String A0D(XK xk) {
        return A02(xk).A0J(A05(576, 21, 112), A05(HttpStatus.SC_OK, 21, 91));
    }

    public static String A0E(XK xk) {
        return A02(xk).A0J(A05(658, 21, 68), A05(0, 38, 38));
    }

    public static String A0F(XK xk) {
        return A02(xk).A0J(A05(649, 9, 8), A05(259, 9, 41));
    }

    public static String A0G(XK xk) {
        return A02(xk).A0J(A05(732, 20, 46), A05(291, 21, 17));
    }

    public static String A0H(XK xk) {
        return A02(xk).A0J(A05(514, 25, 30), A05(60, 69, 121));
    }

    public static String A0I(XK xk) {
        return A02(xk).A0J(A05(679, 27, 53), A05(129, 64, 34));
    }
    ...
    /* JADX INFO: Multiple debug info for r0v16 java.util.List<com.facebook.ads.redexgen.X.2B>: [D('reason' com.facebook.ads.redexgen.X.2B), D('children' java.util.List<com.facebook.ads.internal.adreportingconfig.AdReportingReason>)] */
    /* JADX INFO: Multiple debug info for r0v24 com.facebook.ads.redexgen.X.2B: [D('children' java.util.List<com.facebook.ads.internal.adreportingconfig.AdReportingReason>), D('child' com.facebook.ads.redexgen.X.2B)] */
    public static List<AnonymousClass2B> A0K(String str) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            AnonymousClass2B r6 = new AnonymousClass2B(jSONObject.getInt(A05(637, 12, 99)), jSONObject.getString(A05(626, 11, 123)), jSONObject.optString(A05(366, 16, 17)));
    ...
    @Nullable
    public static Map<String, String> A0L(XK xk, @Nullable String str) {
                ...
                if (!str.equals(A052)) {
                    ...
                    try {
                        ...
                        if (A0K(jSONObject.getString(A05(706, 17, 5))).size() == 0) {
                            xk.A04().A8V(A05, C03228e.A1q, new C03238f(A05(239, 20, 101)));
                            return null;
                        } else if (A0K(jSONObject.getString(A05(539, 15, 120))).size() != 0) {
                            return hashMap;
                        } else {
                            xk.A04().A8V(A05, C03228e.A1n, new C03238f(A05(221, 18, 10)));
                            return null;
                        }
                    } catch (JSONException e) {
                        xk.A04().A8V(A05, C03228e.A1p, new C03238f(e));
                        return null;
                    }
                }
            } else {
    ...
    public static void A0P(XK xk, @Nullable String str) {
        Map<String, String> A0L = A0L(xk, str);
        if (A0L != null && A0L.size() == A04.length) {
            SharedPreferences.Editor edit = A02(xk).A00.edit();
            String[] strArr = A04;
    ...
    public static boolean A0Q(XK xk, boolean z) {
        boolean z2;
