...
public final class C03388u {
    public static byte[] A04;
    public static String[] A05;
    public final String A00;
    public final String A01;
    public final Map<EnumC03428y, List<String>> A02 = new HashMap();
    ...
    public C03388u(String str, String str2, JSONObject jSONObject, @Nullable JSONArray jSONArray) {
        this.A00 = str;
        this.A01 = str2;
        this.A03 = jSONObject;
        if (!(jSONArray == null || jSONArray.length() == 0)) {
            for (EnumC03428y r2 : EnumC03428y.values()) {
                this.A02.put(r2, new LinkedList());
            }
            for (int i = 0; i < jSONArray.length(); i++) {
                try {
                    JSONObject jSONObject2 = jSONArray.getJSONObject(i);
                    String string = jSONObject2.getString(A00(0, 4, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS));
                    String string2 = jSONObject2.getString(A00(4, 3, 61));
                    EnumC03428y valueOf = EnumC03428y.valueOf(string.toUpperCase(Locale.US));
    ...
    public final List<String> A04(EnumC03428y r2) {
