...
public final class AnonymousClass14 extends BroadcastReceiver {
    ...
    public AnonymousClass14(C0387At at, Context context) {
        this.A01 = at;
        this.A00 = context;
    }
    ...
    public final void A03() {
        ...
        AnonymousClass2K.A00(this.A00).A07(this, intentFilter);
    }

    public final void A04() {
        try {
            AnonymousClass2K.A00(this.A00).A06(this);
            ...
            if (str.equals(A00(116, 21, 58))) {
                ...
                if (serializableExtra instanceof K8) {
                    if (this.A01.getListener() != null) {
                        ...
                        this.A01.getListener().AC9();
                    }
                    if (this.A02) {
                        this.A01.A0V(1);
                    } else {
                        this.A01.A0V(((K8) serializableExtra).A01());
                    }
                    this.A01.setVisibility(0);
                    this.A01.A0Y(PO.A05, 1);
                } else if (serializableExtra instanceof C0611Kj) {
                    if (this.A01.getListener() != null) {
                        MH listener = this.A01.getListener();
                ...
                } else if (serializableExtra instanceof KX) {
                    if (this.A01.getListener() != null) {
                        this.A01.getListener().AAF();
                    }
                } else if (serializableExtra instanceof C03167w) {
                    if (this.A01.getListener() != null) {
                        this.A01.getListener().A9l();
                    }
                    this.A02 = true;
                } else if (serializableExtra instanceof KU) {
                    if (this.A01.getListener() != null) {
                        MH listener2 = this.A01.getListener();
                        if (A04[5].length() != 15) {
                    ...
                    this.A02 = false;
                } else if ((serializableExtra instanceof C03157v) && this.A01.getListener() != null) {
