...
public class C02424r<T> implements InvocationHandler {
    ...
    public C02424r(T impl, ClassLoader classLoader) {
        this.A01 = impl;
    ...
    public static Object A00(ClassLoader classLoader, Method method) {
        ...
        return Proxy.newProxyInstance(classLoader, new Class[]{returnType}, new C02414q(classLoader));
    }
    ...
    public final Object invoke(Object obj, Method method, Object[] objArr) {
        try {
            ...
            if (th instanceof InvocationTargetException) {
                ...
                if (targetException instanceof C01671t) {
                    throw new IllegalStateException<>(targetException.getMessage());
                }
            }
            Object A002 = A00(this.A00, method);
            AdApiProxy.ProxyInvocationHandler<T> A003 = AnonymousClass8C.A00();
            if (A003 == null) {
                return A002;
            }
            A003.A04().A8V(A02(0, 3, 99), C03228e.A0D, new C03238f((Throwable) th));
            return A002;
        }
    }
}
