...
public final class MC extends View {
    ...
    public MC(XJ xj, int i, boolean z) {
        super(xj);
        this.A00 = i;
        this.A04 = z;
        if (z) {
    ...
    /* JADX INFO: Multiple debug info for r1v3 int: [D('innerRadius' int), D('startY' int)] */
    public final void onDraw(Canvas canvas) {
        if (this.A04) {
            ...
            int i4 = min / 3;
            int startY = min / 3;
            canvas.drawLine((float) i4, (float) startY, (float) (i4 * 2), (float) (startY * 2), this.A03);
            canvas.drawLine((float) (i4 * 2), (float) startY, (float) i4, (float) (startY * 2), this.A03);
        }
        super.onDraw(canvas);
    }
}
