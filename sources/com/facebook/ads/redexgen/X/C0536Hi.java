...
public final class C0536Hi implements AbstractC0738Pl {
    ...
    public C0536Hi(View view, int i, int i2, int i3) {
        this.A05 = view;
        this.A02 = i;
        this.A04 = i2;
        this.A03 = i3;
    ...
    private ValueAnimator A00(View view, int i, int i2) {
        ...
        ofInt.addUpdateListener(new C0747Pu(this, view));
        return ofInt;
    }
    ...
    public void A09(boolean z) {
        if (z) {
            ...
            this.A00.addListener(new C0746Pt(this));
            this.A00.start();
            return;
        }
    ...
    public void A0A(boolean z) {
        ...
        if (z) {
            ...
            this.A00.addListener(new C0745Ps(this));
            this.A00.start();
            return;
        }
        View view = this.A05;
