...
public final class C0419Cf {
    ...
    public final long A05(CH ch, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.A01 == 0) {
            if (!ch.ACp(this.A02, 0, 1, z)) {
                return -1;
            }
