...
public final class AnonymousClass21 extends AbstractC02013c {
    ...
    public final C0568Iq A0W = new C0568Iq(this.A0V);
    public final C0577Iz A0X;
    ...
    public AnonymousClass21(Context context, Dk dk, long j, @Nullable C0<C0967Yj> c0, boolean z, @Nullable Handler handler, @Nullable J0 j0, int i) {
        super(2, dk, c0, z);
        this.A0U = j;
        this.A0T = i;
        this.A0V = context.getApplicationContext();
        this.A0X = new C0577Iz(handler, j0);
        this.A0Y = A0N();
    ...
    public static int A00(C0437De de, Format format) {
        if (format.A09 == -1) {
            return A01(de, format.A0O, format.A0F, format.A08);
        }
    ...
    public static int A01(com.facebook.ads.redexgen.X.C0437De r11, java.lang.String r12, int r13, int r14) {
        /*
        // Method dump skipped, instructions count: 406
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass21.A01(com.facebook.ads.redexgen.X.De, java.lang.String, int, int):int");
    }

    /* JADX INFO: Multiple debug info for r8v1 int: [D('aspectRatio' float), D('longEdgePx' int)] */
    public static Point A02(C0437De de, Format format) throws C0444Dn {
        boolean z;
        int i;
        int i2;
        int i3;
        ...
        while (longEdgePx < length) {
            ...
            if (A0e[3].charAt(18) != 'r') {
                ...
                if (C0556Ic.A02 >= 21) {
                    ...
                    Point A0F2 = de.A0F(i4, i5);
                    if (de.A0I(A0F2.x, A0F2.y, (double) format.A01)) {
                        return A0F2;
                    }
                } else {
                    int A042 = C0556Ic.A04(i5, 16) * 16;
                    int A043 = C0556Ic.A04(i6, 16) * 16;
                    if (A042 * A043 <= C0446Dp.A00()) {
                        if (z) {
                            i3 = A043;
                        } else {
                            i3 = A042;
    ...
    private final MediaFormat A03(Format format, C0564Im im, boolean z, int i) {
        ...
        C0447Dq.A04(mediaFormat, A05(954, 10, 120), format.A01);
        C0447Dq.A05(mediaFormat, A05(1180, 16, 77), format.A0B);
        C0447Dq.A03(mediaFormat, format.A0J);
        mediaFormat.setInteger(A05(1079, 9, 16), im.A02);
        mediaFormat.setInteger(A05(1055, 10, 79), im.A00);
        C0447Dq.A05(mediaFormat, A05(1065, 14, 77), im.A01);
        if (C0556Ic.A02 >= 23) {
    ...
    /* JADX INFO: Multiple debug info for r10v0 com.facebook.ads.redexgen.X.De: [D('maxHeight' int), D('maxWidth' int)] */
    private final C0564Im A04(C0437De de, Format format, Format[] formatArr) throws C0444Dn {
        boolean z;
        int i = format.A0F;
        int i2 = format.A08;
        int A002 = A00(de, format);
        if (formatArr.length == 1) {
            return new C0564Im(i, i2, A002);
        }
        boolean z2 = false;
        for (Format format2 : formatArr) {
            if (A0W(de.A03, format, format2)) {
                ...
                A002 = Math.max(A002, A00(de, format2));
            }
        }
        if (z2) {
            ...
            Log.w(A053, sb2);
            Point A022 = A02(de, format);
            if (A022 != null) {
                i = Math.max(i, A022.x);
                i2 = Math.max(i2, A022.y);
                A002 = Math.max(A002, A01(de, format.A0O, i, i2));
    ...
    private void A06() {
        MediaCodec A1E;
        this.A0R = false;
        if (C0556Ic.A02 >= 23 && this.A0S && (A1E = A1E()) != null) {
            this.A00 = new C0565In(this, A1E);
        }
    }
        ...
        if (this.A08 != -1 || this.A06 != -1) {
            if (this.A0E != this.A08 || this.A0C != this.A06 || this.A0D != this.A07 || this.A03 != this.A01) {
                ...
                if (strArr[6].charAt(27) != strArr[4].charAt(27)) {
                    ...
                    iz.A01(this.A08, this.A06, this.A07, this.A01);
                    this.A0E = this.A08;
                    this.A0C = this.A06;
                    this.A0D = this.A07;
                    this.A03 = this.A01;
    ...
    public static void A0L(MediaFormat mediaFormat, int i) {
        mediaFormat.setFeatureEnabled(A05(1241, 17, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS), true);
        mediaFormat.setInteger(A05(859, 16, 95), i);
    }

    /* JADX INFO: Multiple debug info for r5v0 'this'  com.facebook.ads.redexgen.X.21: [D('state' int), D('codecInfo' com.facebook.ads.redexgen.X.De)] */
    private void A0M(Surface surface) throws A0 {
        if (surface == null) {
            if (this.A0N != null) {
                surface = this.A0N;
            } else {
        ...
        if (this.A0O != surface) {
            ...
            if (A7F == 1 || A7F == 2) {
                MediaCodec A1E = A1E();
                if (C0556Ic.A02 < 23 || A1E == null || surface == null || this.A0Q) {
                    A1I();
                    A1K();
                } else {
                    A0K(A1E, surface);
    ...
    public static boolean A0N() {
        if (C0556Ic.A02 <= 22) {
            if (A05(948, 6, 4).equals(C0556Ic.A03)) {
                if (A05(545, 6, 122).equals(C0556Ic.A05)) {
                    return true;
                }
            }
        }
    ...
    private final boolean A0T(MediaCodec mediaCodec, int i, long j, long j2) throws A0 {
        int A11 = A11(j2);
        if (A11 == 0) {
            return false;
        }
    ...
    private boolean A0U(C0437De de) {
        if (C0556Ic.A02 >= 23 && !this.A0S) {
            String str = de.A02;
            if (A0e[5].charAt(17) != 'd') {
                throw new RuntimeException();
            }
            ...
            return !A0V(str) && (!de.A05 || DummySurface.A05(this.A0V));
        }
    }
    ...
    private final boolean A0V(java.lang.String r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass21.A0V(java.lang.String):boolean");
    }
    ...
    public static boolean A0W(boolean z, Format format, Format format2) {
        if (format.A0O.equals(format2.A0O) && format.A0B == format2.A0B && (z || (format.A0F == format2.A0F && format.A08 == format2.A08))) {
            ...
            if (strArr[2].charAt(13) != strArr[0].charAt(13)) {
                ...
                if (C0556Ic.A0h(colorInfo, colorInfo2)) {
                    return true;
                }
            } else {
                throw new RuntimeException();
        ...
        if (this.A0M == -9223372036854775807L) {
            ...
            if (strArr[6].charAt(27) != strArr[4].charAt(27)) {
                ...
                if (i == this.A0Z.length) {
                    Log.w(A05(522, 23, 23), A05(776, 45, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE) + this.A0Z[this.A0A - 1]);
                } else {
                    this.A0A = i + 1;
                }
                long[] jArr = this.A0Z;
    ...
    public final int A1C(MediaCodec mediaCodec, C0437De de, Format format, Format format2) {
        if (!A0W(de.A03, format, format2) || format2.A0F > this.A0P.A02 || format2.A08 > this.A0P.A00 || A00(de, format2) > this.A0P.A01) {
            return 0;
        }
        if (format.A0L(format2)) {
            return 1;
        }
        return 3;
    }

    /* JADX INFO: Multiple debug info for r7v0 java.lang.String: [D('i' int), D('decoderInfo' com.facebook.ads.redexgen.X.De)] */
    @Override // com.facebook.ads.redexgen.X.AbstractC02013c
    public final int A1D(Dk dk, C0<C0967Yj> c0, Format format) throws C0444Dn {
        int i;
        int i2;
        ...
        if (strArr[2].charAt(13) != strArr[0].charAt(13)) {
            ...
            boolean z2 = true;
            if (A6E == null) {
                if (!z || dk.A6E(str, false) == null) {
                    return 1;
                }
                return 2;
            } else if (!EP.A0z(c0, drmInitData)) {
                return 2;
            } else {
                boolean A0J2 = A6E.A0J(format.A0K);
                if (A0J2 && format.A0F > 0 && format.A08 > 0) {
                    if (C0556Ic.A02 >= 21) {
                        ...
                        if (A0e[3].charAt(18) != 'r') {
                            ...
                            A0J2 = A6E.A0I(i4, i5, (double) format.A01);
                        } else {
                            throw new RuntimeException();
                        }
                    } else {
                        if (format.A0F * format.A08 > C0446Dp.A00()) {
                            z2 = false;
                        }
                        A0J2 = z2;
                        if (!A0J2) {
                            String str2 = A05(298, 29, 54) + format.A0F + A05(1379, 1, 65) + format.A08 + A05(856, 3, 97) + C0556Ic.A04 + A05(855, 1, 27);
                        }
                    }
                }
                if (A6E.A03) {
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC02013c
    @CallSuper
    public final void A1H() throws A0 {
        super.A1H();
        this.A04 = 0;
    }
    ...
    public final void A1M(android.media.MediaCodec r10, android.media.MediaFormat r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass21.A1M(android.media.MediaCodec, android.media.MediaFormat):void");
    }
    ...
    public final void A1O(YY yy) {
        this.A04++;
        this.A0K = Math.max(yy.A00, this.A0K);
        if (C0556Ic.A02 < 23 && this.A0S) {
            A1T();
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC02013c
    public final void A1P(C0437De de, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws C0444Dn {
        this.A0P = A04(de, format, A1B());
        ...
        if (this.A0O == null) {
            ...
            if (surface == null) {
                this.A0N = DummySurface.A01(this.A0V, de.A05);
            }
            this.A0O = this.A0N;
        }
        mediaCodec.configure(A032, this.A0O, mediaCrypto, 0);
        if (C0556Ic.A02 >= 23 && this.A0S) {
            this.A00 = new C0565In(this, mediaCodec);
        }
    }
    ...
    /* JADX INFO: Multiple debug info for r2v0 long: [D('unadjustedFrameReleaseTimeNs' long), D('earlyUs' long)] */
    @Override // com.facebook.ads.redexgen.X.AbstractC02013c
    public final boolean A1R(long unadjustedFrameReleaseTimeNs, long j, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i, int i2, long unadjustedFrameReleaseTimeNs2, boolean z) throws A0 {
        boolean z2;
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC02013c
    public final boolean A1S(C0437De de) {
        return this.A0O != null || A0U(de);
    }
    ...
    public final boolean A89() {
        Surface surface;
        if (super.A89() && (this.A0R || (((surface = this.A0N) != null && this.A0O == surface) || A1E() == null || this.A0S))) {
            this.A0J = -9223372036854775807L;
            if (A0e[5].charAt(17) != 'd') {
                throw new RuntimeException();
            }
