...
public final class C1085bG implements HI {
    ...
    public boolean A03;
    public final AbstractC0531Hd<? super C1085bG> A04;
    ...
    public C1085bG(AbstractC0531Hd<? super C1085bG> hd) {
        this.A04 = hd;
    }
    ...
    @Override // com.facebook.ads.redexgen.X.HI
    public final long ACC(HM hm) throws HP {
        long j;
        try {
            this.A01 = hm.A04;
            this.A02 = new RandomAccessFile(hm.A04.getPath(), A00(0, 1, 72));
            this.A02.seek(hm.A03);
            if (hm.A02 == -1) {
                j = this.A02.length() - hm.A03;
            } else {
                j = hm.A02;
            }
            this.A00 = j;
            if (this.A00 >= 0) {
                this.A03 = true;
                AbstractC0531Hd<? super C1085bG> hd = this.A04;
                if (hd != null) {
                    hd.ABs(this, hm);
                }
                long j2 = this.A00;
    ...
    @Override // com.facebook.ads.redexgen.X.HI
    public final void close() throws HP {
        this.A01 = null;
        try {
            if (this.A02 != null) {
                this.A02.close();
            ...
            if (this.A03) {
                this.A03 = false;
                AbstractC0531Hd<? super C1085bG> hd2 = this.A04;
                if (hd2 != null) {
                    hd2.ABr(this);
                }
            }
    ...
    @Override // com.facebook.ads.redexgen.X.HI
    public final int read(byte[] bArr, int i, int i2) throws HP {
        if (i2 == 0) {
            return 0;
        }
        long j = this.A00;
