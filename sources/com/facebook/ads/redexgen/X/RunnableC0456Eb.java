...
public final class RunnableC0456Eb implements Runnable {
    ...
    public final C0459Ee A05;
    public volatile int A06;
    public volatile AbstractC0463Ei A07;
    ...
    public RunnableC0456Eb(int i, C0459Ee ee, DownloadAction downloadAction, int i2) {
        this.A02 = i;
        this.A05 = ee;
    ...
    public /* synthetic */ RunnableC0456Eb(int i, C0459Ee ee, DownloadAction downloadAction, int i2, ET et) {
        this(i, ee, downloadAction, i2);
    }
    ...
    public final C0458Ed A0L() {
        return new C0458Ed(this.A02, this.A04, A01(), A00(), A05(), this.A01, null);
    }
    ...
    public final void run() {
        if (!KT.A02(this)) {
            try {
                    ...
                    if (this.A04.A03) {
                        ...
                        while (!Thread.interrupted()) {
                            try {
                                ...
                                long A6H = this.A07.A6H();
                                if (A6H != j) {
                                    C0459Ee.A0K(A07(22, 37, 92) + A6H, this);
                                    j = A6H;
                                    i = 0;
                                }
                                ...
                                C0459Ee.A0K(A07(0, 22, 20) + i, this);
                ...
                this.A05.A07.post(new EZ(this, th));
            } catch (Throwable th3) {
                KT.A00(th3, this);
            }
        }
