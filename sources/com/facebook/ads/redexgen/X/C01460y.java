...
public final class C01460y extends BroadcastReceiver {
    public static byte[] A04;
    public static String[] A05;
    public C0792Rn A00;
    public AbstractC01450x A01;
    public XJ A02;
    public String A03;
    ...
    public C01460y(XJ xj, String str, C0792Rn rn, AbstractC01450x r4) {
        this.A02 = xj;
        this.A03 = str;
        this.A01 = r4;
        this.A00 = rn;
    ...
    public final void A03() {
        ...
        AnonymousClass2K.A00(this.A02).A07(this, intentFilter);
    }

    public final void A04() {
        try {
            AnonymousClass2K.A00(this.A02).A06(this);
        } catch (Exception unused) {
        }
    }

    public final void onReceive(Context context, Intent intent) {
        String str = intent.getAction().split(A00(0, 1, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE))[0];
        if (this.A01 != null && str != null) {
            if (A00(98, 37, 60).equals(str)) {
                this.A01.AAN(this.A00, null, true);
                return;
            }
            ...
            if (equals) {
                ...
                this.A01.AAS(this.A00);
            } else if (A00(331, 35, 0).equals(str)) {
                if (J4.A1B(context)) {
                    this.A01.AAR(this.A00, AdError.AD_PRESENTATION_ERROR);
                } else {
                    this.A01.AAR(this.A00, AdError.INTERNAL_ERROR);
                }
            } else if (A00(1, 48, 12).equals(str)) {
                this.A01.onInterstitialActivityDestroyed();
            } else if (A00(543, 36, 52).equals(str)) {
                AbstractC01450x r3 = this.A01;
                String[] strArr = A05;
                ...
                this.A01.AAV();
            } else if (A00(616, 51, 125).equals(str)) {
                AbstractC01450x r32 = this.A01;
                if (A05[7].charAt(0) != 'P') {
                    throw new RuntimeException();
                }
