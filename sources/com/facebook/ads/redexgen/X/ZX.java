...
public final class ZX implements DM {
    ...
    public ZX(boolean z, String str) {
        this.A0D = new IL(new byte[7]);
        this.A0E = new IM(Arrays.copyOf(A0J, 10));
        A03();
        this.A0G = z;
        this.A0F = str;
    }

    private void A01() throws AJ {
        this.A0D.A08(0);
        if (!this.A0C) {
            ...
            this.A0D.A09(1);
            byte[] A082 = I1.A08(A052, A053, this.A0D.A05(3));
            Pair<Integer, Integer> A032 = I1.A03(A082);
    ...
    private void A08(CS cs, long j, int i, int i2) {
        this.A03 = 3;
        this.A00 = i;
        this.A07 = cs;
        this.A04 = j;
    ...
    /* JADX INFO: Multiple debug info for r9v0 com.facebook.ads.redexgen.X.IM: [D('data' int), D('position' int)] */
    private void A09(IM im) {
        boolean z;
        byte[] bArr = im.A00;
        int position = im.A07();
        int A082 = im.A08();
    ...
    private void A0A(IM im) {
        int min = Math.min(im.A05(), this.A02 - this.A00);
        this.A07.ADR(im, min);
        this.A00 += min;
        int i = this.A00;
        int i2 = this.A02;
        if (i == i2) {
            this.A07.ADS(this.A06, 1, i2, 0, null);
            this.A06 += this.A04;
            A03();
        }
    }

    private boolean A0B(IM im, byte[] bArr, int i) {
    ...
    public final void A49(IM im) throws AJ {
        ...
        while (im.A05() > 0) {
            ...
            if (i2 == 0) {
                ...
                if (strArr[5].charAt(25) != strArr[6].charAt(25)) {
                    ...
                    if (i2 == 2) {
                        ...
                        boolean A0B2 = A0B(im, this.A0D.A00, i);
                        if (A0I[0].charAt(1) == 'g') {
                            String[] strArr3 = A0I;
            ...
            } else if (A0B(im, this.A0E.A00, 10)) {
                A02();
            }
        }
    }
    ...
    public final void A4V(CI ci, C0433Da da) {
        da.A06();
        this.A0A = da.A05();
        this.A09 = ci.AEM(da.A04(), 1);
        if (this.A0G) {
            da.A06();
            this.A08 = ci.AEM(da.A04(), 4);
            this.A08.A5P(Format.A0B(da.A05(), A00(60, 15, 84), null, -1, null));
            return;
        }
        this.A08 = new C0975Yr();
    }
