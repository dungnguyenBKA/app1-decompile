...
public final class N7 extends ViewGroup {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int paddingLeft = getPaddingLeft();
        int i5 = 0;
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i2) - getPaddingTop()) - getPaddingBottom(), RecyclerView.UNDEFINED_DURATION);
        if (getChildCount() > 0) {
            i3 = 1;
        } else {
            i3 = 0;
        ...
        for (int i6 = 0; i6 < getChildCount(); i6++) {
            ...
            child.measure(View.MeasureSpec.makeMeasureSpec(i4, RecyclerView.UNDEFINED_DURATION), makeMeasureSpec);
