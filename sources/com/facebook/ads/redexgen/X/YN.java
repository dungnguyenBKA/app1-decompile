...
public final class YN implements AbstractC0393Az {
    public static String[] A08;
    public int A00 = -1;
    public int A01 = -1;
    public ByteBuffer A02 = AbstractC0393Az.A00;
    ...
    public final boolean A7z() {
        return this.A05 && this.A03 == AbstractC0393Az.A00;
    }
    ...
    /* JADX INFO: Multiple debug info for r0v14 int: [D('frameCount' int), D('channelIndex' int)] */
    @Override // com.facebook.ads.redexgen.X.AbstractC0393Az
    public final void ACi(ByteBuffer byteBuffer) {
        ...
        while (outputSize < limit) {
            for (int channelIndex : this.A06) {
                this.A02.putShort(byteBuffer.getShort((channelIndex * 2) + outputSize));
            }
