...
public final class AnonymousClass3G {
    ...
    public AnonymousClass3G(Object obj) {
        this.A00 = obj;
    }

    public static AnonymousClass3G A00(Object obj) {
        if (obj == null) {
            return null;
        }
        return new AnonymousClass3G(obj);
    }

    public static Object A01(AnonymousClass3G r0) {
        if (r0 == null) {
            return null;
        }
        return r0.A00;
    ...
    public final AnonymousClass3G A07(int i, int i2, int i3, int i4) {
        if (Build.VERSION.SDK_INT >= 20) {
            return new AnonymousClass3G(((WindowInsets) this.A00).replaceSystemWindowInsets(i, i2, i3, i4));
        }
        return null;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        AnonymousClass3G r5 = (AnonymousClass3G) obj;
