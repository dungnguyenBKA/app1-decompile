...
public class GI {
    ...
    public final List<GH> A06 = new ArrayList();
    ...
    private final SpannableString A00() {
        ...
        for (int nextPosition = 0; nextPosition < this.A06.size(); nextPosition++) {
            GH gh = this.A06.get(nextPosition);
            boolean z = gh.A02;
            int i4 = gh.A01;
            if (i4 != 8) {
                if (i4 == 7) {
    ...
    public final GB A06() {
        ...
        return new GB(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, (float) lineAnchor, 1, i2, f, i, Float.MIN_VALUE);
    }
    ...
    public final void A0F(int i, boolean z) {
        this.A06.add(new GH(i, z, this.A05.length()));
    }
