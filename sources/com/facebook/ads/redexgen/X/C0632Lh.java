...
public final class C0632Lh {
    ...
    public static final int A03 = AnonymousClass2L.A01(-16777216, 115);
    public static final int A04 = AnonymousClass2L.A01(-1, 0);
    ...
    public static int A02(int i) {
        if (A0f(i)) {
            return AnonymousClass2L.A02(i, -1, 0.4f);
        }
        return AnonymousClass2L.A02(i, -16777216, 0.2f);
    }
    ...
    /* JADX INFO: Multiple debug info for r0v7 double: [D('lines' int), D('charsInFirstLine' double)] */
    ...
    public static void A0I(int i, View view) {
        ...
        scaleAnimation.setAnimationListener(new C1168cd(view, scaleAnimation2));
        view.startAnimation(scaleAnimation);
    }
    ...
    public static void A0T(View view, int i, int i2, int i3) {
        ...
        A0X(view, gradientDrawable);
    }

    public static void A0U(View view, int i, int i2, int i3) {
        A0X(view, A0A(i, A02(i), i2, i3));
    }

    public static void A0V(View view, int i, float[] fArr) {
        A0X(view, A0B(i, fArr));
    }

    public static void A0W(View view, Context context) {
        GradientDrawable gradientDrawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{A04, A03});
    ...
    public static void A0Y(ViewGroup viewGroup) {
        if (Build.VERSION.SDK_INT > 19) {
            A0Z(viewGroup, HttpStatus.SC_OK);
        }
    }

    public static void A0Z(ViewGroup viewGroup, int i) {
        if (Build.VERSION.SDK_INT > 19) {
            A0b(viewGroup, new AutoTransition(), i);
        }
    }

    public static void A0a(ViewGroup viewGroup, Transition transition) {
        if (Build.VERSION.SDK_INT > 19) {
            A0b(viewGroup, transition, HttpStatus.SC_OK);
        }
    }

    @TargetApi(VungleException.NO_SPACE_TO_DOWNLOAD_ASSETS)
    public static void A0b(ViewGroup viewGroup, Transition transition, int i) {
    ...
    public static void A0d(@Nullable Toast toast, String str, int i, int i2, int i3) {
        if (toast != null) {
    ...
    public static void A0e(View... viewArr) {
    ...
    public static boolean A0f(int i) {
        return AnonymousClass2L.A00(i) < 0.5d;
    }
}
