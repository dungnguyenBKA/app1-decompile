...
public final class C0392Ay extends Exception {
    ...
    public C0392Ay(int i, int i2, int i3) {
        super(A00(27, 18, 12) + i + A00(0, 5, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT) + i2 + A00(5, 22, 87) + i3);
    }
}
