...
public final class C0689Nn extends LinearLayout {
    ...
    /* JADX INFO: Multiple debug info for r0v14 android.widget.LinearLayout$LayoutParams: [D('margin' int), D('dotImageParams' android.widget.LinearLayout$LayoutParams)] */
    public C0689Nn(XJ xj, AnonymousClass1I r11, int dotSize) {
        super(xj);
        setOrientation(0);
        setGravity(17);
        float f = C0632Lh.A01;
        ...
        this.A03 = AnonymousClass2L.A01(this.A04, 128);
        ...
        for (int i3 = 0; i3 < dotSize; i3++) {
            ...
            ImageView imageView = new ImageView(xj);
