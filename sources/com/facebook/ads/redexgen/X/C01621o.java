...
public final class C01621o {
    ...
    public static AdSettings.IntegrationErrorMode A00(XJ xj) {
        ...
        if (integrationErrorMode != AdSettings.IntegrationErrorMode.INTEGRATION_ERROR_CRASH_DEBUG_MODE || A03(xj)) {
    ...
    public static boolean A03(XJ xj) {
        return (xj.getApplicationInfo().flags & 2) != 0;
    }
}
