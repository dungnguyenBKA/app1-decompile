...
public final class D3 {
    ...
    public D3(boolean z, @Nullable String str, int i, byte[] bArr, int i2, int i3, @Nullable byte[] bArr2) {
        boolean z2;
        boolean z3 = true;
        if (i == 0) {
            z2 = true;
        ...
        C0551Hx.A03((bArr2 != null ? false : z3) ^ z2);
        this.A03 = z;
        this.A02 = str;
        this.A00 = i;
        this.A04 = bArr2;
        this.A01 = new CR(A00(str), bArr, i2, i3);
    }
