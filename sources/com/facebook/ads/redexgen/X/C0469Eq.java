...
public class C0469Eq extends ViewGroup implements AbstractC0822Ss {
    public static byte[] A18;
    public static String[] A19;
    public static final Interpolator A1A = new AnonymousClass47();
    ...
    public C02073i A01;
    public T8 A02;
    public RunnableC02203v A03;
    public AnonymousClass48 A04;
    public AnonymousClass4G A05;
    public AnonymousClass4K A06;
    public AnonymousClass4T A07;
    public RunnableC02264b A08;
    public TP A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public C01812h A0d;
    public AnonymousClass4B A0e;
    public AnonymousClass4E A0f;
    public AnonymousClass4N A0g;
    public AnonymousClass4O A0h;
    public AnonymousClass4P A0i;
    public RecyclerView$SavedState A0j;
    public Runnable A0k;
    public List<RecyclerView.OnChildAttachStateChangeListener> A0l;
    public List<AnonymousClass4P> A0m;
    public boolean A0n;
    public boolean A0o;
    public final Rect A0p;
    public final RectF A0q;
    public final AnonymousClass4S A0r;
    public final AnonymousClass4Z A0s;
    public final C02354k A0t;
    public final Runnable A0u;
    public final ArrayList<AnonymousClass4H> A0v;
    public final List<AbstractC02274c> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final TL A11;
    public final AbstractC02344j A12;
    public final ArrayList<AnonymousClass4O> A13;
    ...
    public C0469Eq(Context context) {
        this(context, null);
    }

    public C0469Eq(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C0469Eq(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        T8 t8;
        this.A11 = new TL(this);
        this.A0r = new AnonymousClass4S(this);
        this.A0t = new C02354k();
        this.A0u = new AnonymousClass45(this);
        this.A0p = new Rect();
        this.A0z = new Rect();
        this.A0q = new RectF();
        ...
        this.A0U = 0;
        this.A0N = 0;
        this.A05 = new C0472Et();
        this.A0W = 0;
        this.A0V = -1;
        this.A0L = Float.MIN_VALUE;
        this.A0M = Float.MIN_VALUE;
        this.A0o = true;
        this.A08 = new RunnableC02264b(this);
        if (A1E) {
            t8 = new T8();
        } else {
            t8 = null;
        ...
        this.A02 = t8;
        this.A0s = new AnonymousClass4Z();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new TI(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        this.A0k = new AnonymousClass46(this);
        this.A12 = new TF(this);
        ...
        this.A0L = AnonymousClass30.A00(viewConfiguration, context);
        this.A0M = AnonymousClass30.A01(viewConfiguration, context);
        ...
        setAccessibilityDelegateCompat(new TP(this));
    ...
    private final long A0C(AbstractC02274c r3) {
        return this.A04.A0C() ? r3.A0L() : (long) r3.A03;
    }

    /* JADX INFO: Multiple debug info for r1v2 com.facebook.ads.redexgen.X.4c: [D('i' int), D('limit' int)] */
    private View A0D() {
        int i;
        AbstractC02274c A0E2;
        if (this.A0s.A01 != -1) {
            i = this.A0s.A01;
        } else {
            i = 0;
    ...
    private final AbstractC02274c A0E(int i) {
        if (this.A0C) {
            return null;
        }
        int A072 = this.A01.A07();
        AbstractC02274c r1 = null;
        for (int i2 = 0; i2 < A072; i2++) {
            AbstractC02274c A0G2 = A0G(this.A01.A0B(i2));
    ...
    private final AbstractC02274c A0F(long j) {
        AnonymousClass48 r0 = this.A04;
        if (r0 == null || !r0.A0C()) {
            return null;
        }
        int A072 = this.A01.A07();
        AbstractC02274c r8 = null;
        for (int i = 0; i < A072; i++) {
            AbstractC02274c A0G2 = A0G(this.A01.A0B(i));
    ...
    public static AbstractC02274c A0G(View view) {
        if (view == null) {
            return null;
        }
        ...
        return ((AnonymousClass4L) layoutParams).A00;
    }

    private final AbstractC02274c A0H(View view) {
        View A1G2 = A1G(view);
        if (A1G2 == null) {
            return null;
        }
    ...
    public static C0469Eq A0I(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        boolean z = view instanceof C0469Eq;
        if (A19[5].charAt(2) != 'Y') {
            throw new RuntimeException();
        }
        ...
        for (int i = 0; i < childCount; i++) {
            C0469Eq descendant = A0I(parent.getChildAt(i));
            if (descendant != null) {
                return descendant;
            }
        }
    ...
    /* JADX INFO: Multiple debug info for r10v0 'this'  com.facebook.ads.redexgen.X.Eq: [D('didStructureChange' boolean), D('count' int)] */
    /* JADX INFO: Multiple debug info for r0v32 android.view.View: [D('child' android.view.View), D('animationInfo' com.facebook.ads.redexgen.X.4F)] */
    /* JADX WARNING: Removed duplicated region for block: B:53:0x01a3  */
    /* JADX WARNING: Removed duplicated region for block: B:79:0x0182 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void A0M() {
        /*
        // Method dump skipped, instructions count: 476
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.A0M():void");
    }
    ...
    private void A0N() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.A0N():void");
    }

    /* JADX INFO: Multiple debug info for r3v4 'i'  int: [D('i' int), D('holder' com.facebook.ads.redexgen.X.4c)] */
    /* JADX INFO: Multiple debug info for r0v30 long: [D('key' long), D('postInfo' com.facebook.ads.redexgen.X.4F)] */
    private void A0O() {
        this.A0s.A04(4);
        A1L();
        A1M();
        AnonymousClass4Z r0 = this.A0s;
        r0.A04 = 1;
        if (r0.A0C) {
            ...
            while (true) {
                ...
                AbstractC02274c A0G2 = A0G(this.A01.A0A(i));
                if (!A0G2.A0i()) {
                    long key = A0C(A0G2);
                    AnonymousClass4F A072 = this.A05.A07(this.A0s, A0G2);
                    AbstractC02274c A062 = this.A0t.A06(key);
                    if (A062 == null || A062.A0i()) {
                        ...
                        if (!A0I2 || A062 != A0G2) {
                            AnonymousClass4F A052 = this.A0t.A05(A062);
                            this.A0t.A0F(A0G2, A072);
                            AnonymousClass4F A042 = this.A0t.A04(A0G2);
                            if (A052 == null) {
                                A0o(key, A0G2, A062);
                            } else {
        ...
        AnonymousClass4Z r1 = this.A0s;
        r1.A05 = r1.A03;
        this.A0C = false;
        AnonymousClass4Z r02 = this.A0s;
        r02.A0C = false;
        r02.A0B = false;
        this.A06.A09 = false;
        if (this.A0r.A02 != null) {
            ArrayList<AbstractC02274c> arrayList = this.A0r.A02;
            String[] strArr = A19;
            if (strArr[3].length() != strArr[0].length()) {
    ...
    private void A0P() {
        this.A01 = new C02073i(new TG(this));
    }
    ...
    private void A0Q() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.A0Q():void");
    }

    /* JADX INFO: Multiple debug info for r7v0 'this'  com.facebook.ads.redexgen.X.Eq: [D('focusTarget' com.facebook.ads.redexgen.X.4c), D('focusedChild' android.view.View)] */
    private void A0R() {
        View findViewById;
    ...
    private final void A0Z() {
        ...
        for (int i = 0; i < A072; i++) {
            ...
            if (strArr[3].length() != strArr[0].length()) {
                ...
                AbstractC02274c A0G2 = A0G(r5.A0B(i));
                if (!A0G2.A0i()) {
                    A0G2.A0N();
                }
            } else {
    ...
    private final void A0b() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC02274c r3 = this.A0w.get(size);
            if (r3.A0H.getParent() == this && !r3.A0i() && (i = r3.A02) != -1) {
                AnonymousClass2z.A09(r3.A0H, i);
                r3.A02 = -1;
            }
        }
        this.A0w.clear();
    ...
    private final void A0i() {
        int A072 = this.A01.A07();
        for (int i = 0; i < A072; i++) {
            ((AnonymousClass4L) this.A01.A0B(i).getLayoutParams()).A01 = true;
        }
        this.A0r.A0N();
    }
    ...
    private void A0l(float f, float f2, float f3, float f4) {
        ...
        if (f2 < 0.0f) {
            A0d();
            AnonymousClass3Z.A00(this.A0a, (-f2) / ((float) getWidth()), 1.0f - (f3 / ((float) getHeight())));
            z = true;
        } else if (f2 > 0.0f) {
            A0e();
            AnonymousClass3Z.A00(this.A0b, f2 / ((float) getWidth()), f3 / ((float) getHeight()));
            z = true;
        }
        if (f4 < 0.0f) {
            A0f();
            AnonymousClass3Z.A00(this.A0c, (-f4) / ((float) getHeight()), f / ((float) getWidth()));
            z = true;
        } else if (f4 > 0.0f) {
            A0c();
            AnonymousClass3Z.A00(this.A0Z, f4 / ((float) getHeight()), 1.0f - (f / ((float) getWidth())));
            z = true;
        }
    ...
    private final void A0m(int i) {
        AnonymousClass4K r0 = this.A06;
        AnonymousClass4P r02 = this.A0i;
        if (r02 != null) {
            r02.A0N(this, i);
        }
        List<AnonymousClass4P> list = this.A0m;
        String[] strArr = A19;
        if (strArr[2].length() != strArr[7].length()) {
            String[] strArr2 = A19;
            strArr2[2] = "mB2qLC";
    ...
    private void A0o(long j, AbstractC02274c other, AbstractC02274c r10) {
        int A062 = this.A01.A06();
        for (int i = 0; i < A062; i++) {
            AbstractC02274c A0G2 = A0G(this.A01.A0A(i));
            if (A0G2 != other && A0C(A0G2) == j) {
                AnonymousClass48 r3 = this.A04;
        ...
        Log.e(A0J(1370, 12, 79), A0J(1202, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION, 90) + r10 + A0J(18, 41, 39) + other + A1J());
    }
    ...
    private void A0r(View view, View view2) {
        ...
        if (layoutParams instanceof AnonymousClass4L) {
            AnonymousClass4L r1 = (AnonymousClass4L) layoutParams;
            if (!r1.A01) {
                Rect rect = r1.A03;
    ...
    private void A0s(AnonymousClass48 r6, boolean z, boolean z2) {
        AnonymousClass48 r4 = this.A04;
        if (r4 != null) {
            TL tl = this.A11;
            String[] strArr = A19;
    ...
    private void A0t(AbstractC02274c r7) {
        boolean z;
        View view = r7.A0H;
    ...
    public static void A0u(AbstractC02274c r4) {
        if (r4.A09 != null) {
            WeakReference<C0469Eq> weakReference = r4.A09;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            C0469Eq eq = weakReference.get();
            while (eq != null) {
                if (eq != r4.A0H) {
                    ViewParent parent = eq.getParent();
    ...
    private void A0v(AbstractC02274c r3, AbstractC02274c r4, AnonymousClass4F r5, AnonymousClass4F r6, boolean z, boolean z2) {
        r3.A0a(false);
        if (z) {
            A0t(r3);
        }
    ...
    private void A0z(int[] iArr) {
        ...
        for (int i2 = 0; i2 < minPositionPreLayout; i2++) {
            AbstractC02274c A0G2 = A0G(this.A01.A0A(i2));
            if (!A0G2.A0i()) {
                int A0J2 = A0G2.A0J();
                if (A0J2 < pos) {
                    pos = A0J2;
    ...
    private final boolean A15(int unconsumedY, int consumedX, MotionEvent motionEvent) {
        ...
        if (this.A04 != null) {
            A1L();
            A1M();
            AnonymousClass2M.A01(A0J(1361, 9, 75));
            A1m(this.A0s);
            if (unconsumedY != 0) {
        ...
        if (A1y(i3, i4, i, i2, this.A17, 0)) {
            ...
            if (motionEvent != null && !C01792f.A00(motionEvent, 8194)) {
    ...
    private boolean A16(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < size; i++) {
            AnonymousClass4O r1 = this.A13.get(i);
    ...
    private final boolean A1A(AccessibilityEvent accessibilityEvent) {
        ...
        if (accessibilityEvent != null) {
            i = AnonymousClass3I.A00(accessibilityEvent);
        }
        if (i == 0) {
            i = 0;
        }
    ...
    public final int A1E(AbstractC02274c r5) {
        if (!r5.A0l(524) && r5.A0b()) {
    ...
    public final android.graphics.Rect A1F(android.view.View r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.A1F(android.view.View):android.graphics.Rect");
    }
    ...
    public final AbstractC02274c A1H(int i, boolean z) {
        int A072 = this.A01.A07();
        AbstractC02274c r1 = null;
        for (int i2 = 0; i2 < A072; i2++) {
            AbstractC02274c A0G2 = A0G(this.A01.A0B(i2));
    ...
    public final AbstractC02274c A1I(View view) {
        ViewParent parent = view.getParent();
    ...
    public final void A1K() {
        ...
        if (!z || this.A0C) {
            ...
            if (this.A00.A0M(4)) {
                ...
                if (!A0M2) {
                    AnonymousClass2M.A01(A0J(1341, 20, 82));
                    A1L();
                    A1M();
                    this.A00.A0I();
                    if (!this.A0J) {
    ...
    public final void A1O() {
        if (!this.A0K && this.A0F) {
            AnonymousClass2z.A0C(this, this.A0k);
            this.A0K = true;
        }
    }

    public final void A1P() {
        AnonymousClass4G r0 = this.A05;
        if (r0 != null) {
            r0.A0C();
        }
        AnonymousClass4K r1 = this.A06;
    ...
    public final void A1b(int i, int i2) {
        setMeasuredDimension(AnonymousClass4K.A00(i, getPaddingLeft() + getPaddingRight(), AnonymousClass2z.A03(this)), AnonymousClass4K.A00(i2, getPaddingTop() + getPaddingBottom(), AnonymousClass2z.A02(this)));
    }
    ...
    public final void A1c(int scrollY, int i) {
        ...
        AnonymousClass4P r0 = this.A0i;
        if (r0 != null) {
            r0.A0O(this, scrollY, i);
        }
        List<AnonymousClass4P> list = this.A0m;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.A0m.get(size).A0O(this, scrollY, i);
            }
        }
        this.A0N--;
    }
    ...
    public final void A1d(int i, int i2) {
        ...
        for (int i3 = 0; i3 < A072; i3++) {
            AbstractC02274c A0G2 = A0G(this.A01.A0B(i3));
            if (A0G2 != null && !A0G2.A0i()) {
                int i4 = A0G2.A03;
                if (A19[5].charAt(2) != 'Y') {
                    throw new RuntimeException();
    ...
    public final void A1e(int r12, int r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.A1e(int, int):void");
    }
        ...
        for (int i3 = 0; i3 < A072; i3++) {
            ...
            if (A0G2 != null && !A0G2.A0i()) {
                ...
                if (i4 >= positionEnd && A0G2.A03 < i2) {
                    A0G2.A0U(2);
                    A0G2.A0Z(obj);
                    ((AnonymousClass4L) A0B2.getLayoutParams()).A01 = true;
                }
            }
        }
    ...
    public final void A1k(AnonymousClass4P r2) {
        if (this.A0m == null) {
    ...
    public final void A1l(AnonymousClass4P r2) {
        List<AnonymousClass4P> list = this.A0m;
        if (list != null) {
            list.remove(r2);
        }
    ...
    public final void A1m(AnonymousClass4Z r4) {
        if (getScrollState() == 2) {
    ...
    public final void A1n(AbstractC02274c r4, AnonymousClass4F r5) {
        r4.A0V(0, 8192);
    ...
    public final void A1o(AbstractC02274c r2, AnonymousClass4F r3, AnonymousClass4F r4) {
        r2.A0a(false);
    ...
    public final void A1p(AbstractC02274c r2, AnonymousClass4F r3, AnonymousClass4F r4) {
        A0t(r2);
        r2.A0a(false);
    ...
    public final boolean A1u() {
        if (!this.A0D || this.A0C || this.A00.A0K()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean A21(AbstractC02274c r3) {
        AnonymousClass4G r1 = this.A05;
        return r1 == null || r1.A0G(r3, r3.A0M());
    }

    public final boolean A22(AbstractC02274c r2, int i) {
        if (A1v()) {
            r2.A02 = i;
            this.A0w.add(r2);
            return false;
        }
        AnonymousClass2z.A09(r2.A0H, i);
        return true;
    }
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof AnonymousClass4L) && this.A06.A1d((AnonymousClass4L) layoutParams);
    }
    ...
    public final void draw(android.graphics.Canvas r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.draw(android.graphics.Canvas):void");
    }
    ...
    public final android.view.View focusSearch(android.view.View r9, int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        AnonymousClass4K r0 = this.A06;
        if (r0 != null) {
            AnonymousClass4L A0x2 = r0.A0x(layoutParams);
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    public AnonymousClass48 getAdapter() {
        return this.A04;
    }
    ...
    public TP getCompatAccessibilityDelegate() {
        return this.A09;
    }

    public AnonymousClass4G getItemAnimator() {
        return this.A05;
    }

    public AnonymousClass4K getLayoutManager() {
        return this.A06;
    }
    ...
    public AnonymousClass4N getOnFlingListener() {
        return this.A0g;
    }
    ...
    public AnonymousClass4R getRecycledViewPool() {
        return this.A0r.A0I();
    }
    ...
    private C01812h getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C01812h(this);
        }
        return this.A0d;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.A0K = false;
        if (A1E) {
            this.A03 = RunnableC02203v.A07.get();
            if (this.A03 == null) {
                this.A03 = new RunnableC02203v();
                Display A042 = AnonymousClass2z.A04(this);
                float f = 60.0f;
                ...
                RunnableC02203v.A07.set(this.A03);
            }
            this.A03.A0A(this);
        }
    }
    ...
    /* JADX INFO: Multiple debug info for r6v0 'this'  com.facebook.ads.redexgen.X.Eq: [D('axisScroll' float), D('vScroll' float)] */
    ...
    public final boolean onGenericMotionEvent(android.view.MotionEvent r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.onGenericMotionEvent(android.view.MotionEvent):boolean");
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        AnonymousClass2M.A01(A0J(1330, 11, 86));
        A0a();
        AnonymousClass2M.A00();
        this.A0D = true;
    }
    ...
    public void onMeasure(int r7, int r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0469Eq.onMeasure(int, int):void");
    }
    ...
    /* JADX INFO: Multiple debug info for r0v54 int[]: [D('index' int), D('x' int)] */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            this.A0V = motionEvent.getPointerId(0);
            int index4 = (int) (motionEvent.getX() + 0.5f);
            this.A0S = index4;
            this.A0Q = index4;
            int index5 = (int) (motionEvent.getY() + 0.5f);
            this.A0T = index5;
            this.A0R = index5;
            int index6 = 0;
            if (A25) {
            ...
            z = true;
            this.A0Y.computeCurrentVelocity(AdError.NETWORK_ERROR_CODE, (float) this.A0x);
            if (A25) {
                VelocityTracker velocityTracker = this.A0Y;
                int dy = this.A0V;
                String[] strArr3 = A19;
            ...
            if (this.A0W != 1) {
                boolean z2 = false;
                if (A25 && Math.abs(i3) > (index3 = this.A0X)) {
                    if (i3 > 0) {
                        i3 -= index3;
                    } else {
                        i3 += index3;
                ...
                if (A26 && Math.abs(dx) > (index2 = this.A0X)) {
                    if (dx > 0) {
                        dx -= index2;
                    } else {
                        dx += index2;
    ...
    public void setAccessibilityDelegateCompat(TP tp) {
        this.A09 = tp;
        AnonymousClass2z.A0A(this, this.A09);
    }

    public void setAdapter(AnonymousClass48 r3) {
        setLayoutFrozen(false);
        A0s(r3, false, true);
        requestLayout();
    }

    public void setChildDrawingOrderCallback(AnonymousClass4B r2) {
        boolean z;
        if (r2 != this.A0e) {
            this.A0e = r2;
            if (this.A0e != null) {
    ...
    public void setItemAnimator(AnonymousClass4G r6) {
        AnonymousClass4G r0 = this.A05;
        if (r0 != null) {
            r0.A0C();
            this.A05.A0A(null);
        ...
        this.A05 = r6;
        AnonymousClass4G r4 = this.A05;
        if (r4 != null) {
            AnonymousClass4E r3 = this.A0f;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    public void setLayoutManager(AnonymousClass4K r5) {
        if (r5 != this.A06) {
            A1S();
            if (this.A06 != null) {
                AnonymousClass4G r0 = this.A05;
            ...
            if (r5 != null) {
                ...
                if (eq == null) {
                    ...
                    throw new IllegalArgumentException(A0J(1109, 14, 88) + r5 + A0J(59, 39, 9) + r5.A03.A1J());
                }
            }
            this.A0r.A0P();
            requestLayout();
    ...
    public void setOnFlingListener(AnonymousClass4N r1) {
        this.A0g = r1;
    }

    public void setOnScrollListener(AnonymousClass4P r1) {
        this.A0i = r1;
    }
    ...
    public void setRecycledViewPool(AnonymousClass4R r2) {
        this.A0r.A0a(r2);
    }

    public void setRecyclerListener(AnonymousClass4T r1) {
        this.A07 = r1;
    }
    ...
    public void setViewCacheExtension(AbstractC02254a r2) {
        this.A0r.A0b(r2);
    }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC01802g
