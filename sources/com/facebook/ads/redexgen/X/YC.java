...
public final class YC implements AbstractC0369Aa {
    public static byte[] A04;
    public final int A00;
    public final long A01;
    public final Context A02;
    @Nullable
    public final C0<C0967Yj> A03;
    ...
    @Deprecated
    public YC(Context context, @Nullable C0<C0967Yj> c0, int i, long j) {
        this.A02 = context;
        this.A00 = i;
        this.A01 = j;
        this.A03 = c0;
    ...
    private final void A02(android.content.Context r19, @androidx.annotation.Nullable com.facebook.ads.redexgen.X.C0<com.facebook.ads.redexgen.X.C0967Yj> r20, long r21, android.os.Handler r23, com.facebook.ads.redexgen.X.J0 r24, int r25, java.util.ArrayList<com.facebook.ads.redexgen.X.YH> r26) {
        /*
        // Method dump skipped, instructions count: 161
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.YC.A02(android.content.Context, com.facebook.ads.redexgen.X.C0, long, android.os.Handler, com.facebook.ads.redexgen.X.J0, int, java.util.ArrayList):void");
    }

    /* JADX INFO: Multiple debug info for r0v35 com.facebook.ads.redexgen.X.YH: [D('constructor' java.lang.reflect.Constructor<?>), D('extensionRendererIndex' int)] */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final void A03(android.content.Context r15, @androidx.annotation.Nullable com.facebook.ads.redexgen.X.C0<com.facebook.ads.redexgen.X.C0967Yj> r16, com.facebook.ads.redexgen.X.AbstractC0393Az[] r17, android.os.Handler r18, com.facebook.ads.redexgen.X.B7 r19, int r20, java.util.ArrayList<com.facebook.ads.redexgen.X.YH> r21) {
        /*
        // Method dump skipped, instructions count: 304
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.YC.A03(android.content.Context, com.facebook.ads.redexgen.X.C0, com.facebook.ads.redexgen.X.Az[], android.os.Handler, com.facebook.ads.redexgen.X.B7, int, java.util.ArrayList):void");
    }

    private final void A04(Context context, AbstractC0452Dx dx, Looper looper, int i, ArrayList<YH> arrayList) {
        arrayList.add(new C02003b(dx, looper));
    }

    private final void A05(Context context, GF gf, Looper looper, int i, ArrayList<YH> arrayList) {
        arrayList.add(new AnonymousClass3X(gf, looper));
    }

    private final AbstractC0393Az[] A06() {
        return new AbstractC0393Az[0];
    }

    /* JADX INFO: Multiple debug info for r11v0 java.util.ArrayList<com.facebook.ads.redexgen.X.YH>: [D('renderersList' java.util.ArrayList<com.facebook.ads.internal.exoplayer2.Renderer>), D('drmSessionManager' com.facebook.ads.internal.exoplayer2.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.drm.FrameworkMediaCrypto>)] */
    @Override // com.facebook.ads.redexgen.X.AbstractC0369Aa
    public final YH[] A4R(Handler handler, J0 j0, B7 b7, GF gf, AbstractC0452Dx dx, @Nullable C0<C0967Yj> c0) {
        C0<C0967Yj> c02 = c0;
        if (c02 == null) {
            c02 = this.A03;
        }
        DrmSessionManager<FrameworkMediaCrypto> drmSessionManager = new ArrayList<>();
        A02(this.A02, c02, this.A01, handler, j0, this.A00, drmSessionManager);
        A03(this.A02, c02, A06(), handler, b7, this.A00, drmSessionManager);
        A05(this.A02, gf, handler.getLooper(), this.A00, drmSessionManager);
        A04(this.A02, dx, handler.getLooper(), this.A00, drmSessionManager);
        return (YH[]) drmSessionManager.toArray(new YH[drmSessionManager.size()]);
    }
}
