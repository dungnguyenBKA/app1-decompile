...
public final class AnonymousClass5D implements NativeAdScrollViewApi {
    ...
    public AnonymousClass5D(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, @Nullable NativeAdScrollView.AdViewProvider adViewProvider, int i, @Nullable NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2) {
        if (!nativeAdsManager.isLoaded()) {
            ...
            this.A06 = AnonymousClass56.A02(context);
            this.A04 = nativeAdsManager;
            this.A03 = nativeAdViewAttributes;
            this.A01 = adViewProvider;
            this.A02 = type;
            this.A00 = i2;
            C0838Tj tj = new C0838Tj(this);
            this.A05 = new C0839Tk(context);
            if (this.A02 != null) {
                C0839Tk.A02(this.A05, (int) (C0632Lh.A01 * ((float) this.A02.getHeight())));
            } else if (i > 0) {
                C0839Tk.A02(this.A05, ((int) C0632Lh.A01) * i);
            }
            this.A05.setAdapter(tj);
            setInset(20);
            tj.A0D();
