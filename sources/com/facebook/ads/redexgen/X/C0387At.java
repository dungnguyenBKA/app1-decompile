...
public final class C0387At extends PD {
    public static byte[] A0E;
    public static final String A0F = C0387At.class.getSimpleName();
    @Nullable
    public Uri A00;
    @Nullable
    public NativeAd A01;
    ...
    public final XJ A09;
    public final AbstractC0629Le A0A = new C0388Au(this);
    public final KW A0B = new C0389Av(this);
    public final KQ A0C = new C0390Aw(this);
    ...
    public C0387At(XJ xj) {
        super(xj);
        this.A08 = new AnonymousClass14(this, xj);
        this.A09 = xj;
        A02();
    }

    public C0387At(XJ xj, AttributeSet attributeSet) {
    ...
    public C0387At(XJ xj, AttributeSet attributeSet, int i) {
    ...
    private void A04(Intent intent) {
        if (this.A04 == null) {
            ...
            intent.putExtra(A01(322, 8, 34), KK.A05);
    ...
    private void A05(String str) {
        AbstractC03218d A042 = this.A09.A04();
        int i = C03228e.A1q;
        String defaultErrorMessage = AdErrorType.PARSER_FAILURE.getDefaultErrorMessage();
        A042.A8V(A01(198, 7, 120), i, new C03238f(defaultErrorMessage, A01(90, 7, 93) + str));
    ...
    public final void A0j() {
        AdActivityIntent A042 = C0616Kp.A04(this.A09);
        A04(A042);
        try {
            A0b(false, 6);
            setVisibility(8);
            C0616Kp.A0A(this.A09, A042);
        } catch (Exception e) {
            this.A09.A04().A8V(A01(176, 11, 126), C03228e.A05, new C03238f(e));
            Log.e(A01(97, 17, 22), A01(0, 90, 38), e);
        }
    }

    @Nullable
    public MH getListener() {
        return this.A03;
    }
    ...
    public void setAdEventManager(JC jc) {
        this.A02 = jc;
    }

    public void setClientToken(@Nullable String str) {
        C03177y r0;
        C03177y r02 = this.A04;
        if (r02 != null) {
            r02.A0h();
        }
        this.A05 = str;
        if (str != null) {
            r0 = new C03177y(this.A09, this.A02, this, str);
        } else {
            r0 = null;
        }
        this.A04 = r0;
    ...
    public void setListener(@Nullable MH mh) {
        this.A03 = mh;
    }
