...
public final class C0625La {
    public static byte[] A0I;
    public static String[] A0J;
    public static final String A0K = C0625La.class.getSimpleName();
    ...
    private LF A00() {
        ...
        Object tag = this.A0G.getTag(LF.A02);
        if (tag == null) {
            return LF.A0H;
        }
    ...
    public final Map<String, String> A05() {
        ...
        if (j2 > 0) {
            ...
            if (j3 > j2) {
                ...
                hashMap.put(A01(20, 11, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE), String.valueOf(this.A04));
                ...
                hashMap.put(A01(180, 6, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), String.valueOf(this.A0B));
                hashMap.put(A01(56, 6, 117), String.valueOf(this.A07));
                hashMap.put(A01(62, 6, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS), String.valueOf(this.A08));
        ...
        hashMap2.put(A01(20, 11, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE), String.valueOf(this.A04));
        ...
        hashMap2.put(A01(180, 6, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), String.valueOf(this.A0B));
        hashMap2.put(A01(56, 6, 117), String.valueOf(this.A07));
        hashMap2.put(A01(62, 6, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS), String.valueOf(this.A08));
    ...
    /* JADX INFO: Multiple debug info for r7v0 'this'  com.facebook.ads.redexgen.X.La: [D('touchEndXInPx' int), D('touchDevice' android.view.InputDevice), D('touchStartXInPx' int)] */
    public final void A07(MotionEvent motionEvent, View view, View view2) {
        ...
        if (action != 0) {
            ...
            this.A07 = (int) (((float) ((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0])) / C0632Lh.A01);
            this.A08 = (int) (((float) ((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1])) / C0632Lh.A01);
            this.A0F = view2;
            return;
        }
        this.A04 = (int) (((float) iArr[0]) / C0632Lh.A01);
        this.A05 = (int) (((float) iArr[1]) / C0632Lh.A01);
        this.A06 = (int) (((float) view.getWidth()) / C0632Lh.A01);
        this.A03 = (int) (((float) view.getHeight()) / C0632Lh.A01);
        this.A09 = 1;
        this.A0E = System.currentTimeMillis();
        this.A0A = (int) (((float) ((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0])) / C0632Lh.A01);
        this.A0B = (int) (((float) ((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1])) / C0632Lh.A01);
    ...
    public final boolean A0A(Context context) {
        ...
        if (BuildConfigApi.isDebug()) {
            String str = A01(FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS, 21, 116) + z + A01(2, 18, 43) + A052 + A01(0, 2, 119) + A042;
        }
        return z;
    }
}
