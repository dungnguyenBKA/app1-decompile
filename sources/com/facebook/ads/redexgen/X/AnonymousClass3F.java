...
public final class AnonymousClass3F {
    public static final AnonymousClass3E A00;
    ...
    static {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            A00 = new AnonymousClass3E();
        }
    }

    public static void A00(ViewParent viewParent, View view, int i) {
        if (viewParent instanceof AbstractC0823St) {
            throw null;
        } else if (i == 0) {
    ...
    public static boolean A06(ViewParent viewParent, View view, View view2, int i, int i2) {
        if (viewParent instanceof AbstractC0823St) {
            return ((AbstractC0823St) viewParent).onStartNestedScroll(view, view2, i, i2);
        }
        if (i2 == 0) {
