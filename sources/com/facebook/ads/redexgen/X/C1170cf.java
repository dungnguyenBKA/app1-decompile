...
public final class C1170cf implements AbstractC0638Ln {
    ...
    /* JADX INFO: Multiple debug info for r42v0 int[]: [D('wm' int), D('minX' int), D('stack_start' int)] */
    /* JADX INFO: Multiple debug info for r40v0 int: [D('i' int), D('sp' int)] */
    /* JADX INFO: Multiple debug info for r39v0 int: [D('y' int), D('sp' int), D('src_i' int)] */
    /* JADX INFO: Multiple debug info for r25v1 int: [D('xp' int), D('src_i' int)] */
    /* JADX INFO: Multiple debug info for r29v0 short: [D('dst_i' int), D('src_i' int)] */
    /* JADX INFO: Multiple debug info for r38v2 int: [D('sum_in_b' long), D('sum_out_r' long)] */
    /* JADX INFO: Multiple debug info for r38v6 int: [D('maxY' int), D('sum_out_r' long)] */
    /* JADX INFO: Multiple debug info for r11v7 long: [D('sum_out_b' long), D('sum_in_r' long)] */
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x02e1, code lost:
        if (r3 >= r25) goto L_0x02e3;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:72:0x0373, code lost:
        if (r3 >= r25) goto L_0x02e3;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void A01(int[] r42, int r43, int r44, int r45, int r46, int r47, int r48) {
        /*
        // Method dump skipped, instructions count: 892
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1170cf.A01(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A03(Bitmap bitmap, float f) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                arrayList.add(new CallableC0642Lr(currentPixels, cores, height, (int) f, i, i2, 1));
                height = height;
                arrayList2.add(new CallableC0642Lr(currentPixels, cores, height, (int) f, i, i2, 2));
            }
            try {
                C0643Ls.A01.invokeAll(arrayList);
                try {
                    C0643Ls.A01.invokeAll(arrayList2);
                    try {
