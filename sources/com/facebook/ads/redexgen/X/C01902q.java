...
public final class C01902q extends C3 {
    public static byte[] A07;
    public static final int A08 = C0556Ic.A08(A00(69, 4, 19));
    public static final int A09 = C0556Ic.A08(A00(73, 4, 85));
    public float A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public C01902q(List<byte[]> list) {
        super(A00(5, 11, 11));
        A07(list);
    }

    public static String A01(IM im) throws GD {
        boolean z;
        char A032;
        if (im.A05() >= 2) {
            z = true;
        ...
        if (im.A05() < 2 || ((A032 = im.A03()) != 65279 && A032 != 65534)) {
            return im.A0U(A0J, Charset.forName(A00(22, 5, 101)));
        }
        return im.A0U(A0J, Charset.forName(A00(16, 6, 83)));
    }
    ...
    private void A06(IM im, SpannableStringBuilder spannableStringBuilder) throws GD {
        boolean z;
        if (im.A05() >= 12) {
            z = true;
        } else {
    ...
    private void A07(List<byte[]> list) {
        ...
        if (list != null && list.size() == 1 && (list.get(0).length == 48 || list.get(0).length == 53)) {
            ...
            if (A00(0, 5, 16).equals(C0556Ic.A0R(bArr, 43, bArr.length - 43))) {
                A002 = A00(64, 5, 27);
            }
            this.A04 = A002;
            this.A01 = bArr[25] * 20;
            ...
            this.A05 = z;
            if (this.A05) {
                this.A00 = ((float) (((bArr[10] & 255) << 8) | (bArr[11] & 255))) / ((float) this.A01);
                this.A00 = C0556Ic.A00(this.A00, 0.0f, 0.95f);
                return;
            }
            this.A00 = 0.85f;
            return;
    ...
    public static void A08(boolean z) throws GD {
        if (!z) {
            throw new GD(A00(27, 27, 13));
        }
    }

    /* JADX INFO: Multiple debug info for r0v17 int: [D('requestedVerticalPlacement' int), D('styleRecordCount' int)] */
    ...
    public final GC A0d(byte[] bArr, int i, boolean z) throws GD {
        ...
        while (this.A06.A05() >= 8) {
            ...
            if (A093 == A08) {
                ...
                A08(z2);
                verticalPlacement = C0556Ic.A00(((float) this.A06.A0J()) / ((float) this.A01), 0.0f, 0.95f);
            }
            this.A06.A0Z(A072 + A092);
        }
        return new C1065aw(new GB(spannableStringBuilder, null, verticalPlacement, 0, 0, Float.MIN_VALUE, RecyclerView.UNDEFINED_DURATION, Float.MIN_VALUE));
    }
}
