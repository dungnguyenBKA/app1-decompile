...
public final class C0991Zh implements AbstractC0434Db {
    ...
    public boolean A09;
    public final DM A0A;
    public final IL A0B = new IL(new byte[10]);
    ...
    private boolean A06(IM im, byte[] bArr, int i) {
    ...
    public final void A4A(IM im, boolean z) throws AJ {
        if (z) {
            int i = this.A03;
            if (!(i == 0 || i == 1)) {
        ...
        while (im.A05() > 0) {
            ...
            if (i2 != 0) {
                ...
                if (i2 != 1) {
                    if (i2 == 2) {
                        if (A06(im, this.A0B.A00, Math.min(10, this.A01)) && A06(im, null, this.A01)) {
                            A01();
                            this.A0A.ACJ(this.A04, this.A06);
                            A04(3);
                        }
                    } else if (i2 != 3) {
                        continue;
