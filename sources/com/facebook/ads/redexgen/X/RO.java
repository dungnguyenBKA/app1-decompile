...
public final class RO implements AnonymousClass03<Bitmap> {
    public static byte[] A06;
    public static String[] A07;
    public final int A00;
    public final int A01;
    public final String A02 = RO.class.getSimpleName();
    ...
    public RO(int i, int i2, boolean z, boolean z2, boolean z3) {
        this.A01 = i;
        this.A00 = i2;
        this.A05 = z;
        this.A03 = z2;
                ...
                if (updatedCacheFileOS.size() < 3145728) {
                    ...
                    while (true) {
                        ...
                        if (read > 0) {
                            ...
                            file2.delete();
                            AnonymousClass0M.A07(updatedCacheFileOS);
                            AnonymousClass0M.A07(fileOutputStream);
                            AnonymousClass0M.A07(fileInputStream);
                            AnonymousClass0M.A07(fileOutputStream2);
                            return;
                        }
                    }
                }
    ...
    public final AnonymousClass02<Bitmap> A3E(File file, AnonymousClass0L r8) {
        if (!this.A04) {
            return new AnonymousClass02<>(true, null);
        }
        try {
            Bitmap A032 = AnonymousClass0M.A03(file.getCanonicalPath(), this.A01, this.A00, this.A05);
            if (A032 != null) {
                return new AnonymousClass02<>(true, A032);
            }
            r8.A8O(new RU(A01(4, 14, 77)));
            return A00(null);
        } catch (Throwable th) {
            if (A07[6].length() != 26) {
                String[] strArr = A07;
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass03
    @SuppressLint({"CatchGeneralException"})
    public final void A4C(File file, AnonymousClass0L r6) throws RU {
        if (this.A03) {
            try {
                Bitmap A032 = AnonymousClass0M.A03(file.getCanonicalPath(), this.A01, this.A00, this.A05);
                if (A032 != null) {
