...
public final class AnonymousClass9S {
    ...
    public AnonymousClass9S(File file) {
        this.A00 = file;
    }

    public static AnonymousClass9S A00(String str, Context context) throws IOException {
        File file = new File(context.getFilesDir(), A01(64, 9, 55));
        A03(file);
        File file2 = new File(file, str);
        A03(file2);
        return new AnonymousClass9S(file2);
    }

    public static void A03(File file) throws IOException {
        if (!file.exists() && !file.mkdir()) {
            throw new AnonymousClass9T(String.format(Locale.US, A01(33, 31, 27), file.getCanonicalPath()));
        } else if (!file.isDirectory()) {
            throw new AnonymousClass9T(String.format(Locale.US, A01(0, 33, 58), file.getCanonicalPath()));
        }
    }

    public final AnonymousClass9S A04(String str) throws IOException {
        File file = new File(this.A00, str);
        A03(file);
        return new AnonymousClass9S(file);
    }
