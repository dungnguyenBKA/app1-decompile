...
public final class C0489Fm extends AbstractC0783Re {
    public static byte[] A02;
    public static String[] A03;
    public static final String A04 = C0489Fm.class.getSimpleName();
    ...
    public C0489Fm(XJ xj, JC jc, String str, Uri uri, Map<String, String> map, C01340m r12, boolean z) {
        super(xj, jc, str, r12, z);
        this.A00 = uri;
        this.A01 = map;
    }

    private Intent A00(C01320k r8) {
        if (TextUtils.isEmpty(r8.A06()) || !C01310j.A05(((AbstractC01270f) this).A00, r8.A06())) {
            return null;
        }
        String A042 = r8.A04();
        if (TextUtils.isEmpty(A042) || (!A042.startsWith(A03(250, 4, 23)) && !A042.startsWith(A03(254, 10, 41)))) {
            PackageManager packageManager = ((AbstractC01270f) this).A00.getPackageManager();
    ...
    private List<C01320k> A04() {
        String queryParameter = this.A00.getQueryParameter(A03(114, 12, 124));
        if (TextUtils.isEmpty(queryParameter) || A03(53, 2, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD).equals(queryParameter)) {
            return null;
        }
        ...
        try {
            ...
            if (optJSONArray != null) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    C01320k appSiteData = C01320k.A00(optJSONArray.optJSONObject(i));
                    if (appSiteData != null) {
            ...
            ((AbstractC01270f) this).A00.A04().A8V(A03(HttpStatus.SC_NO_CONTENT, 7, 47), C03228e.A1m, new C03238f(e));
    ...
    private boolean A08() {
        ...
        for (Intent intent : A05) {
            try {
                if (C0616Kp.A0C(((AbstractC01270f) this).A00, intent)) {
                    return true;
                }
    ...
    private boolean A09() {
        C0623Ky ky = new C0623Ky();
        try {
            C0623Ky.A09(ky, ((AbstractC01270f) this).A00, A02(), this.A02);
            return true;
        } catch (Exception unused) {
            ...
            C0623Ky.A09(ky, ((AbstractC01270f) this).A00, Uri.parse(queryParameter), this.A02);
            return false;
        }
    }
