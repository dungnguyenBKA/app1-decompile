...
public final class AnonymousClass2O<E> implements Cloneable {
    ...
    public AnonymousClass2O() {
        this(10);
    }

    public AnonymousClass2O(int i) {
        this.A01 = false;
        if (i == 0) {
            this.A02 = AnonymousClass2N.A01;
            this.A03 = AnonymousClass2N.A02;
        } else {
            int A002 = AnonymousClass2N.A00(i);
    ...
    /* renamed from: A01 */
    public final AnonymousClass2O<E> clone() {
        LongSparseArray<E> longSparseArray = null;
        try {
            longSparseArray = (AnonymousClass2O) super.clone();
    ...
    private final E A02(long j, E e) {
        int A032 = AnonymousClass2N.A03(this.A02, this.A00, j);
        if (A032 >= 0) {
    ...
    public final void A0B(long j, E e) {
        ...
        if (this.A01 && this.A00 >= this.A02.length) {
            A04();
            i = AnonymousClass2N.A03(this.A02, this.A00, j) ^ -1;
        }
        int i2 = this.A00;
        if (i2 >= this.A02.length) {
            int A002 = AnonymousClass2N.A00(i2 + 1);
    ...
    /* JADX INFO: Multiple debug info for r0v9 E: [D('i' int), D('value' java.lang.Object)] */
