...
public final class Ce {
    ...
    private long A00(CH ch) throws IOException, InterruptedException {
        ch.ACM(this.A01.A00, 0, 1);
    ...
    public final boolean A02(CH ch) throws IOException, InterruptedException {
        long A6i = ch.A6i();
        long j = PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID;
        if (A6i != -1 && A6i <= PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) {
            j = A6i;
        }
        int i = (int) j;
        boolean z = false;
        ch.ACM(this.A01.A00, 0, 4);
        ...
        while (A0N != 440786851) {
            ...
            ch.ACM(this.A01.A00, 0, 1);
            A0N = ((A0N << 8) & -256) | ((long) (this.A01.A00[0] & 255));
        }
        long A002 = A00(ch);
