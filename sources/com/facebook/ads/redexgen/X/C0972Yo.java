...
public final class C0972Yo implements CP {
    ...
    public C0972Yo(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    private final int A00(long j) {
        return C0556Ic.A0B(this.A04, j, true, true);
    }
    ...
    public final CO A77(long j) {
        int A002 = A00(j);
        CQ cq = new CQ(this.A04[A002], this.A03[A002]);
        if (cq.A01 >= j || A002 == this.A00 - 1) {
            return new CO(cq);
        }
        return new CO(cq, new CQ(this.A04[A002 + 1], this.A03[A002 + 1]));
    }
