...
public final class D8 {
    ...
    public static final int A0D = C0556Ic.A08(A00(0, 4, 115));
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public final IM A0A = new IM(255);
    ...
    public final boolean A04(CH ch, boolean z) throws IOException, InterruptedException {
        boolean z2;
        this.A0A.A0W();
        A03();
        if (ch.A6i() == -1 || ch.A6i() - ch.A6w() >= 27) {
            z2 = true;
        } else {
            z2 = false;
        }
        if (z2 && ch.ACN(this.A0A.A00, 0, 27, true)) {
            ...
            if (A0C[1].charAt(3) != 'Q') {
                ...
                if (A0N == j) {
                    ...
                    if (this.A03 == 0) {
                        ...
                        this.A0A.A0W();
                        ch.ACM(this.A0A.A00, 0, this.A02);
                        int i = 0;
                        while (true) {
                            int i2 = this.A02;
                            if (A0C[2].length() == 23) {
                        ...
                        throw new AJ(A00(50, 31, 79));
                    }
                } else if (z) {
                    return false;
                } else {
                    throw new AJ(A00(4, 46, 94));
                }
            }
