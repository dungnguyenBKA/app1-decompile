...
public final class C0516Gn {
    ...
    public C0516Gn(String str, int i, String str2, String[] strArr) {
        this.A00 = i;
        this.A01 = str;
        this.A02 = str2;
        this.A03 = strArr;
    ...
    public static C0516Gn A00() {
        String A022 = A02(0, 0, 1);
        return new C0516Gn(A022, 0, A022, new String[0]);
    }

    public static C0516Gn A01(String str, int i) {
        String trim;
        String[] strArr;
        ...
        String[] A0m = C0556Ic.A0m(name, A02(1, 2, 40));
        String str2 = A0m[0];
        if (A0m.length > 1) {
        ...
        return new C0516Gn(str2, i, trim, strArr);
    }
}
