...
public class AnonymousClass4V {
    ...
    public AnonymousClass4V(int i, int i2) {
        this(i, i2, RecyclerView.UNDEFINED_DURATION, null);
    }

    public AnonymousClass4V(int i, int i2, int i3, Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i;
    ...
    private void A01() {
        if (this.A05 != null && this.A01 < 1) {
            ...
            throw new IllegalStateException(A00(76, 41, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD));
        }
    }
    ...
    public final void A06(com.facebook.ads.redexgen.X.C0469Eq r7) {
        /*
        // Method dump skipped, instructions count: 186
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass4V.A06(com.facebook.ads.redexgen.X.Eq):void");
    }
