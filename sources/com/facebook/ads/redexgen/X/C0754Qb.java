...
public final class C0754Qb {
    ...
    /* JADX INFO: Multiple debug info for r1v4 java.security.cert.Certificate: [D('publicKeys' java.util.Set<java.lang.String>), D('cert' java.security.cert.Certificate)] */
    public static void A03(HttpsURLConnection httpsURLConnection, Set<String> set, Set<String> set2) throws Exception {
        String certSha1 = A00(5, 5, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD);
