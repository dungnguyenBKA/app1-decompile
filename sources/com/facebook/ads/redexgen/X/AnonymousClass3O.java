...
public final class AnonymousClass3O {
    public static byte[] A02;
    public static String[] A03;
    public static final AnonymousClass3K A04;
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            A04 = new AnonymousClass0P();
        } else if (Build.VERSION.SDK_INT >= 22) {
            A04 = new AnonymousClass0Z();
        } else if (Build.VERSION.SDK_INT >= 21) {
            A04 = new C01230b();
        } else if (Build.VERSION.SDK_INT >= 19) {
            A04 = new AnonymousClass2D();
            ...
            A04 = new AnonymousClass3K();
        }
    }

    public AnonymousClass3O(AccessibilityNodeInfo accessibilityNodeInfo) {
    ...
    public static AnonymousClass3O A01(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        return new AnonymousClass3O(accessibilityNodeInfo);
    }
    ...
    public final void A0Q(Object obj) {
        A04.A03(this.A01, ((AnonymousClass3L) obj).A00);
    }

    public final void A0R(Object obj) {
        A04.A04(this.A01, ((AnonymousClass3M) obj).A00);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        AnonymousClass3O r5 = (AnonymousClass3O) obj;
    ...
    public final String toString() {
        ...
        A0C(rect);
        sb.append(A08(23, 18, FacebookMediationAdapter.ERROR_NULL_CONTEXT) + rect);
