...
@TargetApi(17)
public final class I7 implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new I5(C0556Ic.A0P(A04(0, 67, 11), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static EGLDisplay A02() {
        ...
        if (display != null) {
            ...
            throw new I5(A04(140, 20, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS));
        }
        throw new I5(A04(120, 20, 23));
    }
    ...
    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i) {
        ...
        if (i == 1) {
            ...
            if (eglCreatePbufferSurface == null) {
                throw new I5(A04(90, 30, 124));
            }
        }
        if (EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eGLContext)) {
            return eglCreatePbufferSurface;
        }
        throw new I5(A04(160, 21, 115));
    }
    ...
    public static void A07(int[] iArr) {
        ...
        if (errorCode != 0) {
            throw new I5(A04(181, 29, 47) + Integer.toHexString(errorCode));
        }
    }

    public final SurfaceTexture A08() {
        return (SurfaceTexture) C0551Hx.A01(this.A00);
    }
