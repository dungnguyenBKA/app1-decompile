...
public final class C0639Lo {
    @TargetApi(VungleException.NO_SPACE_TO_LOAD_AD_AUTO_CACHED)
    public static Bitmap A00(XJ xj, Bitmap bitmap, int i) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation allocation2 = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(xj);
    ...
    @Nullable
    public static Bitmap A01(XJ xj, Bitmap bitmap, int i, int i2) {
        ...
        try {
            Bitmap A00 = A00(xj, createBitmap, i);
            if (i2 == 1) {
                return A00;
            }
            ...
            return new C1170cf().A03(createBitmap, (float) i);
        }
    }
}
