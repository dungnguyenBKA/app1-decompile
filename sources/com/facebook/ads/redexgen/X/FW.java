...
public final class FW {
    ...
    public final synchronized int A0A(AD ad, YY yy, boolean z, boolean z2, Format format, FV fv) {
        if (A0J()) {
            int A002 = A00(this.A03);
            if (z || this.A0G[A002] != format) {
                ad.A00 = this.A0G[A002];
                return -5;
            } else if (yy.A0B()) {
                return -3;
            } else {
                yy.A00 = this.A0F[A002];
                yy.A02(this.A0B[A002]);
                fv.A00 = this.A0C[A002];
                fv.A01 = this.A0E[A002];
                fv.A02 = this.A0H[A002];
                this.A03++;
                return -4;
            }
        } else if (z2) {
    ...
    /* JADX INFO: Multiple debug info for r13v0 'this'  com.facebook.ads.redexgen.X.FW: [D('newSizes' int[]), D('relativeEndIndex' int)] */
    public final synchronized void A0H(long j, int i, long j2, int i2, CR cr) {
        if (this.A0A) {
            if ((i & 1) != 0) {
                this.A0A = false;
            } else {
        ...
        if (this.A02 == this.A01) {
            int i3 = this.A01 + AdError.NETWORK_ERROR_CODE;
            int[] iArr = new int[i3];
            ...
            System.arraycopy(this.A0H, this.A04, crArr, 0, i4);
            ...
            System.arraycopy(this.A0H, 0, crArr, i4, i5);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0055, code lost:
        if (com.facebook.ads.redexgen.X.FW.A0I[0].length() == 29) goto L_0x0064;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0057, code lost:
        r2 = com.facebook.ads.redexgen.X.FW.A0I;
        r2[3] = "Ebt";
    ...
    public final synchronized boolean A0K(long r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.FW.A0K(long):boolean");
    }
    ...
    public final synchronized boolean A0L(Format format) {
        ...
        this.A09 = false;
        if (C0556Ic.A0h(format, this.A08)) {
            return false;
        }
        this.A08 = format;
        return true;
