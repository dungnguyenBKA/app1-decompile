...
public final class J2 {
    ...
    public final ServiceConnection A02 = new J1(this);
    public final XJ A03;
    ...
    public J2(XJ xj, String str, String str2) {
        this.A03 = xj;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void A07(int i, C03238f r6) {
        this.A03.A04().A8V(A05(189, 14, 74), i, r6);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void A08(int i, C03238f r6) {
        r6.A03(1);
        this.A03.A04().A8W(A05(189, 14, 74), i, r6);
    }

    public final void A0C() {
        A08(C03228e.A1b, new C03238f(A05(101, 18, 66), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 125), A05(119, 51, 26));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(C03228e.A1X, new C03238f(A05(51, 50, 11)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e) {
            A07(C03228e.A1W, new C03238f(e));
        }
    }
}
