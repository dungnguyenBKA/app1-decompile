...
public final class II {
    ...
    public static int A04(byte[] r8, int r9, int r10, boolean[] r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.II.A04(byte[], int, int, boolean[]):int");
    }

    public static IG A05(byte[] bArr, int i, int i2) {
        IN in = new IN(bArr, i, i2);
        in.A08(8);
        int picParameterSetId = in.A05();
        int A052 = in.A05();
        in.A07();
        return new IG(picParameterSetId, A052, in.A0B());
    }

    /* JADX INFO: Multiple debug info for r0v15 int: [D('picHeightInMapUnits' int), D('frameHeightInMbs' int)] */
    /* JADX INFO: Multiple debug info for r0v36 int: [D('sarHeight' int), D('picOrderCntLsbLength' int)] */
    /* JADX WARN: Type inference failed for: r17v0, types: [int, boolean] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.facebook.ads.redexgen.X.IH A06(byte[] r19, int r20, int r21) {
        /*
        // Method dump skipped, instructions count: 457
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.II.A06(byte[], int, int):com.facebook.ads.redexgen.X.IH");
    }

    public static void A0A(IN in, int nextScale) {
        int i = 8;
        int deltaScale = 8;
        for (int i2 = 0; i2 < nextScale; i2++) {
            if (deltaScale != 0) {
                deltaScale = ((in.A04() + i) + 256) % 256;
            }
            if (deltaScale != 0) {
                i = deltaScale;
            }
