...
public final class C02685s {
    ...
    public static double A00(Context context) {
        return J4.A0N(context).A1v(A0C(FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS, 29, 13), 0.0d);
    }

    public static double A01(Context context) {
        return J4.A0N(context).A1v(A0C(221, 36, 30), 0.0d);
    }

    public static float A02(Context context) {
        return J4.A0N(context).A1w(A0C(137, 16, 65), 0.0f);
    }

    public static int A03(Context context) {
        return J4.A0N(context).A1x(A0C(8, 42, 18), 0);
    }

    public static int A04(Context context) {
        return J4.A0N(context).A1x(A0C(68, 40, 115), 0);
    }

    public static int A05(Context context) {
        return J4.A0N(context).A1x(A0C(153, 22, 56), 0);
    }

    public static int A06(Context context) {
        return J4.A0N(context).A1x(A0C(257, 20, 88), 0);
    }

    public static int A07(Context context) {
        return J4.A0N(context).A1x(A0C(316, 39, 79), 0);
    }

    public static long A08(Context context) {
        return J4.A0N(context).A1y(A0C(50, 18, 46), 0);
    }

    public static long A09(Context context) {
        return J4.A0N(context).A1y(A0C(HttpStatus.SC_ACCEPTED, 19, 63), 0);
    }

    public static EnumC02816f A0A(Context context) {
        return EnumC02816f.A00(J4.A0N(context).A1x(A0C(277, 5, 98), 0));
    }
    ...
    public static String A0D(Context context) {
        J4 A0N = J4.A0N(context);
        String A0C = A0C(355, 2, 84);
        String A1z = A0N.A1z(A0C(299, 17, 0), A0C);
        return A1z == null ? A0C : A1z;
    }
    ...
    public static boolean A0Q(Context context) {
        return J4.A0N(context).A22(A0C(175, 27, 25), false);
    }

    public static boolean A0R(Context context) {
        return J4.A0N(context).A22(A0C(0, 8, 112), false);
    }
}
