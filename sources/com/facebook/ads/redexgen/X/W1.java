...
public class W1 implements AbstractC02876l<String> {
    ...
    public W1(Enumeration<InetAddress> enumeration) {
        this.A00 = A01(enumeration);
    }

    public /* synthetic */ W1(Enumeration enumeration, W0 w0) {
        this(enumeration);
    }
    ...
    public final boolean A80(Object obj) {
        ...
        if (map != null) {
            Map<String, String> map2 = w1.A00;
            if (A02[3].length() != 23) {
                String[] strArr = A02;
                strArr[0] = "yfFtf6a";
                strArr[4] = "R3xveNN";
                if (map2 != null) {
                    if (map.size() != w1.A00.size()) {
                        return false;
                    }
                    Iterator<Map.Entry<String, String>> newInetAddressIterator = w1.A00.entrySet().iterator();
                    for (Map.Entry<String, String> entry : this.A00.entrySet()) {
