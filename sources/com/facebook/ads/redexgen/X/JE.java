...
public enum JE {
    ...
    A0K(A01(484, 14, 57)),
    A0D(A01(392, 10, 117)),
    A0E(A01(HttpStatus.SC_PAYMENT_REQUIRED, 12, 118)),
    A0L(A01(498, 5, 57)),
    A0G(A01(425, 16, 24)),
    A0H(A01(441, 9, 54)),
    A0F(A01(HttpStatus.SC_REQUEST_URI_TOO_LONG, 11, 6)),
    A0R(A01(568, 5, 113)),
    A0Q(A01(548, 11, 96)),
    A04(A01(594, 5, 112)),
    A0J(A01(466, 18, 14)),
    A05(A01(HttpStatus.SC_SEE_OTHER, 12, 92)),
    A07(A01(348, 11, 62)),
    A0O(A01(533, 15, 70)),
    A0P(A01(518, 15, 59)),
    A0M(A01(HttpStatus.SC_SERVICE_UNAVAILABLE, 11, 33)),
    A09(A01(315, 18, 48)),
    A0S(A01(573, 21, FacebookMediationAdapter.ERROR_NULL_CONTEXT)),
    A0C(A01(559, 9, 15)),
    A0I(A01(450, 16, 22)),
    A0B(A01(369, 23, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD)),
    A0A(A01(364, 5, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE));
    ...
    public static JE A00(String str) {
        JE[] values = values();
        for (JE je : values) {
            if (je.A00.equalsIgnoreCase(str)) {
                return je;
            }
        }
        String[] strArr = A02;
