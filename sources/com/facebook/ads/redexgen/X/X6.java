...
public final class X6 extends AbstractC02956t<HashMap<String, Integer>> {
    ...
    public X6(long j, @Nullable C02936r r9, HashMap<String, Integer> signalValues) {
        super(j, r9, signalValues, EnumC02946s.A07);
    }

    /* JADX INFO: Multiple debug info for r0v10 java.lang.String: [D('key' java.lang.String), D('keySize' int)] */
    ...
    public final boolean A0B(AbstractC02956t<HashMap<String, Integer>> r10) {
        if (A08() != null) {
