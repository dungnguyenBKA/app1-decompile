...
public class TC extends AnonymousClass4X {
    ...
    /* JADX INFO: Multiple debug info for r6v0 com.facebook.ads.redexgen.X.4V: [D('target' int), D('time' int)] */
    private final void A08(AnonymousClass4V r6) {
        PointF A0Q = A0Q(A08());
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass4X
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass4X
    public final void A0I(int i, int i2, AnonymousClass4Z r4, AnonymousClass4V r5) {
        if (A07() == 0) {
            A0A();
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass4X
    public void A0J(View view, AnonymousClass4Z r8, AnonymousClass4V r9) {
    ...
    public PointF A0Q(int i) {
        AnonymousClass4K A09 = A09();
        if (A09 instanceof AnonymousClass4W) {
            return ((AnonymousClass4W) A09).A46(i);
        }
        Log.w(A04(0, 20, 70), A04(20, 93, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION) + AnonymousClass4W.class.getCanonicalName());
        return null;
    }
}
