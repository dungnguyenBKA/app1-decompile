...
public final class C0649Ly {
    public static byte[] A00;
    public static final String A01 = C0649Ly.class.getSimpleName();
    ...
    public static boolean A02(XJ xj) {
        return A03(xj) && C0650Lz.A04(xj);
    }

    public static boolean A03(XJ xj) {
        if (xj == null) {
            return true;
        }
        try {
            PowerManager powerManager = (PowerManager) xj.getSystemService(A00(60, 5, 18));
            ...
            xj.A04().A8V(A00(65, 5, 73), C03228e.A28, new C03238f(e));
            return true;
        }
    }
}
