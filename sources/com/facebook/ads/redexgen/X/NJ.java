...
public final class NJ {
    ...
    public static long A00(String str, String str2) {
        ...
        try {
            ...
            if (A03[2].charAt(3) != 'S') {
                A03[0] = "cNWLyixtjvzJHB8hFk1NwaSxJGtJuDCT";
                if (longValue < 0) {
                    return -1;
                }
    ...
    public final void A05(String str) {
        if (this.A00) {
            ...
            if (str.startsWith(A012)) {
                this.A01.A0H(A00(str, A012));
                return;
            }
            String A013 = A01(0, 22, 46);
            if (str.startsWith(A013)) {
                this.A01.A0F(A00(str, A013));
                return;
            }
            String A014 = A01(22, 18, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD);
            if (str.startsWith(A014)) {
                this.A01.A0G(A00(str, A014));
            }
        }
    }
