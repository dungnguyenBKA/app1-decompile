...
public class MQ implements LR<Bundle> {
    ...
    public MQ(XJ xj, JC jc, PI pi, List<AnonymousClass25> list, String str, boolean z) {
        this(xj, jc, pi, list, str, z, null);
    }

    public MQ(XJ xj, JC jc, PI pi, List<AnonymousClass25> list, String str, boolean z, @Nullable Bundle bundle) {
        this(xj, jc, pi, list, str, z, bundle, null);
    }

    public MQ(XJ xj, JC jc, PI pi, List<AnonymousClass25> list, String str, boolean z, @Nullable Bundle bundle, @Nullable Map<String, String> map) {
        this.A01 = 0;
        this.A00 = 0;
        this.A02 = null;
        this.A03 = null;
        ...
        this.A0B = map;
        this.A04 = z;
        list.add(new MS(this, 0.5d, -1.0d, 2.0d, true));
        list.add(new MR(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A05 = new C0816Sl(pi.getView(), list, bundle.getBundle(A0G(6, 16, 29)), xj);
            this.A01 = bundle.getInt(A0G(57, 18, 2));
            this.A00 = bundle.getInt(A0G(39, 18, 44));
        } else {
            this.A05 = new C0816Sl(pi.getView(), list, xj);
        }
        this.A09 = new PN(new Handler(), this);
    }

    private final float A0E() {
        return C0628Ld.A00(this.A06) * this.A08.getVolume();
    }

    private Map<String, String> A0I(int i) {
        boolean z;
        HashMap<String, String> hashMap = new HashMap<>();
        if (this.A08.getVideoStartReason() == PO.A03) {
            z = true;
        } else {
            z = false;
        }
        C0628Ld.A04(hashMap, z, !this.A08.A84());
        A0S(hashMap);
        A0R(hashMap);
        A0U(hashMap, i);
        A0T(hashMap);
    ...
    public Map<String, String> A0J(PJ pj) {
        return A0K(pj, this.A08.getCurrentPositionInMillis());
    }

    private Map<String, String> A0K(PJ pj, int i) {
        Map<String, String> A0I = A0I(i);
        A0I.put(A0G(0, 6, 122), String.valueOf(pj.A00));
        return A0I;
    }

    private void A0M() {
        this.A07.A8u(this.A0A, A0J(PJ.A04));
    }

    private void A0N() {
        this.A07.A8u(this.A0A, A0J(PJ.A0A));
    }
    ...
    private void A0R(Map<String, String> map) {
        AnonymousClass27 A032 = this.A05.A03();
        AnonymousClass26 A002 = A032.A00();
        ...
        AnonymousClass26 A012 = A032.A01();
        map.put(A0G(FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD, 3, 127), String.valueOf(A012.A00()));
        map.put(A0G(113, 3, 74), String.valueOf(A012.A05()));
        map.put(A0G(116, 5, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), String.valueOf(A012.A02()));
    ...
    private void A0S(Map<String, String> map) {
        map.put(A0G(30, 9, 11), String.valueOf(this.A08.A81()));
    ...
    private void A0T(Map<String, String> map) {
        ...
        map.put(A0G(FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION, 2, 123), String.valueOf(this.A08.getMeasuredWidth()));
    ...
    private void A0U(Map<String, String> map, int i) {
        map.put(A0G(99, 5, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), String.valueOf(((float) this.A00) / 1000.0f));
        map.put(A0G(FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE, 4, 5), String.valueOf(((float) i) / 1000.0f));
    }
    ...
    public final void A0X() {
        this.A05.A04();
        this.A07.A8u(this.A0A, A0J(PJ.A05));
    }

    public final void A0Y() {
        this.A07.A8u(this.A0A, A0J(PJ.A07));
    }

    public final void A0Z() {
        this.A07.A8u(this.A0A, A0J(PJ.A08));
    }
    ...
    public final void A0a() {
        if (((double) A0E()) < 0.05d) {
            ...
            if (A0D[0].charAt(27) != 'x') {
                A0D[0] = "XPLItjVbGIZC9JnvDMj8hFJbnbXNZ6Zm";
                this.A04 = true;
                return;
            }
        ...
        if (((double) i) > 0.0d && i >= (i2 = this.A01)) {
            if (i > i2) {
                ...
                if (z2 || i - this.A00 >= 5000) {
                    JC jc = this.A07;
                    String str = this.A0A;
                    Map<String, String> A0K = A0K(PJ.A09, i);
                    if (A0D[5].length() != 0) {
                        String[] strArr = A0D;
            ...
            if (z) {
                this.A07.A8u(this.A0A, A0K(PJ.A09, i));
            }
        }
    }
}
