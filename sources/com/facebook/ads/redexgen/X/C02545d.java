...
public final class C02545d {
    ...
    public static C02535c A00(ContentResolver contentResolver) {
        String A012 = A01(72, 14, 36);
        String A013 = A01(3, 9, 127);
        String A014 = A01(0, 3, 122);
        Cursor cursor = null;
        try {
            cursor = contentResolver.query(Uri.parse(A01(12, 60, 38)), new String[]{A014, A013, A012}, null, null, null);
            if (cursor == null || !cursor.moveToFirst()) {
                return new C02535c(null, null, false);
            }
            C02535c r0 = new C02535c(cursor.getString(cursor.getColumnIndex(A014)), cursor.getString(cursor.getColumnIndex(A013)), Boolean.valueOf(cursor.getString(cursor.getColumnIndex(A012))).booleanValue());
            cursor.close();
            return r0;
        } finally {
            if (cursor != null) {
