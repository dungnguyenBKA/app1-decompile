...
public final class C0979Yv implements CG {
    public static byte[] A07;
    public static String[] A08;
    public static final CJ A09 = new C0978Yu();
    public static final int A0A = A0E[8];
    public static final byte[] A0B = C0556Ic.A0j(A03(12, 6, 27));
    public static final byte[] A0C = C0556Ic.A0j(A03(18, 9, 50));
    ...
    private int A00(int i) throws AJ {
        if (!A08(i)) {
            StringBuilder sb = new StringBuilder();
            sb.append(A03(53, 12, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS));
            sb.append(this.A05 ? A03(FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS, 2, 10) : A03(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 2, 124));
            sb.append(A03(0, 12, 50));
            sb.append(i);
            throw new AJ(sb.toString());
        } else if (!this.A05) {
            return A0D[i];
        } else {
            int[] iArr = A0E;
    ...
    private int A01(CH ch) throws IOException, InterruptedException {
        ch.ADN();
        ch.ACM(this.A06, 0, 1);
        byte b = this.A06[0];
        if ((b & 131) <= 0) {
        ...
        throw new AJ(A03(65, 38, 93) + ((int) b));
    }

    /* JADX INFO: Multiple debug info for r12v0 'this'  com.facebook.ads.redexgen.X.Yv: [D('e' java.io.EOFException), D('bytesAppended' int)] */
    private int A02(CH ch) throws IOException, InterruptedException {
        if (this.A00 == 0) {
            try {
                this.A01 = A01(ch);
                this.A00 = this.A01;
        ...
        int ADQ = this.A03.ADQ(ch, this.A00, true);
        if (ADQ == -1) {
            return -1;
        }
        this.A00 -= ADQ;
    ...
    private void A04() {
        ...
        if (!this.A04) {
            ...
            if (this.A05) {
                ...
                A032 = A03(FacebookMediationAdapter.ERROR_NULL_CONTEXT, 10, 66);
            }
            if (this.A05) {
                i = 16000;
            } else {
            ...
            this.A03.A5P(Format.A06(null, A032, null, -1, A0A, 1, i, -1, null, null, 0, null));
        }
    }
    ...
    private boolean A0B(CH ch, byte[] bArr) throws IOException, InterruptedException {
        ch.ADN();
        byte[] bArr2 = new byte[bArr.length];
        ch.ACM(bArr2, 0, bArr.length);
