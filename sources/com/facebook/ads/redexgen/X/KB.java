...
public final class KB {
    ...
    public AnonymousClass8D A02;
    public EnumC0591Jo A03;
    public EnumC0593Jr A04;
    @Nullable
    public LK A05;
    @Nullable
    public String A06;
    ...
    public KB(AnonymousClass8D r2, String str, @Nullable LK lk, EnumC0593Jr jr, @Nullable String str2, int i, boolean z, boolean z2, C0598Jw jw, @Nullable String str3, @Nullable String str4, @Nullable AdExperienceType adExperienceType) {
        this.A02 = r2;
        this.A07 = str;
        this.A05 = lk;
        this.A04 = jr;
    ...
    public final EnumC0591Jo A05() {
        return this.A03;
    }

    public final EnumC0593Jr A06() {
        return this.A04;
    }
    ...
    public final Map<String, String> A09(Map<String, String> map) {
        ...
        A03(hashMap, A00(125, 4, 81), C02525b.A00().A03());
        if (C02525b.A00().A04()) {
            A002 = A00(0, 1, 83);
        } else {
            A002 = A00(1, 1, 52);
        ...
        if (this.A0C != AdPlacementType.UNKNOWN) {
            A03(hashMap, A00(HttpStatus.SC_ACCEPTED, 14, 113), this.A0C.toString().toLowerCase());
        }
        LK lk = this.A05;
        if (lk != null) {
            A03(hashMap, A00(259, 5, 36), String.valueOf(lk.A01()));
            A03(hashMap, A00(119, 6, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), String.valueOf(this.A05.A00()));
        }
        EnumC0593Jr jr = this.A04;
        if (jr != null) {
            A03(hashMap, A00(239, 11, 126), String.valueOf(jr.A03()));
        }
        boolean z = this.A0B;
        String[] strArr = A0G;
        if (strArr[1].charAt(22) == strArr[3].charAt(22)) {
            ...
            A03(hashMap, A00(160, 13, 92), String.valueOf(C0633Li.A03(this.A02)));
            A03(hashMap, A00(216, 12, 3), LZ.A05(System.currentTimeMillis()));
            ...
            A03(hashMap, A00(20, 36, 13), LZ.A06(AnonymousClass28.A00(this.A02.A00())));
            String str3 = this.A06;
            if (str3 != null) {
                A03(hashMap, A00(FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS, 11, 51), str3);
            }
