...
public final class AnonymousClass8S {
    ...
    public AnonymousClass8S(String str, Map<String, String> map) {
        this(str, map, false);
    }

    public AnonymousClass8S(String str, Map<String, String> map, boolean z) {
        String A002;
        this.A01 = str;
        this.A02 = map;
        if (z) {
