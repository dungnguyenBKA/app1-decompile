...
public final class AnonymousClass2K {
    public static AnonymousClass2K A05;
    public static byte[] A06;
    public static String[] A07;
    public static final Object A08 = new Object();
    public final Context A00;
    public final Handler A01;
    public final ArrayList<AnonymousClass2I> A02 = new ArrayList<>();
    public final HashMap<String, ArrayList<AnonymousClass2J>> A03 = new HashMap<>();
    public final HashMap<BroadcastReceiver, ArrayList<AnonymousClass2J>> A04 = new HashMap<>();
    ...
    public AnonymousClass2K(Context context) {
        this.A00 = context;
        this.A01 = new AnonymousClass2H(this, context.getMainLooper());
    }

    public static AnonymousClass2K A00(Context context) {
        AnonymousClass2K r0;
        synchronized (A08) {
            if (A05 == null) {
                A05 = new AnonymousClass2K(context.getApplicationContext());
            }
            r0 = A05;
        }
        return r0;
    ...
    public void A02() {
        /*
            r8 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<com.facebook.ads.redexgen.X.2J>> r1 = r8.A04
            monitor-enter(r1)
            java.util.ArrayList<com.facebook.ads.redexgen.X.2I> r0 = r8.A02     // Catch:{ all -> 0x0045 }
            int r0 = r0.size()     // Catch:{ all -> 0x0045 }
            if (r0 > 0) goto L_0x000d
            monitor-exit(r1)     // Catch:{ all -> 0x0045 }
            goto L_0x0044
        L_0x000d:
            com.facebook.ads.redexgen.X.2I[] r7 = new com.facebook.ads.redexgen.X.AnonymousClass2I[r0]     // Catch:{ all -> 0x0045 }
            java.util.ArrayList<com.facebook.ads.redexgen.X.2I> r0 = r8.A02     // Catch:{ all -> 0x0045 }
        ...
        L_0x001b:
            ...
            r5 = r7[r6]
            java.util.ArrayList<com.facebook.ads.redexgen.X.2J> r0 = r5.A01
            int r4 = r0.size()
            r3 = 0
        L_0x0027:
            if (r3 >= r4) goto L_0x0041
            ...
            com.facebook.ads.redexgen.X.2J r1 = (com.facebook.ads.redexgen.X.AnonymousClass2J) r1
            boolean r0 = r1.A01
        ...
        L_0x0045:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass2K.A02():void");
    }

    public final void A06(BroadcastReceiver broadcastReceiver) {
        synchronized (this.A04) {
            ArrayList<AnonymousClass2J> remove = this.A04.remove(broadcastReceiver);
            if (remove != null) {
                for (int size = remove.size() - 1; size >= 0; size--) {
                    AnonymousClass2J r6 = remove.get(size);
                    r6.A01 = true;
                    for (int i = 0; i < r6.A03.countActions(); i++) {
                        String action = r6.A03.getAction(i);
                        ArrayList<AnonymousClass2J> arrayList = this.A03.get(action);
                        if (arrayList != null) {
                            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                                AnonymousClass2J r1 = arrayList.get(size2);
    ...
    public final void A07(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.A04) {
            LocalBroadcastManager.ReceiverRecord r5 = new AnonymousClass2J(intentFilter, broadcastReceiver);
            ArrayList<AnonymousClass2J> arrayList = this.A04.get(broadcastReceiver);
            if (arrayList == null) {
    ...
    public final boolean A08(android.content.Intent r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AnonymousClass2K.A08(android.content.Intent):boolean");
    }
}
