...
/* renamed from: com.facebook.ads.redexgen.X.1v  reason: invalid class name and case insensitive filesystem */
public final class C01691v {
    public long A00 = -1;
    @Nullable
    ...
    public C01691v(XJ xj, @Nullable InterstitialAd interstitialAd, String str) {
        this.A09 = xj;
        this.A0A = str;
    ...
    public final void A0C(@Nullable InterstitialAd interstitialAd) {
        if (interstitialAd != null || J4.A0n(this.A09)) {
            this.A01 = interstitialAd;
        }
    }
