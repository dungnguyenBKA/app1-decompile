...
public final class Z5 implements CG {
    ...
    public static final CJ A0r = new Z3();
    public static final UUID A0s = new UUID(72057594037932032L, -9223371306706625679L);
    public static final byte[] A0t = C0556Ic.A0j(A03(539, 90, 21));
    ...
    public boolean A0a;
    public int[] A0b;
    public final SparseArray<Cc> A0c;
    public final CY A0d;
    public final C0419Cf A0e;
    public final IM A0f;
    public final IM A0g;
    public final IM A0h;
    public final IM A0i;
    ...
    public Z5(CY cy, int i) {
        ...
        this.A0o = z;
        this.A0e = new C0419Cf();
        this.A0c = new SparseArray<>();
        this.A0k = new IM(4);
        this.A0n = new IM(ByteBuffer.allocate(4).putInt(-1).array());
        this.A0l = new IM(4);
        this.A0i = new IM(II.A03);
        this.A0h = new IM(4);
        this.A0j = new IM();
        this.A0m = new IM();
        this.A0f = new IM(8);
    ...
    private int A00(CH ch, CS cs, int i) throws IOException, InterruptedException {
        int ADQ;
    ...
    private long A01(long j) throws AJ {
        long j2 = this.A0M;
        if (j2 != -9223372036854775807L) {
            return C0556Ic.A0F(j, j2, 1000);
        }
        throw new AJ(A03(189, 54, 33));
    }

    private CP A02() {
        IC ic;
        IC ic2;
        if (this.A0K == -1 || this.A0H == -9223372036854775807L || (ic = this.A0Q) == null || ic.A02() == 0 || (ic2 = this.A0P) == null || ic2.A02() != this.A0Q.A02()) {
            this.A0Q = null;
            this.A0P = null;
            return new C0977Yt(this.A0H);
        }
        ...
        this.A0Q = null;
        this.A0P = null;
        return new C0972Yo(iArr, jArr, timesUs, jArr2);
    }
    ...
    private void A08(CH ch, int i) throws IOException, InterruptedException {
        if (this.A0k.A08() < i) {
            if (this.A0k.A06() < i) {
                IM im = this.A0k;
                im.A0c(Arrays.copyOf(im.A00, Math.max(this.A0k.A00.length * 2, i)), this.A0k.A08());
            }
            ch.readFully(this.A0k.A00, this.A0k.A08(), i - this.A0k.A08());
            this.A0k.A0Y(i);
        }
    }

    /* JADX INFO: Multiple debug info for r11v0 com.facebook.ads.redexgen.X.CH: [D('nalLengthData' byte[]), D('isEncrypted' boolean)] */
    /* JADX WARNING: Removed duplicated region for block: B:102:? A[RETURN, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:90:0x0287  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void A09(com.facebook.ads.redexgen.X.CH r11, com.facebook.ads.redexgen.X.Cc r12, int r13) throws java.io.IOException, java.lang.InterruptedException {
        /*
        // Method dump skipped, instructions count: 665
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.Z5.A09(com.facebook.ads.redexgen.X.CH, com.facebook.ads.redexgen.X.Cc, int):void");
    }

    private void A0A(CH ch, byte[] bArr, int i) throws IOException, InterruptedException {
        ...
        ch.readFully(this.A0m.A00, bArr.length, i);
        this.A0m.A0X(length);
    }

    private void A0B(CH ch, byte[] bArr, int i, int i2) throws IOException, InterruptedException {
        int min = Math.min(i2, this.A0j.A05());
        ch.readFully(bArr, i + min, i2 - min);
        if (min > 0) {
    ...
    private void A0C(Cc cc, long j) {
        if (cc.A0X != null) {
            cc.A0X.A03(cc, j);
        } else {
            if (A03(843, 11, 56).equals(cc.A0Y)) {
                A0D(cc, A03(33, 19, 75), 19, 1000, A0x);
            } else {
                if (A03(833, 10, 45).equals(cc.A0Y)) {
                    A0D(cc, A03(14, 19, 119), 21, 10000, A0v);
                }
            }
            cc.A0W.ADS(j, this.A01, this.A08, 0, cc.A0V);
        }
        this.A0V = true;
        A05();
    }

    private void A0D(Cc cc, String str, int i, long j, byte[] bArr) {
    ...
    public static void A0E(byte[] bArr, long j, String str, int i, long j2, byte[] bArr2) {
        ...
        if (j == -9223372036854775807L) {
            ...
            A0j2 = C0556Ic.A0j(String.format(Locale.US, str, Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(lastValue), Integer.valueOf((int) ((j4 - (((long) lastValue) * 1000000)) / j2))));
        }
        System.arraycopy(A0j2, 0, bArr, i, bArr2.length);
    }

    private boolean A0F(CN cn2, long j) {
        if (this.A0Y) {
            this.A0J = j;
            cn2.A00 = this.A0F;
            this.A0Y = false;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x018a, code lost:
        if (r3.equals(r4) == false) goto L_0x018c;
     */
    ...
    public static boolean A0G(java.lang.String r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.Z5.A0G(java.lang.String):boolean");
    }
    ...
    public final void A0J(int i) throws AJ {
        if (i != 160) {
            if (A0q[3].charAt(28) == 'C') {
                ...
                if (i == 174) {
                    ...
                    throw new AJ(A03(667, 50, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION));
                } else if (i != 25152) {
                    if (A0q[7].length() != 22) {
                        ...
                        if (i != 28032) {
                            if (i == 357149030) {
                                ...
                                throw new AJ(A03(756, 26, 66));
                            }
                        } else if (this.A0O.A0c && this.A0O.A0f != null) {
                            throw new AJ(A03(243, 53, 91));
                        } else {
                            return;
                        }
                    }
                    ...
                    if (this.A0O.A0V != null) {
                        this.A0O.A0U = new DrmInitData(new DrmInitData.SchemeData(C03639u.A04, A03(1024, 10, 56), this.A0O.A0V.A03));
                        return;
                    }
                    throw new AJ(A03(449, 55, 66));
                }
            }
            throw new RuntimeException();
        } else if (this.A04 == 2) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void A0L(int r19, int r20, com.facebook.ads.redexgen.X.CH r21) throws java.io.IOException, java.lang.InterruptedException {
        /*
        // Method dump skipped, instructions count: 916
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.Z5.A0L(int, int, com.facebook.ads.redexgen.X.CH):void");
    }

    public final void A0M(int i, long j) throws AJ {
        ...
        if (i != 20529) {
            if (i != 20530) {
                ...
                switch (i) {
                    ...
                    case 16980:
                        if (j != 3) {
                            throw new AJ(A03(296, 16, 112) + j + A032);
                        }
                        return;
                    case 17029:
                        if (j < 1 || j > 2) {
                            throw new AJ(A03(377, 19, 127) + j + A032);
                        }
                        return;
                    case 17143:
                        if (j != 1) {
                            throw new AJ(A03(433, 16, 53) + j + A032);
                        }
                        return;
                    case 18401:
                        if (j != 5) {
                            throw new AJ(A03(312, 15, 26) + j + A032);
                        }
                        return;
                    case 18408:
                        if (j != 1) {
                            throw new AJ(A03(52, 22, 45) + j + A032);
                        }
                        return;
                    case 21420:
                        this.A0I = this.A0K + j;
                ...
                throw new AJ(A03(348, 21, 50) + j + A032);
            }
        } else if (j != 0) {
            throw new AJ(A03(327, 21, 54) + j + A032);
        }
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void A0N(int r8, long r9, long r11) throws com.facebook.ads.redexgen.X.AJ {
        /*
        // Method dump skipped, instructions count: 317
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.Z5.A0N(int, long, long):void");
    }

    public final void A0O(int i, String str) throws AJ {
        if (i == 134) {
            this.A0O.A0Y = str;
        } else if (i != 17026) {
            if (i == 2274716) {
            ...
            throw new AJ(A03(369, 8, 86) + str + A03(0, 14, 56));
        }
    }
