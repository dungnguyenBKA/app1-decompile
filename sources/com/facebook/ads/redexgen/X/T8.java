...
public class T8 implements AnonymousClass4I {
    ...
    public final void A05(C0469Eq eq, boolean z) {
        this.A00 = 0;
        int[] iArr = this.A03;
        if (iArr != null) {
            Arrays.fill(iArr, -1);
        }
        AnonymousClass4K r3 = eq.A06;
        if (eq.A04 != null && r3 != null && r3.A1Z()) {
            if (z) {
                boolean A0K = eq.A00.A0K();
                String[] strArr = A05;
                if (strArr[0].charAt(30) != strArr[5].charAt(30)) {
                    A05[7] = "b5aEeD0";
                    if (!A0K) {
                        r3.A1w(eq.A04.A0E(), this);
                    }
                }
                throw new RuntimeException();
            } else if (!eq.A1u()) {
                r3.A1v(this.A01, this.A02, eq.A0s, this);
            }
            int i = this.A00;
            int i2 = r3.A00;
            String[] strArr2 = A05;
