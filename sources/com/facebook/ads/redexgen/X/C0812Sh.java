...
public final class C0812Sh implements AbstractC01711x {
    public static byte[] A04;
    public static String[] A05;
    public final SV A00;
    public final AbstractC01661s A01;
    public final C01731z A02;
    public final XJ A03;
    ...
    public C0812Sh(XJ xj, C01731z r2, AbstractC01661s r3, SV sv) {
        this.A03 = xj;
        this.A02 = r2;
        this.A01 = r3;
        this.A00 = sv;
    ...
    public final void A7Z(Message message) {
        ...
        if (A012 == null) {
            this.A03.A04().A8V(A002, C03228e.A0A, new C03238f(A00(0, 17, 12)));
            return;
        }
        int i = message.what;
        ...
        if (i != 10) {
            if (i == 2100) {
                ...
                if (bundle != null) {
                    ...
                    int i2 = C03228e.A0K;
                    A042.A8V(A002, i2, new C03238f(A00(129, 26, 89), A003 + message));
                }
                this.A02.A02(null);
            } else if (i != 2103) {
                if (i == 2106) {
        ...
        if (strArr7[1].length() != strArr7[2].length()) {
            ...
            if (bundle2 != null) {
                ...
                AbstractC03218d A043 = this.A03.A04();
                int i5 = C03228e.A0K;
                A043.A8V(A002, i5, new C03238f(A00(155, 27, 49), A003 + message));
            }
            this.A02.A02(null);
            return;
        }
