...
public final class C0678Nc {
    ...
    public C0678Nc(Map<String, String> extraData) {
        this.A00 = extraData;
    }

    public final C0678Nc A03(@Nullable C0625La la) {
        if (la != null) {
            this.A00.put(A00(11, 5, 0), LG.A01(la.A05()));
        }
        return this;
    }

    public final C0678Nc A04(@Nullable QE qe) {
        if (qe != null) {
            this.A00.putAll(qe.A0T());
        }
        return this;
    }

    public final C0678Nc A05(@Nullable String str) {
