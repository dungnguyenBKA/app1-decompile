...
public final class B9 extends Exception {
    ...
    public B9(int r5, int r6, int r7, int r8) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.B9.<init>(int, int, int, int):void");
    }
}
