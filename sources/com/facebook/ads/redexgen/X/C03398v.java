...
public final class C03398v {
    ...
    public C03398v(String str, String str2, String str3, Date date) {
        boolean z;
        this.A01 = str;
        this.A00 = str2;
        this.A02 = str3;
    ...
    public C03398v(JSONObject jSONObject) {
    ...
    public static List<C03398v> A01(String str) {
        if (str == null) {
            return null;
        }
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONObject != null) {
                arrayList.add(new C03398v(jSONObject));
            }
        }
        return arrayList;
    }
