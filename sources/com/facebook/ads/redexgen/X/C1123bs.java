...
public final class C1123bs implements JA {
    public static byte[] A02;
    public static String[] A03;
    public static final String A04 = C1123bs.class.getSimpleName();
    public XK A00;
    public AbstractC0954Xw A01;
    ...
    /* JADX WARNING: Error to parse debug info: Index 20 out of bounds for length 20 in method: com.facebook.ads.redexgen.X.bs.A02(org.json.JSONArray, org.json.JSONArray, int):org.json.JSONArray, file: assets/audience_network.dex
                ...
                if (i2 < length && jSONObject == null) {
                    try {
                        ...
                        if (strArr[5].length() != strArr[6].length()) {
                            ...
                            strArr2[3] = "iJ";
                            if (isDebug) {
                                Log.e(A04, A00(273, 33, FacebookMediationAdapter.ERROR_NULL_CONTEXT) + i2, e);
                            }
                            jSONObject = null;
                            d = Double.MAX_VALUE;
                        } else {
    ...
    public C1123bs(XK xk, AbstractC0954Xw xw) {
        this.A00 = xk;
        this.A01 = xw;
    }
    ...
    private JSONObject A03() {
        JSONArray A032;
        JSONObject payload = this.A01.A5Z();
        JSONArray A5Y = this.A01.A5Y();
        if (J6.A0Q(this.A00) && (A032 = C03248g.A03(this.A00)) != null && A032.length() > 0) {
            A5Y = A01(A032, A5Y);
        }
        JSONObject jSONObject = null;
        if (A5Y != null) {
    ...
    private JSONObject A04(int i) {
        int A08;
        JSONArray A042;
        Pair<JSONObject, JSONArray> A7M = this.A01.A7M(i);
        JSONObject jSONObject = (JSONObject) A7M.first;
        JSONArray jSONArray = (JSONArray) A7M.second;
        if (J6.A0Q(this.A00) && (A042 = C03248g.A04(this.A00, (A08 = J6.A08(this.A00)))) != null && A042.length() > 0) {
    ...
    public final boolean A87() {
        int A0F = J6.A0F(this.A00);
        if (A0F >= 1 && this.A01.A6R() + C03248g.A00(this.A00) > A0F) {
            return true;
        }
        return false;
    }
    ...
    public final void A9O() {
        int A40 = this.A01.A40(J6.A0G(this.A00));
        if (A40 > 0) {
            AbstractC03218d A042 = this.A00.A04();
            int i = C03228e.A0o;
            A042.A8V(A00(379, 8, 100), i, new C03238f(A00(28, 44, 73) + A40));
        }
        XK xk = this.A00;
        String[] strArr = A03;
        if (strArr[5].length() != strArr[6].length()) {
            ...
            try {
                ...
                if (BuildConfigApi.isDebug()) {
                    ...
                    if (strArr[5].length() != strArr[6].length()) {
                        ...
                        Log.e(str, A00(FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS, 62, 122), e);
                    } else {
                        throw new RuntimeException();
                    }
                } else {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                if (A00(393, 26, 8).equals(string)) {
                    J4.A0N(this.A00).A20(jSONObject.getString(A00(HttpStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE, 14, 47)));
                    ...
                    if (i2 == 1) {
                        if (BuildConfigApi.isDebug()) {
                            ...
                            String A6U = this.A01.A6U(string);
                            if (A6U != null) {
                                String str2 = A00(72, 36, 101) + A6U;
                            }
                        }
                        if (!this.A01.A4i(string) && A0Q) {
                            C03248g.A0D(string);
                        }
                    } else {
