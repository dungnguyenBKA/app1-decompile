...
import com.facebook.ads.redexgen.X.HandlerThreadC0561Ii;
...
public final class DummySurface extends Surface {
    ...
    public final HandlerThreadC0561Ii A02;
    ...
    public DummySurface(HandlerThreadC0561Ii ii, SurfaceTexture surfaceTexture, boolean z) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x0027, code lost:
        if (A02(85, 6, 113).equals(com.facebook.ads.redexgen.X.C0556Ic.A06) != false) goto L_0x0029;
     */
    @android.annotation.TargetApi(com.vungle.warren.error.VungleException.ASSET_DOWNLOAD_ERROR)
    ...
    public static DummySurface A01(Context context, boolean z) {
        ...
        C0551Hx.A04(z2);
        HandlerThreadC0561Ii ii = new HandlerThreadC0561Ii();
        if (z) {
            i = A03;
        }
        return ii.A05(i);
    ...
    public static synchronized boolean A05(Context context) {
        ...
        synchronized (DummySurface.class) {
            z = true;
            if (!A04) {
                A03 = C0556Ic.A02 < 24 ? 0 : A00(context);
                A04 = true;
            }
            if (A03 == 0) {
                z = false;
