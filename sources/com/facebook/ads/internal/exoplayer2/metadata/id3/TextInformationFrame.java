...
public final class TextInformationFrame extends Id3Frame {
    ...
    public static final Parcelable.Creator<TextInformationFrame> CREATOR = new EA();
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (super.A00.equals(((Id3Frame) textInformationFrame).A00)) {
            boolean A0h = C0556Ic.A0h(this.A00, textInformationFrame.A00);
            String[] strArr = A03;
            if (strArr[6].length() != strArr[5].length()) {
                String[] strArr2 = A03;
                strArr2[0] = "NUyLGY6c98DzuB2hwNhLwgueoQfkovra";
                strArr2[7] = "68BFtnvNUVid3aPwudNpvIsh4Gz74lHo";
                if (!A0h || !C0556Ic.A0h(this.A01, textInformationFrame.A01)) {
                    return false;
                }
                return true;
            }
