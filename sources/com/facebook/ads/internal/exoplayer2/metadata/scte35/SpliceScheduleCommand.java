...
public final class SpliceScheduleCommand extends SpliceCommand {
    ...
    public static final Parcelable.Creator<SpliceScheduleCommand> CREATOR = new EG();
    public final List<EI> A00;
    ...
    public /* synthetic */ SpliceScheduleCommand(Parcel parcel, EG eg) {
        this(parcel);
    }

    public SpliceScheduleCommand(List<EI> list) {
        this.A00 = Collections.unmodifiableList(list);
    }

    public static SpliceScheduleCommand A00(IM im) {
        int A0F = im.A0F();
        ArrayList arrayList = new ArrayList(A0F);
        for (int i = 0; i < A0F; i++) {
            arrayList.add(EI.A02(im));
