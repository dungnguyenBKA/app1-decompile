...
public final class SpliceInsertCommand extends SpliceCommand {
    public static final Parcelable.Creator<SpliceInsertCommand> CREATOR = new ED();
    ...
    public SpliceInsertCommand(long j, boolean z, boolean z2, boolean z3, boolean z4, long j2, long j3, List<EE> list, boolean z5, long j4, int i, int i2, int i3) {
        this.A06 = j;
        this.A0B = z;
        this.A09 = z2;
        this.A0A = z3;
    ...
    public /* synthetic */ SpliceInsertCommand(Parcel parcel, ED ed) {
        this(parcel);
    }

    /* JADX INFO: Multiple debug info for r2v6 int: [D('programSpliceFlag' boolean), D('componentSplicePts' long)] */
    public static SpliceInsertCommand A00(IM im, long j, IY iy) {
        boolean z;
        ...
        if (!z) {
            ...
            if (autoReturn && !spliceImmediateFlag) {
                programSplicePts = TimeSignalCommand.A00(im, j);
            }
            if (!autoReturn) {
                int A0F2 = im.A0F();
                ...
                for (int i4 = 0; i4 < A0F2; i4++) {
                    ...
                    if (!spliceImmediateFlag) {
                        j3 = TimeSignalCommand.A00(im, j);
                    }
                    emptyList.add(new EE(A0F3, j3, iy.A08(j3), null));
                }
            }
            if (programSpliceFlag) {
                long A0F4 = (long) im.A0F();
                if ((A0F4 & 128) != 0) {
                    z3 = true;
                } else {
                    z3 = false;
                }
                j2 = (1000 * (((A0F4 & 1) << 32) | im.A0N())) / 90;
            }
            i = im.A0J();
            i2 = im.A0F();
            i3 = im.A0F();
        }
        return new SpliceInsertCommand(A0N, z, z2, autoReturn, spliceImmediateFlag, programSplicePts, iy.A08(programSplicePts), emptyList, z3, j2, i, i2, i3);
    }
