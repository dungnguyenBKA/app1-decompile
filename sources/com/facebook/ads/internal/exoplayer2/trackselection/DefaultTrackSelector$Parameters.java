...
import com.facebook.ads.redexgen.X.C0525Gw;
import com.facebook.ads.redexgen.X.C0556Ic;
...
public final class DefaultTrackSelector$Parameters implements Parcelable {
    ...
    public static final Parcelable.Creator<DefaultTrackSelector$Parameters> CREATOR = new C0525Gw();
    ...
    public DefaultTrackSelector$Parameters(Parcel parcel) {
        ...
        this.A0E = C0556Ic.A0g(parcel);
        this.A00 = parcel.readInt();
        this.A0D = C0556Ic.A0g(parcel);
        this.A09 = C0556Ic.A0g(parcel);
        this.A0A = C0556Ic.A0g(parcel);
        this.A03 = parcel.readInt();
        this.A02 = parcel.readInt();
        this.A01 = parcel.readInt();
        this.A0C = C0556Ic.A0g(parcel);
        this.A0B = C0556Ic.A0g(parcel);
        this.A06 = parcel.readInt();
        this.A05 = parcel.readInt();
        this.A0F = C0556Ic.A0g(parcel);
    ...
    public DefaultTrackSelector$Parameters(SparseArray<Map<TrackGroupArray, DefaultTrackSelector$SelectionOverride>> sparseArray, SparseBooleanArray sparseBooleanArray, @Nullable String str, @Nullable String str2, boolean z, int i, boolean z2, boolean z3, boolean z4, int i2, int i3, int i4, boolean z5, boolean z6, int i5, int i6, boolean z7, int i7) {
        ...
        this.A07 = C0556Ic.A0L(str);
        this.A08 = C0556Ic.A0L(str2);
        this.A0E = z;
        this.A00 = i;
        this.A0D = z2;
        this.A09 = z3;
    ...
    /* JADX INFO: Multiple debug info for r0v3 int: [D('second' android.util.SparseArray<java.util.Map<com.facebook.ads.internal.exoplayer2.source.TrackGroupArray, com.facebook.ads.internal.exoplayer2.trackselection.DefaultTrackSelector$SelectionOverride>>), D('indexInSecond' int)] */
    ...
    public static boolean A05(java.util.Map<com.facebook.ads.internal.exoplayer2.source.TrackGroupArray, com.facebook.ads.internal.exoplayer2.trackselection.DefaultTrackSelector$SelectionOverride> r5, java.util.Map<com.facebook.ads.internal.exoplayer2.source.TrackGroupArray, com.facebook.ads.internal.exoplayer2.trackselection.DefaultTrackSelector$SelectionOverride> r6) {
        ...
        L_0x0014:
            ...
            boolean r0 = com.facebook.ads.redexgen.X.C0556Ic.A0h(r1, r0)
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0556Ic.A0W(parcel, this.A0E);
        parcel.writeInt(this.A00);
        C0556Ic.A0W(parcel, this.A0D);
        C0556Ic.A0W(parcel, this.A09);
        C0556Ic.A0W(parcel, this.A0A);
        parcel.writeInt(this.A03);
        parcel.writeInt(this.A02);
        parcel.writeInt(this.A01);
        C0556Ic.A0W(parcel, this.A0C);
        C0556Ic.A0W(parcel, this.A0B);
        parcel.writeInt(this.A06);
        parcel.writeInt(this.A05);
        C0556Ic.A0W(parcel, this.A0F);
