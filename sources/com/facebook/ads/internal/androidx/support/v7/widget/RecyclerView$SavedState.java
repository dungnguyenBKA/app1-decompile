...
import com.facebook.ads.redexgen.X.AnonymousClass4K;
import com.facebook.ads.redexgen.X.AnonymousClass4U;

@RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
public class RecyclerView$SavedState extends AbsSavedState {
    public static final Parcelable.Creator<RecyclerView$SavedState> CREATOR = new AnonymousClass4U();
    public Parcelable A00;

    public RecyclerView$SavedState(Parcel parcel, ClassLoader classLoader) {
        super(parcel, classLoader);
        this.A00 = parcel.readParcelable(classLoader == null ? AnonymousClass4K.class.getClassLoader() : classLoader);
    }
