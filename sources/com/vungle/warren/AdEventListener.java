...
public class AdEventListener implements AdContract.AdvertisementPresenter.EventListener {
    ...
    public void onNext(String str, String str2, String str3) {
        ...
        if (this.placement == null) {
            Placement placement2 = (Placement) this.repository.load(this.placementId, Placement.class).get();
            this.placement = placement2;
            if (placement2 == null) {
        ...
        try {
            ...
            if (str.equals("start")) {
                ...
                Placement placement3 = (Placement) this.repository.load(this.placementId, Placement.class).get();
