...
public class ReportDBAdapter implements DBAdapter<Report> {
    ...
    Type stringType = new z80<ArrayList<String>>() {
        /* class com.vungle.warren.model.ReportDBAdapter.AnonymousClass1 */
    }.getType();
    Type userActionsType = new z80<ArrayList<Report.UserAction>>() {
        /* class com.vungle.warren.model.ReportDBAdapter.AnonymousClass2 */
    }.getType();
    ...
    public Report fromContentValues(ContentValues contentValues) {
        ...
        report.status = contentValues.getAsInteger(ReportColumns.COLUMN_REPORT_STATUS).intValue();
        ...
        List list = (List) this.gson.d(contentValues.getAsString(ReportColumns.COLUMN_CLICKED_THROUGH), this.stringType);
        List list2 = (List) this.gson.d(contentValues.getAsString(ReportColumns.COLUMN_ERRORS), this.stringType);
        List list3 = (List) this.gson.d(contentValues.getAsString(ReportColumns.COLUMN_USER_ACTIONS), this.userActionsType);
        if (list != null) {
    ...
    public ContentValues toContentValues(Report report) {
        ...
        contentValues.put(ReportColumns.COLUMN_URL, report.url);
        ...
        contentValues.put(ReportColumns.COLUMN_USER_ACTIONS, this.gson.i(new ArrayList(report.userActions), this.userActionsType));
        contentValues.put(ReportColumns.COLUMN_CLICKED_THROUGH, this.gson.i(new ArrayList(report.clickedThrough), this.stringType));
        contentValues.put(ReportColumns.COLUMN_ERRORS, this.gson.i(new ArrayList(report.errors), this.stringType));
        contentValues.put(ReportColumns.COLUMN_REPORT_STATUS, Integer.valueOf(report.status));
