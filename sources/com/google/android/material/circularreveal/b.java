...
public class b {
    ...
    private float e(c.e eVar) {
        return wx.b(eVar.a, eVar.b, 0.0f, 0.0f, (float) this.b.getWidth(), (float) this.b.getHeight());
    }
    ...
    private boolean k() {
        ...
        L_0x0024:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.circularreveal.b.k():boolean");
    }
    ...
    public void c(Canvas canvas) {
        ...
        if (k()) {
            ...
            if (i2 == 0) {
                ...
                throw new IllegalStateException(ic.f("Unsupported strategy ", i2));
            }
        } else {
            this.a.i(canvas);
            if (l()) {
