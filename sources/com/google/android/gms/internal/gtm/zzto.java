...
public abstract class zzto extends zzss {
    ...
    @Deprecated
    static int zzv(int i, zzwk zzwk, zzwx zzwx) {
        int zzD = zzD(i << 3);
        int i2 = zzD + zzD;
        zzsh zzsh = (zzsh) zzwk;
        int zzQ = zzsh.zzQ();
    ...
    public final void zzH(String str, zzyc zzyc) {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) zzyc);
    ...
    public abstract void zze(int i, zztd zztd);
