...
abstract class zzuk<T extends zzun<T>> {
    ...
    /* access modifiers changed from: package-private */
    public abstract <UT, UB> UB zze(zzww zzww, Object obj, zzuj zzuj, zzuo<T> zzuo, UB ub, zzxo<UT, UB> zzxo);

    /* access modifiers changed from: package-private */
    public abstract void zzf(Object obj);

    /* access modifiers changed from: package-private */
    public abstract void zzg(zzww zzww, Object obj, zzuj zzuj, zzuo<T> zzuo);

    /* access modifiers changed from: package-private */
    public abstract void zzh(zztd zztd, Object obj, zzuj zzuj, zzuo<T> zzuo);

    /* access modifiers changed from: package-private */
    public abstract boolean zzi(zzwk zzwk);

    /* access modifiers changed from: package-private */
    public abstract void zzj(zztp zztp, Map.Entry<?, ?> entry);
}
