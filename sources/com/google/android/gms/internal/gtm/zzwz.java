...
final class zzwz {
    ...
    static <UT, UB> UB zzC(int i, List<Integer> list, zzvd zzvd, UB ub, zzxo<UT, UB> zzxo) {
        if (zzvd == null) {
            return ub;
        }
    ...
    static <UT, UB> UB zzD(int i, int i2, UB ub, zzxo<UT, UB> zzxo) {
        if (ub == null) {
            ub = zzxo.zzf();
        }
    ...
    static <T, FT extends zzun<FT>> void zzE(zzuk<FT> zzuk, T t, T t2) {
    ...
    static <T, UT, UB> void zzF(zzxo<UT, UB> zzxo, T t, T t2) {
    ...
    static <T> void zzI(zzwf zzwf, T t, T t2, long j) {
        zzxy.zzs(t, j, zzwf.zzc(zzxy.zzf(t, j), zzxy.zzf(t2, j)));
    }

    public static void zzJ(int i, List<Boolean> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzc(i, list, z);
        }
    }

    public static void zzK(int i, List<zztd> list, zztp zztp) {
        if (list != null && !list.isEmpty()) {
            zztp.zze(i, list);
        }
    }

    public static void zzL(int i, List<Double> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzg(i, list, z);
        }
    }

    public static void zzM(int i, List<Integer> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzj(i, list, z);
        }
    }

    public static void zzN(int i, List<Integer> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzl(i, list, z);
        }
    }

    public static void zzO(int i, List<Long> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzn(i, list, z);
        }
    }

    public static void zzP(int i, List<Float> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzp(i, list, z);
        }
    }

    public static void zzQ(int i, List<?> list, zztp zztp, zzwx zzwx) {
        if (!(list == null || list.isEmpty())) {
    ...
    public static void zzR(int i, List<Integer> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzs(i, list, z);
        }
    }

    public static void zzS(int i, List<Long> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzu(i, list, z);
        }
    }

    public static void zzT(int i, List<?> list, zztp zztp, zzwx zzwx) {
        if (!(list == null || list.isEmpty())) {
            for (int i2 = 0; i2 < list.size(); i2++) {
    ...
    public static void zzU(int i, List<Integer> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzy(i, list, z);
        }
    }

    public static void zzV(int i, List<Long> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzA(i, list, z);
        }
    }

    public static void zzW(int i, List<Integer> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzC(i, list, z);
        }
    }

    public static void zzX(int i, List<Long> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzE(i, list, z);
        }
    }

    public static void zzY(int i, List<String> list, zztp zztp) {
        if (list != null && !list.isEmpty()) {
            zztp.zzH(i, list);
        }
    }

    public static void zzZ(int i, List<Integer> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzJ(i, list, z);
        }
    }
    ...
    public static void zzaa(int i, List<Long> list, zztp zztp, boolean z) {
        if (list != null && !list.isEmpty()) {
            zztp.zzL(i, list, z);
        }
    }
    ...
    static int zzc(int i, List<zztd> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int zzj(int i, List<zzwk> list, zzwx zzwx) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int zzo(int i, Object obj, zzwx zzwx) {
        if (!(obj instanceof zzvq)) {
            return zzto.zzD(i << 3) + zzto.zzA((zzwk) obj, zzwx);
        }
    ...
    static int zzp(int i, List<?> list, zzwx zzwx) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (obj instanceof zzvq) {
                zzC = zzto.zzy((zzvq) obj) + zzC;
            } else {
                zzC += zzto.zzA((zzwk) obj, zzwx);
            }
        }
        return zzC;
    }
