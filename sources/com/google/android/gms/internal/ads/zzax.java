...
public final class zzax {
    ...
    public final boolean zza(OutputStream outputStream) {
        try {
            ...
            if (list != null) {
                ...
                for (zzv zzv2 : list) {
                    zzav.zza(outputStream, zzv2.getName());
                    zzav.zza(outputStream, zzv2.getValue());
                }
            } else {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [java.util.List<com.google.android.gms.internal.ads.zzv>] */
