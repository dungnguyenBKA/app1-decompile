...
public final class zzawb extends RewardedAd {
    ...
    public final void zza(zzzk zzzk, RewardedAdLoadCallback rewardedAdLoadCallback) {
        try {
            this.zzdzl.zza(zzvq.zza(this.zzaad, zzzk), new zzawe(rewardedAdLoadCallback, this));
        } catch (RemoteException e) {
            zzazk.zze("#007 Could not call remote method.", e);
        }
    }
    ...
    public final void show(Activity activity, RewardedAdCallback rewardedAdCallback, boolean z) {
        ...
        try {
            this.zzdzl.zza(this.zzdzn);
            this.zzdzl.zza(aw.Q(activity), z);
        } catch (RemoteException e) {
            zzazk.zze("#007 Could not call remote method.", e);
        }
    }
