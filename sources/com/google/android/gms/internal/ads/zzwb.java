...
public final class zzwb extends zzws<zzxl> {
    ...
    zzwb(zzwc zzwc, Context context, zzvs zzvs, String str, zzane zzane) {
        this.zzciw = zzwc;
    ...
    public final /* synthetic */ zzxl zza(zzxy zzxy) {
        return zzxy.zza(aw.Q(this.val$context), this.zzcit, this.zzciu, this.zzciv, 204204000);
    }

    /* Return type fixed from 'java.lang.Object' to match base method */
    @Override // com.google.android.gms.internal.ads.zzws
    public final /* synthetic */ zzxl zzqj() {
        zzwc.zza(this.val$context, "banner");
        return new zzaac();
    }
    ...
    public final /* synthetic */ zzxl zzqk() {
        return this.zzciw.zzcix.zza(this.val$context, this.zzcit, this.zzciu, this.zzciv, 1);
    }
}
