        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (zzeom.zze(b2)) {
                    ...
                    i = i6;
                    i5 = i7;
                } else if (zzeom.zzf(b2)) {
                    if (i6 < i3) {
                        zzeom.zza(b2, bArr[i6], cArr, i5);
                        i = i6 + 1;
                        i5++;
                    } else {
                        throw zzelo.zzbji();
                    }
                } else if (zzeom.zzg(b2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzeom.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw zzelo.zzbji();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzeom.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzelo.zzbji();
