...
public final class zzalz implements zzakl, zzalw {
    ...
    public zzalz(zzalx zzalx) {
        this.zzdkm = zzalx;
    }

    @Override // com.google.android.gms.internal.ads.zzalx
    public final void zza(String str, zzaif<? super zzalx> zzaif) {
        this.zzdkm.zza(str, zzaif);
        this.zzdkn.add(new AbstractMap.SimpleEntry<>(str, zzaif));
    }
    ...
    public final void zzb(String str, zzaif<? super zzalx> zzaif) {
        this.zzdkm.zzb(str, zzaif);
        this.zzdkn.remove(new AbstractMap.SimpleEntry(str, zzaif));
    }
