...
public final class zzehx {
    ...
    public static ECParameterSpec zza(zzehz zzehz) {
        int i = zzeia.zzijx[zzehz.ordinal()];
        if (i == 1) {
        ...
        String valueOf = String.valueOf(zzehz);
        throw new NoSuchAlgorithmException(ic.d(valueOf.length() + 22, "curve not implemented:", valueOf));
    }

    public static ECPublicKey zza(zzehz zzehz, byte[] bArr, byte[] bArr2) {
        ECParameterSpec zza = zza(zzehz);
