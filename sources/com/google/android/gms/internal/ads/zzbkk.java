...
public final class zzbkk implements zzeqb<Set<zzbya<zzqw>>> {
    ...
    private zzbkk(zzeqo<zzbjz> zzeqo, zzeqo<Executor> zzeqo2, zzeqo<JSONObject> zzeqo3) {
        this.zzewe = zzeqo;
        this.zzewf = zzeqo2;
        this.zzftd = zzeqo3;
    }

    public static zzbkk zze(zzeqo<zzbjz> zzeqo, zzeqo<Executor> zzeqo2, zzeqo<JSONObject> zzeqo3) {
        return new zzbkk(zzeqo, zzeqo2, zzeqo3);
    }
