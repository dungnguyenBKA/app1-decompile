...
public final class zzbid extends zzchi {
    ...
    private zzeqo<zzug.zza.EnumC0069zza> zzfpl;
    ...
    private zzbid(zzbgz zzbgz, zzbpa zzbpa, zzdon zzdon, zzbqh zzbqh, zzcle zzcle, zzbwg zzbwg, zzbqx zzbqx, zzdor zzdor, zzdnl zzdnl, zzdkv zzdkv, zzdjx zzdjx) {
        this.zzffq = zzbgz;
        this.zzeyx = zzdor;
        this.zzeyy = zzbqx;
        this.zzeyz = zzdnl;
        ...
        zzbrf zzl = zzbrf.zzl(zzbqx);
        this.zzfay = zzl;
        this.zzfpl = new zzchl(zzl);
        this.zzezj = zzeqc.zzau(zzcmw.zzarm());
        this.zzezk = zzeqc.zzau(zzciy.zze(zzbgz.zzewr, this.zzezi, zzbgz.zzews, this.zzfpl, this.zzezj));
        ...
        this.zzfcb = zzder.zzc(zzdqj.zzaww(), zzbgz.zzewx, this.zzfpm, zzbgz.zzexf, this.zzewr, this.zzfay, this.zzfce);
        ...
        this.zzfcf = zzdck.zzi(zzdqj.zzaww(), zzbgz.zzexq, this.zzfay, this.zzfpm);
        ...
        this.zzfpo = new zzcwb(this.zzewr, zzbgz.zzewz, this.zzfpn);
        this.zzfde = zzcwm.zzg(this.zzfaf, zzbgz.zzeye, zzbgz.zzexe, this.zzfpo);
        this.zzfpp = new zzcvg(this.zzewr, zzbgz.zzewz, this.zzfpn);
        zzcwm zzg = zzcwm.zzg(this.zzfaf, zzbgz.zzeye, zzbgz.zzeyl, this.zzfpp);
        this.zzfdh = zzg;
        this.zzfpq = new zzchj(this.zzfde, zzg, this.zzfay);
        this.zzfpr = new zzcvk(this.zzewr, this.zzfpn);
        this.zzfdf = zzcwd.zzai(this.zzfce);
        this.zzfps = new zzchn(this.zzfaf, zzbgz.zzeye, this.zzfpr, this.zzfdf);
        ...
        this.zzfpt = new zzcvv(this.zzewr, zzbgz.zzews, this.zzfay, zzbgz.zzewz, this.zzfpn, this.zzfdm);
        this.zzfcy = zzbre.zzk(zzbqx);
        this.zzfcx = zzbxa.zzz(zzbwg);
        this.zzfpu = new zzcut(zzbgz.zzewg, this.zzfcy, this.zzfcx);
    ...
    public final zzchd zza(zzboj zzboj, zzchg zzchg) {
        zzeqh.checkNotNull(zzboj);
        zzeqh.checkNotNull(zzchg);
        return new zzbic(this, zzboj, zzchg);
    }
