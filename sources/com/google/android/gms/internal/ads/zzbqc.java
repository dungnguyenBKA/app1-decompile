...
public final class zzbqc implements zzeqb<zzbya<zzbvq>> {
    ...
    private zzbqc(zzeqo<zzckb> zzeqo, zzeqo<Executor> zzeqo2, zzeqo<zzcpf> zzeqo3) {
        this.zzfxt = zzeqo;
        this.zzewf = zzeqo2;
        this.zzfxu = zzeqo3;
    }

    public static zzbqc zzj(zzeqo<zzckb> zzeqo, zzeqo<Executor> zzeqo2, zzeqo<zzcpf> zzeqo3) {
        return new zzbqc(zzeqo, zzeqo2, zzeqo3);
    }
