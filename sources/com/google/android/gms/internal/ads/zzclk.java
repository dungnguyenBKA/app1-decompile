...
public final class zzclk implements zzeqb<Set<zzbya<AppEventListener>>> {
    ...
    private zzclk(zzcle zzcle, zzeqo<zzclo> zzeqo, zzeqo<Executor> zzeqo2) {
        this.zzgmn = zzcle;
        this.zzgjp = zzeqo;
        this.zzewf = zzeqo2;
    }

    public static zzclk zzf(zzcle zzcle, zzeqo<zzclo> zzeqo, zzeqo<Executor> zzeqo2) {
        return new zzclk(zzcle, zzeqo, zzeqo2);
    }
