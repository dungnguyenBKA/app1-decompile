...
public final class zzeqn {
    ...
    public static String zzcl(Context context) {
        ...
        if (arrayList.isEmpty()) {
            ...
            zzjcf = (String) arrayList.get(0);
        } else if (!TextUtils.isEmpty(str2) && !zzd(context, intent) && arrayList.contains(str2)) {
            zzjcf = str2;
        } else if (arrayList.contains("com.android.chrome")) {
            zzjcf = "com.android.chrome";
        } else if (arrayList.contains("com.chrome.beta")) {
            zzjcf = "com.chrome.beta";
        } else if (arrayList.contains("com.chrome.dev")) {
            zzjcf = "com.chrome.dev";
        } else if (arrayList.contains("com.google.android.apps.chrome")) {
            zzjcf = "com.google.android.apps.chrome";
        }
        return zzjcf;
    }
