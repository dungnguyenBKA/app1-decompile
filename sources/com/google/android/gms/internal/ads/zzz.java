...
public final class zzz {
    ...
    public zzz(int r9, byte[] r10, java.util.Map<java.lang.String, java.lang.String> r11, boolean r12, long r13) {
        /*
            r8 = this;
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public zzz(int r9, byte[] r10, boolean r11, long r12, java.util.List<com.google.android.gms.internal.ads.zzv> r14) {
        /*
            r8 = this;
    ...
    public zzz(byte[] bArr, Map<String, String> map) {
        this((int) HttpStatus.SC_OK, bArr, map, false, 0L);
    }
