...
public final class zzana {
    ...
    public zzana(JSONObject jSONObject) {
        List<String> list;
        this.zzdls = jSONObject.optString(FacebookAdapter.KEY_ID);
        ...
        this.zzdmf = jSONObject.optString("transaction_id");
        ...
        this.zzdmm = jSONObject.optString("response_type", null);
        this.zzdmn = jSONObject.optLong("ad_network_timeout_millis", -1);
    }
}
