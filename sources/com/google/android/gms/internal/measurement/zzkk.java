        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (zzki.zza(b2)) {
                    ...
                    if (i5 < i3 - 1) {
                        int i7 = i5 + 1;
                        zzki.zze(b2, bArr[i5], bArr[i7], cArr, i4);
                        i = i7 + 1;
                        i4++;
                    } else {
                        throw zzic.zzf();
                    ...
                    int i8 = i5 + 1;
                    int i9 = i8 + 1;
                    zzki.zzf(b2, bArr[i5], bArr[i8], bArr[i9], cArr, i4);
                    i4 += 2;
                    i = i9 + 1;
                } else {
                    throw zzic.zzf();
