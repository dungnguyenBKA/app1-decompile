...
public enum zzhk {
    ...
    private static final zzhk[] zzac = new zzhk[51];
    private final zzid zzZ;
    private final int zzaa;
    private final Class<?> zzab;

    static {
        zzid zzid = zzid.DOUBLE;
        zzid zzid2 = zzid.FLOAT;
        zzid zzid3 = zzid.LONG;
        zzid zzid4 = zzid.INT;
        zzid zzid5 = zzid.BOOLEAN;
        zzid zzid6 = zzid.STRING;
        zzid zzid7 = zzid.MESSAGE;
        zzid zzid8 = zzid.BYTE_STRING;
        zzid zzid9 = zzid.ENUM;
        zzid zzid10 = zzid.LONG;
        zzhk[] values = values();
        for (int i = 0; i < 51; i++) {
            zzhk zzhk = values[i];
            zzac[zzhk.zzaa] = zzhk;
