...
public final class zzlb implements zzla {
    ...
    static {
        ...
        zza = zzfe.zza("measurement.ad_id_cache_time", 10000);
        zzb = zzfe.zza("measurement.max_bundles_per_iteration", 100);
        zzc = zzfe.zza("measurement.config.cache_time", 86400000);
        ...
        zzn = zzfe.zza("measurement.monitoring.sample_period_millis", 86400000);
        zzo = zzfe.zza("measurement.upload.realtime_upload_interval", 10000);
        zzp = zzfe.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000);
        zzq = zzfe.zza("measurement.config.cache_time.service", 3600000);
        zzr = zzfe.zza("measurement.service_client.idle_disconnect_millis", 5000);
        zzs = zzfe.zzd("measurement.log_tag.service", "FA-SVC");
        zzt = zzfe.zza("measurement.upload.stale_data_deletion_interval", 86400000);
        ...
        zzx = zzfe.zza("measurement.upload.interval", 3600000);
        ...
        zzL = zzfe.zza("measurement.upload.window_interval", 3600000);
    }
