...
public final class zzjk {
    ...
    public static void zzJ(int i, List<Double> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzB(i, list, z);
        }
    }

    public static void zzK(int i, List<Float> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzA(i, list, z);
        }
    }

    public static void zzL(int i, List<Long> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzx(i, list, z);
        }
    }

    public static void zzM(int i, List<Long> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzy(i, list, z);
        }
    }

    public static void zzN(int i, List<Long> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzK(i, list, z);
        }
    }

    public static void zzO(int i, List<Long> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzz(i, list, z);
        }
    }

    public static void zzP(int i, List<Long> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzI(i, list, z);
        }
    }

    public static void zzQ(int i, List<Integer> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzv(i, list, z);
        }
    }

    public static void zzR(int i, List<Integer> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzG(i, list, z);
        }
    }

    public static void zzS(int i, List<Integer> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzJ(i, list, z);
        }
    }

    public static void zzT(int i, List<Integer> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzw(i, list, z);
        }
    }

    public static void zzU(int i, List<Integer> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzH(i, list, z);
        }
    }

    public static void zzV(int i, List<Integer> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzC(i, list, z);
        }
    }

    public static void zzW(int i, List<Boolean> list, zzha zzha, boolean z) {
        if (list != null && !list.isEmpty()) {
            zzha.zzD(i, list, z);
        }
    }

    public static void zzX(int i, List<String> list, zzha zzha) {
        if (list != null && !list.isEmpty()) {
            zzha.zzE(i, list);
        }
    }

    public static void zzY(int i, List<zzgs> list, zzha zzha) {
        if (list != null && !list.isEmpty()) {
            zzha.zzF(i, list);
        }
    }

    public static void zzZ(int i, List<?> list, zzha zzha, zzji zzji) {
        if (!(list == null || list.isEmpty())) {
    ...
    public static void zzaa(int i, List<?> list, zzha zzha, zzji zzji) {
        if (!(list == null || list.isEmpty())) {
            for (int i2 = 0; i2 < list.size(); i2++) {
    ...
    static int zzb(List<Long> list) {
        ...
        if (list instanceof zzim) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzgz.zzx(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzc(int i, List<Long> list, boolean z) {
        ...
        return (zzgz.zzu(i) * list.size()) + zzb(list);
    }
    ...
    static int zze(int i, List<Long> list, boolean z) {
        ...
        return (zzgz.zzu(i) * size) + zzd(list);
    }
    ...
    static int zzf(List<Long> list) {
        ...
        if (list instanceof zzim) {
            ...
            while (i2 < size) {
                ...
                i += zzgz.zzx((longValue >> 63) ^ (longValue + longValue));
                i2++;
            }
        }
        return i;
    ...
    static int zzg(int i, List<Long> list, boolean z) {
        ...
        return (zzgz.zzu(i) * size) + zzf(list);
    }
    ...
    static int zzh(List<Integer> list) {
        ...
        if (list instanceof zzht) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzgz.zzv(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzi(int i, List<Integer> list, boolean z) {
        ...
        return (zzgz.zzu(i) * size) + zzh(list);
    }
    ...
    static int zzk(int i, List<Integer> list, boolean z) {
        ...
        return (zzgz.zzu(i) * size) + zzj(list);
    }
    ...
    static int zzl(List<Integer> list) {
        ...
        if (list instanceof zzht) {
            ...
            i = 0;
            while (i2 < size) {
                i += zzgz.zzw(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzm(int i, List<Integer> list, boolean z) {
        ...
        return (zzgz.zzu(i) * size) + zzl(list);
    }
    ...
    static int zzn(List<Integer> list) {
        ...
        if (list instanceof zzht) {
            ...
            while (i2 < size) {
                ...
                i += zzgz.zzw((intValue >> 31) ^ (intValue + intValue));
                i2++;
            }
        }
        return i;
    ...
    static int zzo(int i, List<Integer> list, boolean z) {
        ...
        return (zzgz.zzu(i) * size) + zzn(list);
    }
    ...
    static int zzx(int i, List<?> list, zzji zzji) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (obj instanceof zzif) {
                zzu = zzgz.zzz((zzif) obj) + zzu;
            } else {
                zzu += zzgz.zzB((zzix) obj, zzji);
            }
        }
        return zzu;
    }
