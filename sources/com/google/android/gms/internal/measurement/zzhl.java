...
final class zzhl extends zzgc<Float> implements RandomAccess, zzhz, zzje {
    ...
    static {
        zzhl zzhl = new zzhl(new float[0], 0);
        zza = zzhl;
        zzhl.zzb();
    }
    ...
    public final /* bridge */ /* synthetic */ void add(int i, Float f) {
        int i2;
    ...
    @Override // java.util.List, com.google.android.gms.internal.measurement.zzgc, java.util.AbstractList
    public final /* bridge */ /* synthetic */ Float remove(int i) {
        zzbL();
        zzf(i);
        float[] fArr = this.zzb;
        float f = fArr[i];
    ...
    /* JADX DEBUG: Method arguments types fixed to match base method, original types: [int, java.lang.Object] */
    @Override // java.util.List, com.google.android.gms.internal.measurement.zzgc, java.util.AbstractList
    public final /* bridge */ /* synthetic */ Float set(int i, Float f) {
        float floatValue = f.floatValue();
        zzbL();
        zzf(i);
        float[] fArr = this.zzb;
