...
public final class zzbr {
    ...
    private final cw zze;
    private final List<Pair<k5, zzbi>> zzf;
    private int zzg;
    private boolean zzi;
    ...
    protected zzbr(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        this.zze = new cw(this);
        this.zzf = new ArrayList();
        try {
            if (j.b(context, "google_app_id", b.S0(context)) != null && !zzT()) {
                this.zzj = null;
                this.zzi = true;
    ...
    static /* synthetic */ void zzO(Context context) {
        synchronized (zzbr.class) {
            try {
                if (zzh == null) {
                    n.e("app_measurement_internal_disable_startup_flags");
                    try {
                        ApplicationInfo c = yv.a(context).c(context.getPackageName(), 128);
                        if (c != null) {
    ...
    public final int zzE(String str) {
        ...
        Integer num = (Integer) zzm.zze(zzm.zzd(10000), Integer.class);
        if (num == null) {
            return 25;
        }
        return num.intValue();
    ...
    public final zzp zzc(Context context, boolean z) {
        ...
        return zzo.asInterface(DynamiteModule.e(context, bVar, ModuleDescriptor.MODULE_ID).d("com.google.android.gms.measurement.internal.AppMeasurementDynamiteService"));
    }

    public final void zzd(j5 j5Var) {
        zzbh zzbh = new zzbh(j5Var);
        if (this.zzk != null) {
            try {
    ...
    public final void zze(com.google.android.gms.measurement.internal.k5 r5) {
        /*
            r4 = this;
            java.lang.String r0 = "null reference"
            java.util.Objects.requireNonNull(r5, r0)
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r0 = r4.zzf
            monitor-enter(r0)
            r1 = 0
        L_0x0009:
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r2 = r4.zzf     // Catch:{ all -> 0x0057 }
            int r2 = r2.size()     // Catch:{ all -> 0x0057 }
            if (r1 >= r2) goto L_0x002d
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r2 = r4.zzf     // Catch:{ all -> 0x0057 }
            java.lang.Object r2 = r2.get(r1)     // Catch:{ all -> 0x0057 }
            android.util.Pair r2 = (android.util.Pair) r2     // Catch:{ all -> 0x0057 }
            java.lang.Object r2 = r2.first     // Catch:{ all -> 0x0057 }
            boolean r2 = r5.equals(r2)     // Catch:{ all -> 0x0057 }
            if (r2 == 0) goto L_0x002a
            java.lang.String r5 = r4.zzd     // Catch:{ all -> 0x0057 }
            java.lang.String r1 = "OnEventListener already registered."
            android.util.Log.w(r5, r1)     // Catch:{ all -> 0x0057 }
        ...
        L_0x002a:
            ...
            goto L_0x0009
        L_0x002d:
            com.google.android.gms.internal.measurement.zzbi r1 = new com.google.android.gms.internal.measurement.zzbi     // Catch:{ all -> 0x0057 }
            r1.<init>(r5)     // Catch:{ all -> 0x0057 }
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r2 = r4.zzf     // Catch:{ all -> 0x0057 }
            android.util.Pair r3 = new android.util.Pair     // Catch:{ all -> 0x0057 }
            r3.<init>(r5, r1)     // Catch:{ all -> 0x0057 }
            r2.add(r3)     // Catch:{ all -> 0x0057 }
            monitor-exit(r0)     // Catch:{ all -> 0x0057 }
            com.google.android.gms.internal.measurement.zzp r5 = r4.zzk
            if (r5 == 0) goto L_0x004e
            com.google.android.gms.internal.measurement.zzp r5 = r4.zzk     // Catch:{ BadParcelableException | NetworkOnMainThreadException | RemoteException | IllegalArgumentException | IllegalStateException | NullPointerException | SecurityException | UnsupportedOperationException -> 0x0047 }
        ...
        L_0x005b:
            goto L_0x005a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzbr.zze(com.google.android.gms.measurement.internal.k5):void");
    }

    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0045, code lost:
        if (r3.zzk == null) goto L_0x0054;
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void zzf(com.google.android.gms.measurement.internal.k5 r4) {
        /*
            r3 = this;
            java.lang.String r0 = "null reference"
            java.util.Objects.requireNonNull(r4, r0)
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r0 = r3.zzf
            monitor-enter(r0)
            r1 = 0
        L_0x0009:
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r2 = r3.zzf     // Catch:{ all -> 0x005d }
            int r2 = r2.size()     // Catch:{ all -> 0x005d }
            if (r1 >= r2) goto L_0x002d
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r2 = r3.zzf     // Catch:{ all -> 0x005d }
            java.lang.Object r2 = r2.get(r1)     // Catch:{ all -> 0x005d }
            android.util.Pair r2 = (android.util.Pair) r2     // Catch:{ all -> 0x005d }
            java.lang.Object r2 = r2.first     // Catch:{ all -> 0x005d }
            boolean r2 = r4.equals(r2)     // Catch:{ all -> 0x005d }
            if (r2 == 0) goto L_0x002a
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r4 = r3.zzf     // Catch:{ all -> 0x005d }
            java.lang.Object r4 = r4.get(r1)     // Catch:{ all -> 0x005d }
            android.util.Pair r4 = (android.util.Pair) r4     // Catch:{ all -> 0x005d }
            goto L_0x002e
        L_0x002a:
            int r1 = r1 + 1
            goto L_0x0009
        ...
        L_0x002e:
            ...
            java.lang.String r4 = r3.zzd     // Catch:{ all -> 0x005d }
            java.lang.String r1 = "OnEventListener had not been registered."
            android.util.Log.w(r4, r1)     // Catch:{ all -> 0x005d }
            monitor-exit(r0)     // Catch:{ all -> 0x005d }
            return
        L_0x0039:
            java.util.List<android.util.Pair<com.google.android.gms.measurement.internal.k5, com.google.android.gms.internal.measurement.zzbi>> r1 = r3.zzf     // Catch:{ all -> 0x005d }
            r1.remove(r4)     // Catch:{ all -> 0x005d }
            java.lang.Object r4 = r4.second     // Catch:{ all -> 0x005d }
            com.google.android.gms.internal.measurement.zzbi r4 = (com.google.android.gms.internal.measurement.zzbi) r4     // Catch:{ all -> 0x005d }
            monitor-exit(r0)     // Catch:{ all -> 0x005d }
            com.google.android.gms.internal.measurement.zzp r0 = r3.zzk
            if (r0 == 0) goto L_0x0054
            com.google.android.gms.internal.measurement.zzp r0 = r3.zzk     // Catch:{ BadParcelableException | NetworkOnMainThreadException | RemoteException | IllegalArgumentException | IllegalStateException | NullPointerException | SecurityException | UnsupportedOperationException -> 0x004d }
        ...
        L_0x0061:
            goto L_0x0060
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzbr.zzf(com.google.android.gms.measurement.internal.k5):void");
    }
