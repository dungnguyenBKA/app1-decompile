...
public final class zzbh {
    ...
    private static void b(JsonWriter jsonWriter, JSONArray jSONArray) {
        try {
            jsonWriter.beginArray();
    ...
    public static JSONObject zzc(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (JsonToken.BEGIN_ARRAY.equals(peek)) {
                ...
                throw new IllegalStateException(ic.d(valueOf.length() + 23, "unexpected json token: ", valueOf));
            }
        }
        jsonReader.endObject();
        return jSONObject;
    ...
    public static String zza(zzbm zzbm) {
        if (zzbm == null) {
            return null;
        }
