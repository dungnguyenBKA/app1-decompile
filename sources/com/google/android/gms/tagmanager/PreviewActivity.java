    ...
    public void onCreate(@RecentlyNonNull Bundle bundle) {
        try {
            ...
            if (!TagManager.getInstance(this).zzd(data)) {
                ...
                create.setButton(-1, "Continue", new zzdz());
                create.show();
            }
            ...
            if (valueOf3.length() != 0) {
                "No launch activity found for package name: ".concat(valueOf3);
            } else {
                new String("No launch activity found for package name: ");
            }
        } catch (Exception e) {
            String valueOf4 = String.valueOf(e.getMessage());
            Log.e("GoogleTagManager", valueOf4.length() != 0 ? "Calling preview threw an exception: ".concat(valueOf4) : new String("Calling preview threw an exception: "));
        }
    }
}
