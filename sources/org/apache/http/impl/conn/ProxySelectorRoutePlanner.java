...
public class ProxySelectorRoutePlanner implements HttpRoutePlanner {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                org.apache.http.impl.conn.ProxySelectorRoutePlanner.AnonymousClass1.$SwitchMap$java$net$Proxy$Type = r0
                java.net.Proxy$Type r1 = java.net.Proxy.Type.DIRECT     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = org.apache.http.impl.conn.ProxySelectorRoutePlanner.AnonymousClass1.$SwitchMap$java$net$Proxy$Type     // Catch:{ NoSuchFieldError -> 0x001d }
                java.net.Proxy$Type r1 = java.net.Proxy.Type.HTTP     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = org.apache.http.impl.conn.ProxySelectorRoutePlanner.AnonymousClass1.$SwitchMap$java$net$Proxy$Type     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    public HttpHost determineProxy(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        ...
        try {
            ...
            StringBuilder q = ic.q("Unable to handle non-Inet proxy address: ");
            q.append(chooseProxy.address());
