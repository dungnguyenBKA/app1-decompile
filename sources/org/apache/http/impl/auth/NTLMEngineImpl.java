...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static class HMACMD5 {
        ...
        HMACMD5(byte[] bArr) {
            try {
                ...
                StringBuilder q = ic.q("Error getting md5 message digest implementation: ");
                q.append(e.getMessage());
                throw new NTLMEngineException(q.toString(), e);
            }
        }
    ...
    public static class Type1Message extends NTLMMessage {
        ...
        Type1Message(String str, String str2) {
            try {
                ...
                StringBuilder q = ic.q("Unicode unsupported: ");
                q.append(e.getMessage());
                throw new NTLMEngineException(q.toString(), e);
            }
        }
    ...
    static class Type2Message extends NTLMMessage {
        ...
        Type2Message(String str) {
            ...
            StringBuilder q = ic.q("NTLM type 2 message has flags that make no sense: ");
            q.append(Integer.toString(this.flags));
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2) {
            ...
            if (bArr2 != null && str5 != null) {
                try {
                    ...
                    this.ntResp = NTLMEngineImpl.getNTLMv2Response(str5, str3, str4, bArr, makeRandomChallenge, bArr2);
                    this.lmResp = NTLMEngineImpl.getLMv2Response(str5, str3, str4, bArr, makeRandomChallenge);
            ...
            try {
                ...
                StringBuilder q = ic.q("Unicode not supported: ");
                q.append(e.getMessage());
                throw new NTLMEngineException(q.toString(), e);
            }
        }
        ...
        public String getResponse() {
            ...
            addULong((i6 & NTLMEngineImpl.FLAG_NEGOTIATE_ALWAYS_SIGN) | (NTLMEngineImpl.FLAG_NEGOTIATE_NTLM2 & i6) | 536871429 | (i6 & 16) | (i6 & 32) | (NTLMEngineImpl.FLAG_NEGOTIATE_KEY_EXCH & i6));
