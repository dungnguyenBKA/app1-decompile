            ...
            if (domain == null) {
                ...
                if (domain.indexOf(46) == -1) {
                    ...
                    if (indexOf < 0 || indexOf == domain.length() - 1) {
                        throw new CookieRestrictionViolationException(ic.j("Domain attribute \"", domain, "\" violates RFC 2109: domain must contain an embedded dot"));
                    }
                    ...
                    if (!lowerCase.endsWith(domain)) {
                        ...
                        throw new CookieRestrictionViolationException(ic.j("Domain attribute \"", domain, "\" violates RFC 2109: host minus domain may not contain any dots"));
                    }
                } else {
                    throw new CookieRestrictionViolationException(ic.j("Domain attribute \"", domain, "\" violates RFC 2109: domain must start with a dot"));
                }
            }
        } else {
            throw new IllegalArgumentException("Cookie origin may not be null");
